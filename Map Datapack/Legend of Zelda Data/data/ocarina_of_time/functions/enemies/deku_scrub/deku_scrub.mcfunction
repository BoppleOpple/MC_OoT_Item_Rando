...
execute if entity @s[tag=Scared,scores={lifetime=1}] at @s unless entity @s[tag=Stun] run summon minecraft:marker ~ ~ ~ {Tags:["DekuScrubReturn"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
...
execute if entity @s[tag=Scared,scores={lifetime=130..145}] at @s facing entity @e[type=marker,tag=DekuScrubReturn,sort=nearest,limit=1] feet rotated ~ 0 run tp @s ^ ^ ^.5 ~ 0
execute if entity @s[tag=Scared,scores={lifetime=147..}] run kill @e[type=marker,tag=DekuScrubReturn]
