...
execute if entity @s[scores={GameTimer=1}] run summon minecraft:marker ~ ~ ~ {Tags:["DekuScrubReturn"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
...
execute if entity @s[tag=Cheer] unless entity @s[tag=Dodge1] unless entity @s[tag=Dodge2] if entity @s[scores={GameTimer=31..999}] facing entity @e[type=marker,tag=DekuScrubReturn,limit=1,sort=nearest] feet run tp @s ^ ^ ^.5 ~ 0
execute if entity @s[tag=Cheer] unless entity @s[tag=Dodge1] unless entity @s[tag=Dodge2] if entity @s[scores={GameTimer=31..999}] if entity @e[type=marker,tag=DekuScrubReturn,distance=..0.3] run scoreboard players set @s GameTimer 1000
execute if entity @s[tag=Cheer] unless entity @s[tag=Dodge1] unless entity @s[tag=Dodge2] if entity @s[scores={GameTimer=31..999}] as @e[type=marker,tag=DekuScrubReturn,distance=..0.3] run kill @s
execute if entity @s[tag=Cheer] unless entity @s[tag=Dodge1] unless entity @s[tag=Dodge2] if entity @s[scores={GameTimer=1000..}] if entity @e[type=marker,tag=DekuScrubReturn,distance=..0.3] run tp @s ~ ~-1 ~
execute if entity @s[tag=Cheer] unless entity @s[tag=Dodge1] unless entity @s[tag=Dodge2] if entity @s[scores={GameTimer=1000..}] as @e[type=marker,tag=DekuScrubReturn,distance=..0.3] run kill @s
