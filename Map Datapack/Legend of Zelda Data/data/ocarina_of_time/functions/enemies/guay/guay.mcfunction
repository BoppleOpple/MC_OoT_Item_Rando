#Idle
execute unless entity @s[tag=Attack] unless entity @s[tag=Return] unless entity @e[type=marker,tag=Guay,sort=nearest,limit=1,distance=..8] run tag @s add Turn
...
execute if entity @s[tag=Return] run tp @s ^ ^ ^.15 facing entity @e[type=marker,tag=Guay,limit=1,sort=nearest] feet
execute if entity @s[tag=Return] if entity @e[type=marker,tag=Guay,limit=1,sort=nearest,distance=..1] run tag @s remove Return
