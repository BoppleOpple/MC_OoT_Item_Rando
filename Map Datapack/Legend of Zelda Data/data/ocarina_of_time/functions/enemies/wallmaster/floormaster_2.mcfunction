...
execute unless entity @s[tag=Grow] unless entity @s[tag=Attack] unless entity @s[tag=Attack2] if entity @s[scores={timer=5..}] unless block ~ ~-.2 ~ minecraft:air if block ^ ^ ^.5 minecraft:air if block ^.4 ^ ^ minecraft:air if block ^-.4 ^ ^ minecraft:air run tp @s ^ ^ ^.1 ~ 0
execute unless entity @s[tag=Grow] unless entity @s[tag=Attack] unless entity @s[tag=Attack2] if entity @s[scores={timer=5..}] unless block ~ ~-.2 ~ minecraft:air unless block ^ ^ ^.5 minecraft:air unless entity @a[distance=4..5] run tag @s add Turn
...
execute unless entity @s[tag=Grow] unless entity @s[tag=Attack] unless entity @s[tag=Attack2] if entity @s[scores={timer=5..}] unless block ~ ~-.2 ~ minecraft:air unless block ^-.4 ^ ^ minecraft:air unless entity @a[distance=4..5] run tag @s add Turn
execute unless entity @s[tag=Grow] unless entity @s[tag=Attack] unless entity @s[tag=Attack2] if entity @s[scores={timer=5..}] unless block ~ ~-.2 ~ minecraft:air unless block ^ ^ ^.5 minecraft:air if entity @a[distance=4..5] run tag @s add Attack
...
execute if entity @s[scores={HoverTimer=1}] unless entity @e[type=marker,tag=TinymasterTeleport] at @a run summon minecraft:marker ~ ~ ~ {Tags:["TinymasterTeleport"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute if entity @s[scores={HoverTimer=1..80}] at @e[type=marker,tag=TinymasterTeleport] run tp @p ~ ~ ~
