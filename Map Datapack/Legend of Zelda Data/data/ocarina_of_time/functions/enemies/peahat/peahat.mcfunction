...
execute if entity @e[type=marker,tag=PeahatReturn] run scoreboard players add @s GameTimer 1
...
execute unless entity @s[tag=Stun] unless entity @s[tag=Attack] if entity @s[scores={lifetime=1..}] if entity @e[type=marker,tag=PeahatReturn] if block ~ ~-1 ~ #ocarina_of_time:peahat unless block ~ ~-2 ~ #ocarina_of_time:peahat facing entity @e[type=marker,tag=PeahatReturn,sort=nearest,limit=1] feet rotated ~ 0 positioned ^ ^ ^.1 rotated as @s run tp @s ~ ~ ~ ~4 ~
execute unless entity @s[tag=Stun] unless entity @s[tag=Attack] if entity @s[scores={lifetime=1..}] if entity @e[type=marker,tag=PeahatReturn] unless block ~ ~-1 ~ #ocarina_of_time:peahat run tp @s ~ ~1 ~
execute unless entity @s[tag=Stun] unless entity @s[tag=Attack] if entity @s[scores={lifetime=1..}] if entity @e[type=marker,tag=PeahatReturn] if block ~ ~-2 ~ #ocarina_of_time:peahat if block ~ ~-1 ~ #ocarina_of_time:peahat run tp @s ~ ~-1 ~
execute unless entity @s[tag=Stun] unless entity @s[tag=Attack] if entity @s[scores={lifetime=1..}] if entity @e[type=marker,tag=PeahatReturn] as @e[type=zombie,tag=Peahat,distance=..1.5] at @s run tp @s ~ ~ ~ ~4 25

execute unless entity @s[tag=Stun] unless entity @s[tag=Attack] if entity @s[scores={lifetime=1..}] positioned ~ ~-5 ~ if entity @e[type=marker,tag=PeahatReturn,distance=..0.1] run scoreboard players set @s timer 0
execute unless entity @s[tag=Stun] unless entity @s[tag=Attack] if entity @s[scores={lifetime=1..}] positioned ~ ~-5 ~ at @e[type=marker,tag=PeahatReturn,distance=..0.1] run tp @s ~ ~ ~
execute unless entity @s[tag=Stun] unless entity @s[tag=Attack] if entity @s[scores={lifetime=1..}] positioned ~ ~-5 ~ at @e[type=marker,tag=PeahatReturn,distance=..0.1] run tp @e[type=zombie,tag=Peahat,sort=nearest,limit=1] ~ ~2.5 ~ ~ 0
execute unless entity @s[tag=Stun] unless entity @s[tag=Attack] if entity @s[scores={lifetime=1..}] positioned ~ ~-5 ~ as @e[type=marker,tag=PeahatReturn,distance=..0.1] run kill @s
execute unless entity @s[tag=Stun] unless entity @s[tag=Attack] if entity @s[scores={lifetime=1..}] unless entity @e[type=marker,tag=PeahatReturn] run scoreboard players set @s lifetime 0
...
#Hurt
execute unless entity @e[type=marker,tag=PeahatReturn] run data merge entity @e[type=zombie,tag=Peahat,limit=1,sort=nearest] {Invulnerable:1b}
execute if entity @e[type=marker,tag=PeahatReturn] run data merge entity @e[type=zombie,tag=Peahat,limit=1,sort=nearest] {Invulnerable:0b}
...
execute unless entity @e[type=marker,tag=PeahatReturn] run scoreboard players set @s GameTimer 0
