...
execute if entity @s[scores={lifetime=1}] run summon minecraft:marker ~ ~ ~ {Tags:["RedBubbleReturn"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute if entity @s[scores={lifetime=2}] run tp @s ~ ~2 ~
execute if entity @s[scores={lifetime=3..10}] run tp @s ^ ^.4 ^.2

#Reset
execute if entity @s[scores={lifetime=251..}] run tp @s @e[type=marker,tag=RedBubbleReturn,limit=1,sort=nearest]
execute if entity @s[scores={lifetime=251..}] run kill @e[type=marker,tag=RedBubbleReturn,limit=1,sort=nearest,distance=..1]
