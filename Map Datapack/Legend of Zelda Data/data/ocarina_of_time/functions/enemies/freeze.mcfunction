...
execute at @a if entity @s[scores={Shock=1}] run summon minecraft:marker ~ ~ ~ {Tags:["Frozen"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
...
execute at @e[type=marker,tag=Frozen] if entity @s[scores={Shock=1..50}] unless entity @a[scores={ResetHealth=1..}] run tp @a ~ ~ ~
...
execute if entity @s[scores={Shock=50..}] run kill @e[type=marker,tag=Frozen]
