...
execute unless entity @a[scores={ResetHealth=1..}] unless entity @a[tag=InDeathTown] unless entity @s[tag=Stun] unless entity @s[tag=Eat] at @a if entity @s[scores={timer=10}] run summon minecraft:marker ~ ~ ~ {Tags:["Scared"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
...
execute unless entity @a[scores={ResetHealth=1..}] unless entity @a[tag=InDeathTown] unless entity @s[tag=Stun] unless entity @s[tag=Eat] at @e[type=marker,tag=Scared] if entity @s[scores={timer=10..40}] run tp @a ~ ~ ~
...
execute unless entity @a[scores={ResetHealth=1..}] unless entity @a[tag=InDeathTown] unless entity @s[tag=Stun] unless entity @s[tag=Eat] if entity @s[scores={timer=81}] run kill @e[type=marker,tag=Scared]
...
execute if entity @a[scores={ResetHealth=1..}] run kill @e[type=marker,tag=Scared]
...
execute at @a if entity @s[scores={SlingshotDamage=20}] unless entity @e[type=marker,tag=Progress,tag=RedeadHelp] run tellraw @a ["",{"text":"Navi: ","color":"gold"},{"text":"Run and Jump "},{"text":"to get away from its grasp, ","color":"aqua"},{"selector":"@p","color":"aqua"},{"text":"!","color":"aqua"}]
execute at @a if entity @s[scores={SlingshotDamage=20}] run tag @e[type=marker,tag=Progress] add RedeadHelp
