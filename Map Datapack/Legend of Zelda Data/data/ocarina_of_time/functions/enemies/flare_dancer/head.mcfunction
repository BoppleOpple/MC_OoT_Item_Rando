...
#Moving
execute unless entity @s[tag=Reverse] if entity @e[type=marker,tag=FlarePoint,distance=..0.2] unless entity @s[tag=Cooldown] run scoreboard players remove @s timer 1
execute unless entity @s[tag=Reverse] if entity @e[type=marker,tag=FlarePoint,distance=..0.2] run tag @s add Cooldown
execute if entity @s[tag=Reverse] if entity @e[type=marker,tag=FlarePoint,distance=..0.2] unless entity @s[tag=Cooldown] run scoreboard players add @s timer 1
execute if entity @s[tag=Reverse] if entity @e[type=marker,tag=FlarePoint,distance=..0.2] run tag @s add Cooldown
...
execute unless entity @s[tag=Cooldown2] if entity @s[scores={time=7..399}] if entity @s[scores={timer=1}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=FlarePoint1,limit=1]
execute unless entity @s[tag=Cooldown2] if entity @s[scores={time=7..399}] if entity @s[scores={timer=2}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=FlarePoint2,limit=1]
execute unless entity @s[tag=Cooldown2] if entity @s[scores={time=7..399}] if entity @s[scores={timer=3}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=FlarePoint3,limit=1]
execute unless entity @s[tag=Cooldown2] if entity @s[scores={time=7..399}] if entity @s[scores={timer=4}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=FlarePoint4,limit=1]
execute unless entity @s[tag=Cooldown2] if entity @s[scores={time=7..399}] if entity @s[scores={timer=5}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=FlarePoint5,limit=1]
execute unless entity @s[tag=Cooldown2] if entity @s[scores={time=7..399}] if entity @s[scores={timer=6}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=FlarePoint6,limit=1]
execute unless entity @s[tag=Cooldown2] if entity @s[scores={time=7..399}] if entity @s[scores={timer=7}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=FlarePoint7,limit=1]
execute unless entity @s[tag=Cooldown2] if entity @s[scores={time=7..399}] if entity @s[scores={timer=8}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=FlarePoint8,limit=1]
...
execute if entity @s[scores={time=2}] run scoreboard players operation @s timer = @e[type=marker,tag=FlarePoint,tag=!FlarePoint9,limit=1,sort=nearest] timer
...
execute if entity @s[scores={time=400..420}] run tp @s ^ ^ ^.5 facing entity @e[type=marker,tag=FlarePoint9,limit=1]
