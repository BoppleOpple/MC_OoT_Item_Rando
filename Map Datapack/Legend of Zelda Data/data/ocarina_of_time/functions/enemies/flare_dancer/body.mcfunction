#Flare Points
scoreboard players set @e[type=marker,tag=FlarePoint1] timer 1
scoreboard players set @e[type=marker,tag=FlarePoint2] timer 2
scoreboard players set @e[type=marker,tag=FlarePoint3] timer 3
scoreboard players set @e[type=marker,tag=FlarePoint4] timer 4
scoreboard players set @e[type=marker,tag=FlarePoint5] timer 5
scoreboard players set @e[type=marker,tag=FlarePoint6] timer 6
scoreboard players set @e[type=marker,tag=FlarePoint7] timer 7
scoreboard players set @e[type=marker,tag=FlarePoint8] timer 8
...
#Running
execute unless entity @s[tag=Cooldown] unless entity @s[tag=Spin] if entity @e[type=marker,tag=FlarePoint,distance=..0.2] run scoreboard players remove @s timer 1
execute if entity @e[type=marker,tag=FlarePoint,distance=..0.2] run tag @s add Cooldown
execute if entity @s[scores={timer=..0}] run scoreboard players set @s timer 8
execute unless entity @s[tag=Spin] unless entity @s[scores={GameTimer=1..}] if entity @s[scores={timer=1}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=FlarePoint1,limit=1]
execute unless entity @s[tag=Spin] unless entity @s[scores={GameTimer=1..}] if entity @s[scores={timer=2}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=FlarePoint2,limit=1]
execute unless entity @s[tag=Spin] unless entity @s[scores={GameTimer=1..}] if entity @s[scores={timer=3}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=FlarePoint3,limit=1]
execute unless entity @s[tag=Spin] unless entity @s[scores={GameTimer=1..}] if entity @s[scores={timer=4}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=FlarePoint4,limit=1]
execute unless entity @s[tag=Spin] unless entity @s[scores={GameTimer=1..}] if entity @s[scores={timer=5}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=FlarePoint5,limit=1]
execute unless entity @s[tag=Spin] unless entity @s[scores={GameTimer=1..}] if entity @s[scores={timer=6}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=FlarePoint6,limit=1]
execute unless entity @s[tag=Spin] unless entity @s[scores={GameTimer=1..}] if entity @s[scores={timer=7}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=FlarePoint7,limit=1]
execute unless entity @s[tag=Spin] unless entity @s[scores={GameTimer=1..}] if entity @s[scores={timer=8}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=FlarePoint8,limit=1]
...
execute if entity @s[scores={time=53}] run scoreboard players operation @s timer = @e[type=marker,tag=FlarePoint,tag=!FlarePoint9,limit=1,sort=nearest] timer
#Spinning
