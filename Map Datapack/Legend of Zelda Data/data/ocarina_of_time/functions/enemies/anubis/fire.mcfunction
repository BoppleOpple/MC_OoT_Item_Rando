...
execute positioned ~ ~-1 ~ if entity @a[distance=..1] if entity @s[scores={timer=29}] if entity @a[nbt={SelectedItem:{id:"minecraft:shield",Count:1b,tag:{Wooden:1b}}}] run item replace entity @a weapon.mainhand with minecraft:air
...
execute positioned ~ ~-1 ~ if entity @a[distance=..1] if entity @s[scores={timer=29}] if entity @a[nbt={Inventory:[{Slot:-106b,id:"minecraft:shield",Count:1b,tag:{Wooden:1b}}]}] run item replace entity @a weapon.offhand with minecraft:air
