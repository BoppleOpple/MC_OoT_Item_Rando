...
execute if entity @s[scores={timer=281}] if entity @s[tag=Move] run tp @s @e[type=marker,tag=FreezardReset,limit=1,sort=nearest]
execute if entity @s[scores={timer=281}] if entity @s[tag=Move] run kill @e[type=marker,tag=FreezardReset,limit=1,sort=nearest]
...
execute if entity @s[scores={lifetime=1}] run summon minecraft:marker ~ ~ ~ {Tags:["FreezardReset"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
