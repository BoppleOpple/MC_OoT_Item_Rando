...
execute if entity @s[scores={lifetime=1}] run summon minecraft:marker ~ ~ ~ {Tags:["WallSkullReset"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
...
#Stop
execute if entity @s[scores={lifetime=42..}] at @e[type=marker,tag=WallSkullReset,sort=nearest,limit=1] run tp @s ~ ~ ~
execute if entity @s[scores={lifetime=42..}] run kill @e[type=marker,tag=WallSkullReset,sort=nearest,limit=1]
