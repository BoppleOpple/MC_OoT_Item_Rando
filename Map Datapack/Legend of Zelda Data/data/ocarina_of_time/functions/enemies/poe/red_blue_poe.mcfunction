...
execute if entity @s[tag=Joelle,scores={lifetime=1}] unless entity @s[tag=RedCutscene] at @a run summon minecraft:marker ~ ~ ~ {Tags:["RedPoeCutscene"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
...
execute if entity @s[tag=Joelle,scores={lifetime=25}] unless entity @s[tag=RedCutscene] run tp @a @e[type=marker,tag=RedPoeCutscene,limit=1]
execute if entity @s[tag=Joelle,scores={lifetime=25}] unless entity @s[tag=RedCutscene] run kill @e[type=marker,tag=RedPoeCutscene]
...
execute if entity @s[tag=Beth,scores={lifetime=1}] unless entity @s[tag=BlueCutscene] at @a run summon minecraft:marker ~ ~ ~ {Tags:["BluePoeCutscene"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
...
execute if entity @s[tag=Beth,scores={lifetime=25}] unless entity @s[tag=BlueCutscene] run tp @a @e[type=marker,tag=BluePoeCutscene,limit=1]
execute if entity @s[tag=Beth,scores={lifetime=25}] unless entity @s[tag=BlueCutscene] run kill @e[type=marker,tag=BluePoeCutscene]
