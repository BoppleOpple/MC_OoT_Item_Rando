...
#Enemies
execute if entity @s[scores={timer=1..250}] if entity @e[type=!marker,type=!player,tag=!Bombchu,distance=..1] unless entity @s[scores={timer=250..}] run scoreboard players set @s timer 250
