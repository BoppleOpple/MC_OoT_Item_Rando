...
execute if entity @a[tag=InWell] unless entity @s[tag=LensHelp] if entity @a[nbt={Inventory:[{tag:{LensOfTruth:1b}}]}] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={lifetime=23..}] run scoreboard players set @s lifetime 23
