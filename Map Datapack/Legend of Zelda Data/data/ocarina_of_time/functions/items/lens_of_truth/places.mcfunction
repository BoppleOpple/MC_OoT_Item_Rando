...
item replace entity @a weapon.mainhand with minecraft:carrot_on_a_stick{display:{Name:"{\"text\":\"Lens of Truth\"}"},Unbreakable:1b,Damage:24,HideFlags:63,LensOfTruth:1b,LensOfTruth2:1b}
