...
execute if entity @s[nbt={Inventory:[{tag:{NutPickup:1b}}]}] unless entity @s[nbt={Inventory:[{tag:{DekuNut:1b}}]}] unless entity @e[type=marker,tag=Progress,tag=GotDekuNut] run function ocarina_of_time:items/pickup_items/deku_nut
