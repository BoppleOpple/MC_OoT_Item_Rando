...
#Torch
    execute if entity @s[tag=Fire] positioned ~ ~ ~ if block ~ ~ ~ minecraft:jungle_fence as @e[type=armor_stand,tag=UnlitTorch,limit=1,sort=nearest,distance=..1] run tag @s add LitTorch
