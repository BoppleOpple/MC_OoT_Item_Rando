...
execute unless entity @s[scores={DekuSeeds2=..0}] unless entity @a[nbt={Inventory:[{Slot:-106b}]}] run item replace entity @s weapon.offhand with minecraft:snowball{display:{Name:"\"Deku Seeds\""},SlingshotAmmo:1b} 1
