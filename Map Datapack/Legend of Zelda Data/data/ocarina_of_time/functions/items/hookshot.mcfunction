...
execute if entity @s[scores={Hookshot=2..100}] positioned ~ ~1.6 ~ if block ^ ^ ^1 #ocarina_of_time:hookshot_1 if block ^-.4 ^ ^.5 #ocarina_of_time:hookshot_1 if block ^.4 ^ ^.5 #ocarina_of_time:hookshot_1 run playsound minecraft:block.sweet_berry_bush.pick_berries ambient @a ~ ~ ~ 10 2
...
execute if entity @s[scores={Hookshot=200}] at @a run summon minecraft:marker ~ ~ ~ {Tags:["Hookshot2"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
...
execute if entity @s[scores={Hookshot=200..}] as @e[type=marker,tag=Hookshot2] at @s run tp @s ^ ^ ^.6 facing entity @e[type=marker,tag=Hookshot,limit=1]
execute if entity @s[scores={Hookshot=200..}] as @e[type=marker,tag=Hookshot2] at @s run playsound minecraft:block.sweet_berry_bush.pick_berries ambient @a ~ ~ ~ 10 1.5
execute if entity @s[scores={Hookshot=200..}] as @e[type=marker,tag=Hookshot2] at @s run tp @p @s
...
#Finish
execute unless entity @e[type=marker,tag=Progress,tag=GotLongshot] if entity @s[scores={Hookshot=16}] run scoreboard players set @s Hookshot 1000
execute if entity @e[type=marker,tag=Progress,tag=GotLongshot] if entity @s[scores={Hookshot=36}] run scoreboard players set @s Hookshot 1000
execute if entity @s[scores={Hookshot=200..}] if entity @a[distance=...6] run scoreboard players set @s Hookshot 1000

#Under
execute if entity @s[scores={Hookshot=200..}] if entity @e[type=marker,tag=Hookshot2] if entity @a[distance=...6] at @a rotated ~ 0 if block ~ ~ ~ #ocarina_of_time:hookshot_3 if block ~ ~1 ~ #ocarina_of_time:hookshot_3 unless block ~ ~2 ~ #ocarina_of_time:hookshot_3 run tp @a ~ ~-1 ~
#Above
execute if entity @s[scores={Hookshot=200..}] if entity @e[type=marker,tag=Hookshot2] if entity @a[distance=...6] at @a rotated ~ 0 if block ^ ^2.6 ^.6 #ocarina_of_time:hookshot_3 run tp @a ^ ^2.6 ^.5
#Bottom
execute if entity @s[scores={Hookshot=200..}] if entity @e[type=marker,tag=Hookshot2] if entity @a[distance=...6] at @a rotated ~ 0 unless block ~ ~ ~ #ocarina_of_time:hookshot_3 run tp @a ^ ^.8 ^-1
#Wall
execute if entity @s[scores={Hookshot=200..}] if entity @e[type=marker,tag=Hookshot2] if entity @a[distance=...6] at @a rotated ~ 0 unless block ^ ^1 ^.5 #ocarina_of_time:hookshot_3 unless block ^ ^1 ^.2 #ocarina_of_time:hookshot_3 run tp @a ^ ^.8 ^-1
...
execute if entity @s[scores={Hookshot=1000..}] run kill @e[type=marker,tag=Hookshot2]
