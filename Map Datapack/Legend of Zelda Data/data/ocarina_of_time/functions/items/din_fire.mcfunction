...
execute if entity @s[scores={SpiritMagic=1}] positioned 938 83 -1154 if entity @a[distance=..5] if block 936 87 -1154 minecraft:ice run summon minecraft:marker 946 84 -1190 {Tags:["TwistedRoom","TwistedRoom5"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
