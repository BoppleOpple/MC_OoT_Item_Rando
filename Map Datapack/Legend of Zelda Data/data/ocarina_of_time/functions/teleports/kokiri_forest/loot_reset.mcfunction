tag @e[type=marker,tag=HoppingStones] remove 0
...
#Bean Spots
#1
execute if entity @a[tag=Adult] if entity @e[type=marker,tag=BeanSpot,tag=PlantBean6] run clone -547 61 -641 -545 61 -639 -551 65 -639
execute unless entity @a[tag=Adult] if entity @e[type=marker,tag=BeanSpot,tag=PlantBean6] run fill -550 65 -638 -550 65 -638 minecraft:pumpkin_stem[age=6]
#2
execute if entity @a[tag=Adult] if entity @e[type=marker,tag=BeanSpot,tag=PlantBean7] run clone -633 64 -648 -631 64 -646 -634 69 -645
execute unless entity @a[tag=Adult] if entity @e[type=marker,tag=BeanSpot,tag=PlantBean7] run fill -633 69 -644 -633 69 -644 minecraft:pumpkin_stem[age=6]
#3
execute if entity @a[tag=Adult] if entity @e[type=marker,tag=BeanSpot,tag=PlantBean8] run clone -581 70 -707 -579 70 -705 -583 75 -706
execute unless entity @a[tag=Adult] if entity @e[type=marker,tag=BeanSpot,tag=PlantBean8] run fill -582 75 -705 -582 75 -705 minecraft:pumpkin_stem[age=6]
