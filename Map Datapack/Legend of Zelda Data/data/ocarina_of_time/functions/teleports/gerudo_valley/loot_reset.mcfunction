...
#Bean Spots
execute if entity @a[tag=Adult] if entity @e[type=marker,tag=BeanSpot,tag=PlantBean4] run clone 360 29 2038 362 29 2040 364 36 2038
execute unless entity @a[tag=Adult] if entity @e[type=marker,tag=BeanSpot,tag=PlantBean4] run fill 365 36 2039 365 36 2039 minecraft:pumpkin_stem[age=6]
...
fill 446 67 2051 446 67 2051 minecraft:granite_slab
fill 445 67 2052 445 67 2052 minecraft:granite_slab
fill 446 67 2053 446 67 2053 minecraft:granite_slab
