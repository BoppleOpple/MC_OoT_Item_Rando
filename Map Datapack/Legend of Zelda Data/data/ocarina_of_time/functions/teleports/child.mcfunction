...
execute if entity @s[scores={LoadZone=15..}] run function ocarina_of_time:teleports/remove_teleports
execute if entity @s[scores={LoadZone=1..15}] run tag @a add InKokiriForest
execute if entity @s[scores={LoadZone=15..}] run scoreboard players reset @e[type=marker,tag=Progress] Die
execute if entity @s[scores={LoadZone=15..}] run tag @s add StopTime
execute if entity @s[scores={LoadZone=15..}] unless entity @s[scores={time=13001..23000}] run function ocarina_of_time:music/inside_house
