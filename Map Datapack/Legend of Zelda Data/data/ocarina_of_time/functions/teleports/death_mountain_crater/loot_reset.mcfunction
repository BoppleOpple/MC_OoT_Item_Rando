...
#Bean Spots
execute if entity @a[tag=Adult] if entity @e[type=marker,tag=BeanSpot,tag=PlantBean2] run clone 2684 35 1921 2686 35 1923 2686 37 1943
execute unless entity @a[tag=Adult] if entity @e[type=marker,tag=BeanSpot,tag=PlantBean2] run fill 2687 37 1944 2687 37 1944 minecraft:pumpkin_stem[age=6]
