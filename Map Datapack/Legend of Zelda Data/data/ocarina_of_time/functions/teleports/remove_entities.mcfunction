#Area effect clouds
kill @e[type=marker,tag=Scared]
kill @e[type=marker,tag=FireEye]
kill @e[type=marker,tag=DekuScrubReturn]
kill @e[type=marker,tag=Guay]
kill @e[type=marker,tag=AnubisFire]
kill @e[type=marker,tag=WallSkullReset]
kill @e[type=marker,tag=ArmosReset]
kill @e[type=marker,tag=FreezardReset]
kill @e[type=marker,tag=BigFairy]
kill @e[type=marker,tag=LungeBabaReset]

#Armor Stand Enemies
kill @e[type=armor_stand,tag=SpikeWall]
...
kill @e[type=armor_stand,tag=OwlStand10]
...
kill @e[type=armor_stand,tag=Sakon]
kill @e[type=armor_stand,tag=GirlChasingCucco]
kill @e[type=armor_stand,tag=GraveyardBoy]
kill @e[type=armor_stand,tag=Dampe]
...
kill @e[type=villager,tag=DampeShop]

#Minibosses
tag @e[type=marker,tag=MiniBossPlatform,tag=Version1] remove Version1
kill @e[tag=BigOcto]

#Bosses
kill @e[type=zombie,tag=Gohma]
kill @e[type=marker,tag=GohmaSpot]
