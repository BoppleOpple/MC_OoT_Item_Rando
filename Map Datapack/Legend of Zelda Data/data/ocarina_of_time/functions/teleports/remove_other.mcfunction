...
scoreboard players set @e[type=marker,tag=TimeBlock] timer 1
scoreboard players set @e[type=marker,tag=TimeBlock] lifetime 1
scoreboard players set @e[type=armor_stand,tag=Fisherman1] text 1
scoreboard players reset @e[type=marker,tag=BeanSpot]
scoreboard players set @e[type=marker,tag=FakeSaria] timer 0
scoreboard players set @e[type=marker,tag=Guay] timer 0

#Tags
tag @a remove WearingGoronTunic
...
tag @e[type=marker,tag=BeanSpot] remove Bean
tag @e[type=marker,tag=BeanSpot] remove Bean1
tag @e[type=marker,tag=BeanSpot] remove Bean2
tag @e[type=marker,tag=BeanSpot] remove Bean3
...
execute unless block 1726 55 963 minecraft:gold_block run fill 1725 55 963 1725 55 963 minecraft:air
...
fill 902 5 -635 902 5 -635 minecraft:air
fill 1550 55 878 1550 55 878 minecraft:air
fill 1561 58 886 1541 63 878 minecraft:air replace minecraft:barrier
...
#Other
execute as @e[type=marker,tag=Songs] unless entity @s[scores={time=..15}] run stopsound @a record
