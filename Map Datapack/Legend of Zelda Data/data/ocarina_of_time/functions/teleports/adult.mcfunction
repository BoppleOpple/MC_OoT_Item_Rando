...
execute if entity @s[scores={LoadZone=1..15}] run tag @a add InDeathTown
...
execute if entity @s[scores={LoadZone=15..}] run function ocarina_of_time:music/temple_of_time
