...
#Bean Spots
execute if entity @a[tag=Adult] if entity @e[type=marker,tag=BeanSpot,tag=PlantBean1] run clone 2012 89 1444 2014 89 1446 2010 93 1450
execute unless entity @a[tag=Adult] if entity @e[type=marker,tag=BeanSpot,tag=PlantBean1] run fill 2011 93 1451 2011 93 1451 minecraft:pumpkin_stem[age=6]
