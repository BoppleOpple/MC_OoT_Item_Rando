#Lizalfos
#1
execute unless block 2269 37 1930 minecraft:stone_pressure_plate run kill @e[type=marker,tag=LizPlatform]
#2
execute unless block 2276 50 1941 minecraft:stone_pressure_plate run kill @e[type=marker,tag=LizPlatform]
