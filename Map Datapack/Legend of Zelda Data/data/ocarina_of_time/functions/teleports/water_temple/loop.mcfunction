#Lake Hylia
execute if entity @s[x=1061,y=53,z=3001,dx=4,dy=3,dz=1] unless entity @a[tag=FinishLake] run function ocarina_of_time:teleports/water_temple/lake_hylia/to_lake_hylia_adult
execute if entity @s[x=1061,y=53,z=3001,dx=4,dy=3,dz=1] if entity @a[tag=FinishLake] run function ocarina_of_time:teleports/water_temple/lake_hylia/to_lake_hylia_child
