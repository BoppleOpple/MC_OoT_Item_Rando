...
#Guay
#1
execute if entity @a[tag=Adult] unless entity @e[type=marker,tag=Guay1] run summon minecraft:zombie 740 83 2720 {Tags:["Guay","Guay1","Invisible","Fire"],PersistenceRequired:1b,IsBaby:1b,Silent:1b,NoAI:1b,DeathLootTable:"ocarina_of_time:entities/guay",Health:1,Attributes:[{Name:"generic.max_health",Base:1}],ArmorItems:[{},{},{},{id:cobblestone,Count:1b,tag:{CustomModelData:87}}],ArmorDropChances:[0f,0f,0f,0f]}
execute if entity @a[tag=Adult] unless entity @e[type=marker,tag=Guay1] run summon minecraft:marker 740 83 2720 {Tags:["Guay","Guay1"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
#2
execute if entity @a[tag=Adult] unless entity @e[type=marker,tag=Guay2] run summon minecraft:zombie 749 82 2766 {Tags:["Guay","Guay2","Invisible","Fire"],PersistenceRequired:1b,IsBaby:1b,Silent:1b,NoAI:1b,DeathLootTable:"ocarina_of_time:entities/guay",Health:1,Attributes:[{Name:"generic.max_health",Base:1}],ArmorItems:[{},{},{},{id:cobblestone,Count:1b,tag:{CustomModelData:87}}],ArmorDropChances:[0f,0f,0f,0f]}
execute if entity @a[tag=Adult] unless entity @e[type=marker,tag=Guay2] run summon minecraft:marker 749 82 2766 {Tags:["Guay","Guay2"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
