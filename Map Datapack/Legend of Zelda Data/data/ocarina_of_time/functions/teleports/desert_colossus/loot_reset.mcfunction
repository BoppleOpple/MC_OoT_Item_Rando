...
#Leever
scoreboard players set @e[type=marker,tag=LeeverSpawn] timer 0

#Fairy Fountain
fill 359 55 456 347 57 444 minecraft:air replace minecraft:water

#Bean Spots
execute if entity @a[tag=Adult] if entity @e[type=marker,tag=BeanSpot,tag=PlantBean3] run clone 396 48 403 398 48 405 398 55 391
execute unless entity @a[tag=Adult] if entity @e[type=marker,tag=BeanSpot,tag=PlantBean3] run fill 399 55 392 399 55 392 minecraft:pumpkin_stem[age=6]
