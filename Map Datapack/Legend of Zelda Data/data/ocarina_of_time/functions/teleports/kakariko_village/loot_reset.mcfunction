...
#Bean Spots
execute if entity @a[tag=Adult] if entity @e[type=marker,tag=BeanSpot,tag=PlantBean5] run clone 1613 76 1931 1615 76 1933 1612 75 1941
execute unless entity @a[tag=Adult] if entity @e[type=marker,tag=BeanSpot,tag=PlantBean5] run fill 1613 75 1942 1613 75 1942 minecraft:pumpkin_stem[age=6]
