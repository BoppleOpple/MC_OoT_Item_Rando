...
execute as @s[tag=LeaderScrub,scores={text=1}] at @s if entity @a[distance=..2] unless entity @s[tag=stoptext] as @e[type=marker,tag=Progress] if entity @s[tag=StickUpgrade1] run tag @s add StickUpgrade2
execute as @s[tag=LeaderScrub,scores={text=1}] at @s if entity @a[distance=..2] unless entity @s[tag=stoptext] as @e[type=marker,tag=Progress,tag=StickUpgrade2] run advancement grant @a only minecraft:_upgrades/stick_upgrade_2
execute as @s[tag=LeaderScrub,scores={text=1}] at @s if entity @a[distance=..2] unless entity @s[tag=stoptext] as @e[type=marker,tag=Progress,tag=StickUpgrade2] run tellraw @a ["",{"text":"You can now pick up even more "},{"text":"Deku Sticks","color":"red"},{"text":"! You can carry up to "},{"text":"30 ","color":"yellow"},{"text":"of them!"}]
execute as @s[tag=LeaderScrub,scores={text=1}] at @s if entity @a[distance=..2] unless entity @s[tag=stoptext] as @e[type=marker,tag=Progress,tag=StickUpgrade2] run give @a stick{display:{Name:"{\"text\":\"Deku Stick\"}"},DekuStick:1b,Item:1b} 30
execute as @s[tag=LeaderScrub,scores={text=1}] at @s if entity @a[distance=..2] unless entity @s[tag=stoptext] as @e[type=marker,tag=Progress] unless entity @s[tag=StickUpgrade1] run tag @s add StickUpgrade1
execute as @s[tag=LeaderScrub,scores={text=1}] at @s if entity @a[distance=..2] unless entity @s[tag=stoptext] as @e[type=marker,tag=Progress,tag=StickUpgrade1] unless entity @s[tag=StickUpgrade2] run advancement grant @a only minecraft:_upgrades/stick_upgrade_1
execute as @s[tag=LeaderScrub,scores={text=1}] at @s if entity @a[distance=..2] unless entity @s[tag=stoptext] as @e[type=marker,tag=Progress,tag=StickUpgrade1] unless entity @s[tag=StickUpgrade2] run tellraw @a ["",{"text":"Now you can pick up more "},{"text":"Deku Sticks","color":"red"},{"text":"! You can carry up to "},{"text":"20 ","color":"yellow"},{"text":"of them!"}]
execute as @s[tag=LeaderScrub,scores={text=1}] at @s if entity @a[distance=..2] unless entity @s[tag=stoptext] as @e[type=marker,tag=Progress,tag=StickUpgrade1] unless entity @s[tag=StickUpgrade2] run give @a stick{display:{Name:"{\"text\":\"Deku Stick\"}"},DekuStick:1b,Item:1b} 20
...
execute as @s[tag=LeaderScrub,scores={text=2}] at @s if entity @a[distance=..2] unless entity @s[tag=stoptext] as @e[type=marker,tag=Progress] if entity @s[tag=NutUpgrade1] run tag @s add NutUpgrade2
execute as @s[tag=LeaderScrub,scores={text=2}] at @s if entity @a[distance=..2] unless entity @s[tag=stoptext] as @e[type=marker,tag=Progress,tag=NutUpgrade2] run advancement grant @a only minecraft:_upgrades/nut_upgrade_2
execute as @s[tag=LeaderScrub,scores={text=2}] at @s if entity @a[distance=..2] unless entity @s[tag=stoptext] as @e[type=marker,tag=Progress,tag=NutUpgrade2] run tellraw @a ["",{"text":"You can now can carry even more "},{"text":"Deku Nuts","color":"red"},{"text":"! You can carry up to "},{"text":"40 ","color":"yellow"},{"text":"nuts!"}]
execute as @s[tag=LeaderScrub,scores={text=2}] at @s if entity @a[distance=..2] unless entity @s[tag=stoptext] as @e[type=marker,tag=Progress,tag=NutUpgrade2] run scoreboard players set @a DekuNuts 40
execute as @s[tag=LeaderScrub,scores={text=2}] at @s if entity @a[distance=..2] unless entity @s[tag=stoptext] as @e[type=marker,tag=Progress] unless entity @s[tag=NutUpgrade1] run tag @s add NutUpgrade1
execute as @s[tag=LeaderScrub,scores={text=2}] at @s if entity @a[distance=..2] unless entity @s[tag=stoptext] as @e[type=marker,tag=Progress,tag=NutUpgrade1] unless entity @s[tag=NutUpgrade2] run advancement grant @a only minecraft:_upgrades/nut_upgrade_1
execute as @s[tag=LeaderScrub,scores={text=2}] at @s if entity @a[distance=..2] unless entity @s[tag=stoptext] as @e[type=marker,tag=Progress,tag=NutUpgrade1] unless entity @s[tag=NutUpgrade2] run tellraw @a ["",{"text":"Now you can carry many "},{"text":"Deku Nuts","color":"red"},{"text":"! You can hold up to "},{"text":"30 ","color":"yellow"},{"text":"nuts!"}]
execute as @s[tag=LeaderScrub,scores={text=2}] at @s if entity @a[distance=..2] unless entity @s[tag=stoptext] as @e[type=marker,tag=Progress,tag=NutUpgrade1] unless entity @s[tag=NutUpgrade2] run scoreboard players set @a DekuNuts 30
