...
execute as @s[tag=Goron8,scores={text=3}] at @s if entity @a[distance=..2] unless entity @a[tag=Adult] unless entity @s[tag=stoptext] run tellraw @a ["",{"text":"Goron: ","color":"gold"},{"text":"How was Big Brother? I see... By the way, do you know the music coming from deep inside this tunnel? We all like this music!"}]
...
execute as @s[tag=Goron11,scores={text=2},tag=Wait] at @s if entity @a[distance=..2] as @e[type=marker,tag=Progress] if entity @s[tag=BombUpgrade1] run tag @s add BombUpgrade2
execute as @s[tag=Goron11,scores={text=2},tag=Wait] at @s if entity @a[distance=..2] if entity @e[type=marker,tag=Progress,tag=BombUpgrade2] run advancement grant @a only minecraft:_upgrades/bomb_upgrade_2
execute as @s[tag=Goron11,scores={text=2},tag=Wait] at @s if entity @a[distance=..2] if entity @e[type=marker,tag=Progress,tag=BombUpgrade2] run tellraw @a ["",{"text":"You got the ","color":"white"},{"text":"Biggest Bomb Bag","color":"red"},{"text":"! Now you can carry up to "},{"text":"40 ","color":"yellow"},{"text":"Bombs!"}]
execute as @s[tag=Goron11,scores={text=2},tag=Wait] at @s if entity @a[distance=..2] if entity @e[type=marker,tag=Progress,tag=BombUpgrade2] run give @p tnt{display:{Name:"\"Bomb\""}} 50
execute as @s[tag=Goron11,scores={text=2},tag=Wait] at @s if entity @a[distance=..2] as @e[type=marker,tag=Progress] unless entity @s[tag=BombUpgrade1] run tag @s add BombUpgrade1
execute as @s[tag=Goron11,scores={text=2},tag=Wait] at @s if entity @a[distance=..2] as @e[type=marker,tag=Progress,tag=BombUpgrade1] unless entity @s[tag=BombUpgrade2] run advancement grant @a only minecraft:_upgrades/bomb_upgrade_1
execute as @s[tag=Goron11,scores={text=2},tag=Wait] at @s if entity @a[distance=..2] as @e[type=marker,tag=Progress,tag=BombUpgrade1] unless entity @s[tag=BombUpgrade2] run tellraw @a ["",{"text":"You got a "},{"text":"Big Bomb Bag","color":"red"},{"text":"! Now you can carry more bombs, up to a maximum of "},{"text":"30","color":"yellow"},{"text":"!"}]
execute as @s[tag=Goron11,scores={text=2},tag=Wait] at @s if entity @a[distance=..2] as @e[type=marker,tag=Progress,tag=BombUpgrade1] unless entity @s[tag=BombUpgrade2] run give @p tnt{display:{Name:"\"Bomb\""}} 50
