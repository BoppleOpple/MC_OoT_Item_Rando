...
execute unless block 411 57 2718 minecraft:gold_block if score @s timer > @s lifetime if entity @s[scores={timer=13..21}] run tag @e[type=marker,tag=Progress] add GoldenScale
