...
#Business Scrub 3
execute as @s[tag=BusinessScrub12,scores={text=1}] at @s if entity @a[distance=..3] if entity @e[type=marker,tag=Progress,tag=Bombs] run summon minecraft:villager ~ ~-1 ~ {Tags:["ScrubShop","Invisible"],PersistenceRequired:1,Invulnerable:1,Silent:1,NoAI:1,Offers:{Recipes:[{buy:{id:lime_dye,Count:40,tag:{Item:1b,display:{Name:"{\"text\":\"Green Rupee\"}"}}},sell:{id:tnt,Count:5,tag:{display:{Name:"\"Bomb\""}}},rewardExp:0b,maxUses:9999999}]}}
execute as @s[tag=BusinessScrub12,scores={text=1}] at @s if entity @a[distance=..3] if entity @e[type=marker,tag=Progress,tag=Bombs] run tellraw @a ["",{"text":"Business Scrub: ","color":"gold"},{"text":"I quit! If you let me go, I'll sell you some "},{"text":"bombs","color":"red"},{"text":"! "},{"text":"Five ","color":"red"},{"text":"for "},{"text":"40 Rupees ","color":"red"},{"text":"they are! Let's make a deal!"}]
execute as @s[tag=BusinessScrub12,scores={text=1}] at @s if entity @a[distance=..3] unless entity @e[type=marker,tag=Progress,tag=Bombs] run summon minecraft:villager ~ ~-1 ~ {Tags:["ScrubShop","Invisible"],PersistenceRequired:1,Invulnerable:1,Silent:1,NoAI:1,Offers:{Recipes:[{buy:{id:lime_dye,Count:15,tag:{Item:1b,display:{Name:"{\"text\":\"Green Rupee\"}"}}},sell:{id:stick,Count:1,tag:{display:{Name:"{\"text\":\"Deku Stick\"}"},DekuStick:1b,Item:1b}},rewardExp:0b,maxUses:1}]}}
execute as @s[tag=BusinessScrub12,scores={text=1}] at @s if entity @a[distance=..3] unless entity @e[type=marker,tag=Progress,tag=Bombs] run tellraw @a ["",{"text":"Business Scrub: ","color":"gold"},{"text":"All right! You win! In return, I will sell you Deku Sticks! "},{"text":"One","color":"red"},{"text":" for "},{"text":"15 Rupees","color":"red"},{"text":" they are! Let's make a deal!"}]
