...
execute if entity @s[scores={lifetime=1}] run scoreboard players set @a ArrowCount2 50
...
execute if entity @s[scores={lifetime=706}] run fill ^-5 ^ ^-2 ^5 ^1 ^-7 minecraft:air replace minecraft:barrier
...
execute if entity @s[scores={lifetime=710}] as @e[type=armor_stand,tag=PermanentGerudo5] if entity @s[tag=Prize1] unless entity @s[tag=Prize2] if entity @a[scores={Score=1500..}] as @e[type=marker,tag=Progress] if entity @s[tag=FairyBowUpgrade1] run tag @s add FairyBowUpgrade2
execute if entity @s[scores={lifetime=710}] as @e[type=armor_stand,tag=PermanentGerudo5] if entity @s[tag=Prize1] unless entity @s[tag=Prize2] if entity @a[scores={Score=1500..}] if entity @e[type=marker,tag=Progress,tag=FairyBowUpgrade2] run advancement grant @a only minecraft:_upgrades/biggest_quiver
execute if entity @s[scores={lifetime=710}] as @e[type=armor_stand,tag=PermanentGerudo5] if entity @s[tag=Prize1] unless entity @s[tag=Prize2] if entity @a[scores={Score=1500..}] if entity @e[type=marker,tag=Progress,tag=FairyBowUpgrade2] run tellraw @a ["",{"text":"You upgraded your quiver to the ","color":"white"},{"text":"Biggest Quiver","color":"red"},{"text":"! Now you can carry even more arrows, to the maximum of "},{"text":"50","color":"yellow"},{"text":"!"}]
execute if entity @s[scores={lifetime=710}] as @e[type=armor_stand,tag=PermanentGerudo5] if entity @s[tag=Prize1] unless entity @s[tag=Prize2] if entity @a[scores={Score=1500..}] if entity @e[type=marker,tag=Progress,tag=FairyBowUpgrade2] run scoreboard players set @a ArrowCount2 50
execute if entity @s[scores={lifetime=710}] as @e[type=armor_stand,tag=PermanentGerudo5] if entity @s[tag=Prize1] unless entity @s[tag=Prize2] if entity @a[scores={Score=1500..}] as @e[type=marker,tag=Progress] unless entity @s[tag=FairyBowUpgrade1] run tag @s add FairyBowUpgrade1
execute if entity @s[scores={lifetime=710}] as @e[type=armor_stand,tag=PermanentGerudo5] if entity @s[tag=Prize1] unless entity @s[tag=Prize2] if entity @a[scores={Score=1500..}] as @e[type=marker,tag=Progress,tag=FairyBowUpgrade1] unless entity @s[tag=FairyBowUpgrade2] run advancement grant @a only minecraft:_upgrades/big_quiver
...
execute if entity @s[scores={lifetime=710}] as @e[type=armor_stand,tag=PermanentGerudo5] if entity @s[tag=Prize1] unless entity @s[tag=Prize2] if entity @a[scores={Score=1500..}] as @e[type=marker,tag=Progress,tag=FairyBowUpgrade1] unless entity @s[tag=FairyBowUpgrade2] run scoreboard players set @a ArrowCount2 40
...
#End
execute if entity @s[scores={lifetime=711}] run fill 2 101 1888 -154 101 1906 minecraft:air replace minecraft:barrier
