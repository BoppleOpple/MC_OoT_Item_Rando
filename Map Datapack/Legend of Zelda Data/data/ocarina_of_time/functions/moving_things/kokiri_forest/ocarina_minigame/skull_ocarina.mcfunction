...
execute if entity @s[scores={lifetime=1}] if entity @e[type=marker,tag=Songs,tag=!Lullaby] run tag @s add RemoveLullaby
execute if entity @s[scores={lifetime=1}] if entity @e[type=marker,tag=Songs,tag=!Lullaby] run tag @e[type=marker,tag=Songs] add Lullaby
...
#Next Note
execute if entity @s[scores={lifetime=2950}] unless entity @s[scores={GameTimer=1..}] run tag @a remove NoOcarina
...
execute if entity @s[scores={lifetime=3010..}] if entity @s[tag=RemoveLullaby] run tag @e[type=marker,tag=Songs] remove Lullaby
