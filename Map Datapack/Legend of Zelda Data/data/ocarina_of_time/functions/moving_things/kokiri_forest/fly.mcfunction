...
#Sounds
execute if entity @s[scores={lifetime=324}] run playsound minecraft:entity.axolotl.idle_air master @a ~ ~ ~ 1 1
execute if entity @s[scores={lifetime=440}] run playsound minecraft:entity.axolotl.idle_air master @a ~ ~ ~ 1 1
execute if entity @s[scores={lifetime=622}] run playsound minecraft:entity.axolotl.hurt master @a ~ ~ ~ 1 1
