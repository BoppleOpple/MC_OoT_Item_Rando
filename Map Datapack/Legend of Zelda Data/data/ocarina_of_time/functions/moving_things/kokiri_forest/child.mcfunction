...
execute if entity @a[x=-550,y=65,z=-638,dx=0,dz=0] unless entity @e[type=marker,tag=BeanSpot,tag=PlantBean6] if entity @a[nbt={SelectedItem:{tag:{MagicBean:1b}}}] positioned -550 65 -638 run function ocarina_of_time:items/magic_bean
execute if block -550 65 -638 minecraft:pumpkin_stem[age=6] as @e[type=marker,tag=BeanSpot] unless entity @s[tag=PlantBean6] run tag @s add PlantBean6
#2
fill -633 68 -644 -633 68 -644 minecraft:farmland[moisture=0]
execute if entity @a[x=-633,y=69,z=-644,dx=0,dz=0] unless entity @e[type=marker,tag=BeanSpot,tag=PlantBean7] if entity @a[nbt={SelectedItem:{tag:{MagicBean:1b}}}] positioned -633 69 -644 run function ocarina_of_time:items/magic_bean
execute if block -633 69 -644 minecraft:pumpkin_stem[age=6] as @e[type=marker,tag=BeanSpot] unless entity @s[tag=PlantBean7] run tag @s add PlantBean7
#3
fill -582 74 -705 -582 74 -705 minecraft:farmland[moisture=0]
execute if entity @a[x=-582,y=75,z=-705,dx=0,dz=0] unless entity @e[type=marker,tag=BeanSpot,tag=PlantBean8] if entity @a[nbt={SelectedItem:{tag:{MagicBean:1b}}}] positioned -582 75 -705 run function ocarina_of_time:items/magic_bean
execute if block -582 75 -705 minecraft:pumpkin_stem[age=6] as @e[type=marker,tag=BeanSpot] unless entity @s[tag=PlantBean8] run tag @s add PlantBean8
