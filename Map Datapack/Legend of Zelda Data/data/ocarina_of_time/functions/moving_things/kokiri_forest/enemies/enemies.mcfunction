#Deku Babas
#1
execute unless entity @a[tag=NotStarted] unless entity @a[tag=MeetNavi] unless entity @a[tag=MeetDekuTree,x=-516,y=65,z=-644,dx=5,dy=2,dz=5] unless entity @a[tag=DeadDekuTree] unless entity @e[type=wither_skeleton,tag=DekuBabaBody1] unless entity @a[tag=Adult] unless entity @e[type=wither_skeleton,tag=DekuBabaBody1] if entity @e[type=marker,tag=DekuBabaHealth1,scores={lifetime=300..}] run function ocarina_of_time:moving_things/kokiri_forest/enemies/deku_baba1
...
execute unless entity @a[tag=NotStarted] unless entity @a[tag=MeetNavi] unless entity @a[tag=MeetDekuTree,x=-516,y=65,z=-644,dx=5,dy=2,dz=5] unless entity @a[tag=DeadDekuTree] unless entity @e[type=wither_skeleton,tag=DekuBabaBody1] run scoreboard players add @e[type=marker,tag=DekuBabaHealth1] lifetime 1
#2
execute unless entity @a[tag=NotStarted] unless entity @a[tag=MeetNavi] unless entity @a[tag=MeetDekuTree,x=-516,y=65,z=-644,dx=5,dy=2,dz=5] unless entity @a[tag=DeadDekuTree] unless entity @e[type=wither_skeleton,tag=DekuBabaBody2] unless entity @a[tag=Adult] unless entity @e[type=wither_skeleton,tag=DekuBabaBody2] if entity @e[type=marker,tag=DekuBabaHealth2,scores={lifetime=300..}] run function ocarina_of_time:moving_things/kokiri_forest/enemies/deku_baba2
...
execute unless entity @a[tag=NotStarted] unless entity @a[tag=MeetNavi] unless entity @a[tag=MeetDekuTree,x=-516,y=65,z=-644,dx=5,dy=2,dz=5] unless entity @a[tag=DeadDekuTree] unless entity @e[type=wither_skeleton,tag=DekuBabaBody2] run scoreboard players add @e[type=marker,tag=DekuBabaHealth2] lifetime 1
#3
execute unless entity @a[tag=NotStarted] unless entity @a[tag=MeetNavi] unless entity @a[tag=MeetDekuTree,x=-516,y=65,z=-644,dx=5,dy=2,dz=5] unless entity @a[tag=DeadDekuTree] unless entity @e[type=wither_skeleton,tag=DekuBabaBody3] unless entity @a[tag=Adult] unless entity @e[type=wither_skeleton,tag=DekuBabaBody3] if entity @e[type=marker,tag=DekuBabaHealth3,scores={lifetime=300..}] run function ocarina_of_time:moving_things/kokiri_forest/enemies/deku_baba3
...
execute unless entity @a[tag=NotStarted] unless entity @a[tag=MeetNavi] unless entity @a[tag=MeetDekuTree,x=-516,y=65,z=-644,dx=5,dy=2,dz=5] unless entity @a[tag=DeadDekuTree] unless entity @e[type=wither_skeleton,tag=DekuBabaBody3] run scoreboard players add @e[type=marker,tag=DekuBabaHealth3] lifetime 1
