...
#Fly Navi
execute if entity @a[tag=FlyNavi] unless entity @e[type=marker,tag=Fly] run summon minecraft:marker -488.500 72.00000 -641.500 {Tags:["Fly"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute as @e[type=marker,tag=Fly] at @s run function ocarina_of_time:moving_things/kokiri_forest/fly
...
#Hopping Stones
execute as @e[type=marker,tag=HoppingStones] unless entity @a[tag=Adult] if entity @a[x=-575,y=66,z=-634,dx=11,dy=1,dz=3] run function ocarina_of_time:moving_things/kokiri_forest/hopping_stones
execute as @e[type=marker,tag=HoppingStones] unless entity @a[tag=Adult] unless entity @a[x=-575,y=66,z=-634,dx=11,dy=1,dz=3] unless entity @s[tag=0] run tag @s remove 1
execute as @e[type=marker,tag=HoppingStones] unless entity @a[tag=Adult] unless entity @a[x=-575,y=66,z=-634,dx=11,dy=1,dz=3] unless entity @s[tag=0] run tag @s remove 2
execute as @e[type=marker,tag=HoppingStones] unless entity @a[tag=Adult] unless entity @a[x=-575,y=66,z=-634,dx=11,dy=1,dz=3] unless entity @s[tag=0] run tag @s remove 3
execute as @e[type=marker,tag=HoppingStones] unless entity @a[tag=Adult] unless entity @a[x=-575,y=66,z=-634,dx=11,dy=1,dz=3] unless entity @s[tag=0] run tag @s remove Wait
...
#Regen Bushes
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill -590 69 -579 -590 69 -579 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill -596 69 -587 -596 69 -587 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill -582 70 -575 -582 70 -575 minecraft:fern

#Pots
execute as @e[type=marker,tag=Pots] run function ocarina_of_time:moving_things/kokiri_forest/pots
...
execute if block -610 44 -697 minecraft:stone_button[powered=true] as @e[type=marker,tag=Secrets] run function ocarina_of_time:moving_things/kokiri_forest/secrets
execute if block -610 44 -699 minecraft:stone_button[powered=true] as @e[type=marker,tag=Secrets] run tellraw @a ["",{"text":"Total secrets found: "},{"score":{"name":"@s","objective":"timer"},"color":"red"}]
...
#Big Fairies
execute positioned -552 75 -684 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run summon minecraft:armor_stand -552 75 -684 {Tags:["GreenNavi"],Small:1b,Marker:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;-102214788,162220947,-1666754575,1836136248],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTljNTE1NDVkNTQ5NDczZWNjYWE2NzdiZTc3ZmM4OTNjZmEwNWVjMWYwM2I4NWMyZWJjMjM0MmM0YTlmOTdjMyJ9fX0="}]}}}}]}
execute positioned -552 75 -684 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run tag @a add GreenNaviSpot
execute positioned -552 75 -684 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_stal",Count:1b}]}] run function ocarina_of_time:items/big_fairy/summon
...
#Deku Stick Upgrade
execute unless block -629 62 -609 minecraft:gold_block if entity @a[nbt={Inventory:[{tag:{DekuStickUpgrade:1b}}]}] as @e[type=marker,tag=Progress] run function ocarina_of_time:moving_things/kokiri_forest/deku_stick_upgrade
#Deku Nut Upgrade
execute unless block -580 47 -711 minecraft:gold_block if entity @a[nbt={Inventory:[{tag:{DekuNutUpgrade:1b}}]}] as @e[type=marker,tag=Progress] run function ocarina_of_time:moving_things/kokiri_forest/deku_nut_upgrade
