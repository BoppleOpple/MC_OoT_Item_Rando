#Pots
execute as @e[type=marker,tag=Pots] run function ocarina_of_time:moving_things/spirit_temple/pots

#Hookshot
execute as @e[type=marker,tag=Hookshot] at @s unless entity @s[scores={Hookshot=200..}] run function ocarina_of_time:moving_things/spirit_temple/hookshot
...
#4
execute if entity @a[x=-54,y=77,z=849,dx=15,dz=5] run effect give @a minecraft:wither 1 1 true
execute if entity @a[x=-54,y=77,z=849,dx=15,dz=5] run tp @a -47 87 860
...
#Silver Rupees
#1
execute if block -44 88 835 minecraft:air if block -27 115 789 minecraft:black_terracotta if entity @e[type=armor_stand,tag=Rock] if entity @e[type=marker,tag=SilverRupeeCounter,scores={BlueRupee=0}] run fill -46 93 848 -48 87 848 minecraft:air
execute if block -44 88 835 minecraft:air if block -27 115 789 minecraft:black_terracotta if entity @e[type=armor_stand,tag=Rock] if entity @e[type=marker,tag=SilverRupeeCounter,scores={BlueRupee=0}] run clone -80 81 838 -78 81 843 -48 86 849
execute if block -44 88 835 minecraft:air if block -27 115 789 minecraft:black_terracotta if entity @e[type=armor_stand,tag=Rock] if entity @e[type=marker,tag=SilverRupeeCounter,scores={BlueRupee=0}] run fill -44 88 835 -44 88 835 minecraft:gold_block
#2
execute if block -58 112 890 minecraft:air if block -27 115 789 minecraft:black_terracotta if entity @e[type=armor_stand,tag=Rock] if entity @e[type=marker,tag=SilverRupeeCounter,scores={BlueRupee2=0}] run fill -46 93 848 -48 87 848 minecraft:air
execute if block -58 112 890 minecraft:air if block -27 115 789 minecraft:black_terracotta if entity @e[type=armor_stand,tag=Rock] if entity @e[type=marker,tag=SilverRupeeCounter,scores={BlueRupee2=0}] run playsound minecraft:block.fire.ambient ambient @a ~ ~ ~ 1 1
execute if block -58 112 890 minecraft:air if block -27 115 789 minecraft:black_terracotta if entity @e[type=armor_stand,tag=Rock] if entity @e[type=marker,tag=SilverRupeeCounter,scores={BlueRupee2=0}] run tag @e[type=armor_stand,tag=UnlitTorch,x=-64,y=110,z=875,dx=0,dz=0] add LitTorch
execute if block -58 112 890 minecraft:air if block -27 115 789 minecraft:black_terracotta if entity @e[type=armor_stand,tag=Rock] if entity @e[type=marker,tag=SilverRupeeCounter,scores={BlueRupee2=0}] run fill -64 111 875 -64 111 875 minecraft:torch
execute if block -58 112 890 minecraft:air if block -27 115 789 minecraft:black_terracotta if entity @e[type=armor_stand,tag=Rock] if entity @e[type=marker,tag=SilverRupeeCounter,scores={BlueRupee2=0}] run fill -58 112 890 -58 112 890 minecraft:gold_block
#3
execute if block 21 90 865 minecraft:air if block -27 115 789 minecraft:black_terracotta if entity @e[type=armor_stand,tag=Rock] if entity @e[type=marker,tag=SilverRupeeCounter,scores={RedRupee=0}] at @a run playsound minecraft:block.iron_door.open ambient @a ~ ~ ~ .3 1
execute if block 21 90 865 minecraft:air if block -27 115 789 minecraft:black_terracotta if entity @e[type=armor_stand,tag=Rock] if entity @e[type=marker,tag=SilverRupeeCounter,scores={RedRupee=0}] run fill 19 82 836 19 82 836 minecraft:stone_pressure_plate
execute if block 21 90 865 minecraft:air if block -27 115 789 minecraft:black_terracotta if entity @e[type=armor_stand,tag=Rock] if entity @e[type=marker,tag=SilverRupeeCounter,scores={RedRupee=0}] run fill 21 90 865 21 90 865 minecraft:gold_block
...
execute if entity @a[x=12,y=83,z=839,dx=5,dy=3,dz=12] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_wait",Count:1b}]}] run scoreboard players add @e[type=marker,tag=TimeBlock] timer 1
execute if entity @a[x=9,y=111,z=882,dx=8,dz=6] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_wait",Count:1b}]}] run scoreboard players add @e[type=marker,tag=TimeBlock] lifetime 1

#Big Fairies
execute positioned 19 83 827 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run summon minecraft:armor_stand 19 83 827 {Tags:["GreenNavi"],Small:1b,Marker:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;-102214788,162220947,-1666754575,1836136248],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTljNTE1NDVkNTQ5NDczZWNjYWE2NzdiZTc3ZmM4OTNjZmEwNWVjMWYwM2I4NWMyZWJjMjM0MmM0YTlmOTdjMyJ9fX0="}]}}}}]}
execute positioned 19 83 827 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run tag @a add GreenNaviSpot
execute positioned 19 83 827 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_stal",Count:1b}]}] run function ocarina_of_time:items/big_fairy/summon
