...
#Ice Beam
execute as @e[type=marker,tag=IceBeam] at @s run function ocarina_of_time:moving_things/spirit_temple/boss/ice_beam

#Fire Beam
execute as @e[type=marker,tag=FireBeam] at @s run function ocarina_of_time:moving_things/spirit_temple/boss/fire_beam

#Platform Spot
execute as @e[type=marker,tag=TwinrovaSpot] at @s run function ocarina_of_time:moving_things/spirit_temple/boss/spot
