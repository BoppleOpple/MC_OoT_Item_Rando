...
execute if entity @s[scores={timer=20..21}] facing entity @e[type=marker,tag=TwinrovaSpot,tag=!Cooldown,sort=random] feet rotated ~ 0 run tp @s ~ ~ ~ ~ 0
execute if entity @s[scores={timer=25..}] unless entity @s[tag=Shoot] run tp @s ^ ^ ^.5 ~ 0
execute if entity @s[scores={timer=25..}] if entity @e[type=marker,tag=TwinrovaSpot,tag=!Cooldown,distance=..1] run tag @s add Shoot
...
execute if entity @s[tag=Fire] if entity @s[scores={timer=291}] run summon minecraft:marker ^-4.5 ^-.5 ^1 {Tags:["Twinrova","FireBeam"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute if entity @s[tag=Fire] at @e[type=marker,tag=FireBeam] run particle minecraft:flame ~ ~ ~ .1 .1 .1 0 1 normal
...
execute if entity @a[tag=ReflectFire] if entity @a[nbt={Inventory:[{Slot:-106b,tag:{MirrorShield:1b}}]}] unless entity @s[scores={GameTimer=81..}] run item replace entity @a weapon.offhand with minecraft:shield{MirrorShield:1b,display:{Name:"\"Mirror Shield\""},Unbreakable:1b,Damage:4}
...
execute if entity @a[tag=ReflectFire] if entity @a[nbt={SelectedItem:{tag:{MirrorShield:1b}}}] unless entity @s[scores={GameTimer=81..}] run item replace entity @a weapon.mainhand with minecraft:shield{MirrorShield:1b,display:{Name:"\"Mirror Shield\""},Unbreakable:1b,Damage:4}
...
execute if entity @s[tag=Ice] if entity @s[scores={timer=291}] run summon minecraft:marker ^4.5 ^-.5 ^1 {Tags:["Twinrova","IceBeam"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute if entity @s[tag=Ice] at @e[type=marker,tag=IceBeam] run particle minecraft:soul_fire_flame ~ ~ ~ .1 .1 .1 0 1 normal
...
execute if entity @a[tag=ReflectIce] if entity @a[nbt={Inventory:[{Slot:-106b,tag:{MirrorShield:1b}}]}] unless entity @s[scores={GameTimer=81..}] run item replace entity @a weapon.offhand with minecraft:shield{MirrorShield:1b,display:{Name:"\"Mirror Shield\""},Unbreakable:1b,Damage:5}
...
execute if entity @a[tag=ReflectIce] if entity @a[nbt={SelectedItem:{tag:{MirrorShield:1b}}}] unless entity @s[scores={GameTimer=81..}] run item replace entity @a weapon.mainhand with minecraft:shield{MirrorShield:1b,display:{Name:"\"Mirror Shield\""},Unbreakable:1b,Damage:5}
