...
#Bombs
execute as @e[type=marker,tag=Bomb2] at @s if entity @a[tag=InDeathMountain] run function ocarina_of_time:moving_things/death_mountain/bomb
...
execute unless entity @e[type=marker,tag=Progress,tag=HalfMagic] unless entity @e[type=marker,tag=Progress,tag=FullMagic] run scoreboard players set @e[type=armor_stand,tag=OwlStand9] text 1
execute if entity @e[type=marker,tag=Progress,tag=HalfMagic] run scoreboard players set @e[type=armor_stand,tag=OwlStand9] text 2
execute if entity @e[type=marker,tag=Progress,tag=FullMagic] run scoreboard players set @e[type=armor_stand,tag=OwlStand9] text 2
execute as @e[type=armor_stand,tag=OwlFly] at @s run function ocarina_of_time:moving_things/death_mountain/owl
execute if entity @a[tag=Fly] unless entity @e[type=marker,tag=Fly] run summon minecraft:marker 2026.505 158.00000 1347.643 {Tags:["Fly"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute as @e[type=marker,tag=Fly] at @s run function ocarina_of_time:moving_things/death_mountain/fly

#Meteors
execute as @e[type=marker,tag=Meteor] at @a unless block 2021 100 1406 minecraft:gold_block if entity @a[tag=Adult,x=2018,y=113,z=1364,dx=14,dy=14,dz=64] run function ocarina_of_time:moving_things/death_mountain/meteor/meteor_1
execute as @e[type=marker,tag=Meteor] at @a unless entity @a[tag=Adult] if entity @a[x=2018,y=113,z=1364,dx=14,dy=14,dz=64] run function ocarina_of_time:moving_things/death_mountain/meteor/meteor_1
execute as @e[type=marker,tag=Meteor] unless entity @a[x=2018,y=113,z=1364,dx=14,dy=14,dz=64] run function ocarina_of_time:moving_things/death_mountain/meteor/meteor_2
...
#Bug Rock
execute as @e[type=marker,tag=Pots] run function ocarina_of_time:moving_things/death_mountain/rock
...
#Big Fairies
execute positioned 2031 107 1477 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run summon minecraft:armor_stand 2031 107 1477 {Tags:["GreenNavi"],Small:1b,Marker:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;-102214788,162220947,-1666754575,1836136248],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTljNTE1NDVkNTQ5NDczZWNjYWE2NzdiZTc3ZmM4OTNjZmEwNWVjMWYwM2I4NWMyZWJjMjM0MmM0YTlmOTdjMyJ9fX0="}]}}}}]}
execute positioned 2031 107 1477 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run tag @a add GreenNaviSpot
execute positioned 2031 107 1477 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_stal",Count:1b}]}] run function ocarina_of_time:items/big_fairy/summon
execute positioned 2023 67 1471 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run summon minecraft:armor_stand 2023 67 1471 {Tags:["GreenNavi"],Small:1b,Marker:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;-102214788,162220947,-1666754575,1836136248],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTljNTE1NDVkNTQ5NDczZWNjYWE2NzdiZTc3ZmM4OTNjZmEwNWVjMWYwM2I4NWMyZWJjMjM0MmM0YTlmOTdjMyJ9fX0="}]}}}}]}
execute positioned 2023 67 1471 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run tag @a add GreenNaviSpot
execute positioned 2023 67 1471 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_stal",Count:1b}]}] run function ocarina_of_time:items/big_fairy/summon
