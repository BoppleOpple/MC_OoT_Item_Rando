...
execute if entity @a[x=2011,y=93,z=1451,dx=0,dz=0] unless entity @e[type=marker,tag=BeanSpot,tag=PlantBean1] if entity @a[nbt={SelectedItem:{tag:{MagicBean:1b}}}] positioned 2011 93 1451 run function ocarina_of_time:items/magic_bean
execute if block 2011 93 1451 minecraft:pumpkin_stem[age=6] as @e[type=marker,tag=BeanSpot] unless entity @s[tag=PlantBean1] run tag @s add PlantBean1
