...
execute if entity @s[scores={lifetime=1}] run summon minecraft:marker ~ ~ ~ {Tags:["DodongoRock"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute if entity @s[scores={lifetime=2}] run tp @e[type=marker,tag=DodongoRock] @p
...
execute if entity @s[scores={lifetime=31}] run tp @a @e[type=marker,tag=DodongoRock,limit=1]
execute if entity @s[scores={lifetime=31}] run kill @e[type=marker,tag=DodongoRock]
