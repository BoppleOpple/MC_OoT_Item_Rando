...
execute unless block 878 77 1995 minecraft:air run data merge entity @e[type=marker,tag=Wallet,limit=1] {Tags:["Wallet"]}
execute unless block 878 77 1995 minecraft:air run data merge entity @e[type=marker,tag=Songs,limit=1] {Tags:["Songs"]}
execute unless block 878 77 1995 minecraft:air run data merge entity @e[type=marker,tag=Progress,limit=1] {Tags:["Progress"]}
execute unless block 878 77 1995 minecraft:air run scoreboard players reset @e[type=marker,tag=Progress,limit=1]
execute unless block 878 77 1995 minecraft:air run scoreboard players reset @e[type=marker,tag=Progress,limit=1]
execute unless block 878 77 1995 minecraft:air run scoreboard players reset @e[type=marker,tag=FakeSaria]
...
#Quit Game
execute if entity @a[name=!Rivero7462] unless block 878 60 1997 minecraft:gold_block run scoreboard players set @a Intro 1
execute if entity @a[name=!Rivero7462] unless block 878 60 1997 minecraft:gold_block run fill 878 60 1997 878 60 1997 minecraft:gold_block
...
execute if entity @a[scores={Intro=1..}] run advancement grant @a everything
execute if entity @a[scores={Intro=1..}] run advancement revoke @a through minecraft:_gear/root
execute if entity @a[scores={Intro=1..}] run advancement revoke @a through minecraft:_health/root
execute if entity @a[scores={Intro=1..}] run advancement revoke @a through minecraft:_ocarina/root
execute if entity @a[scores={Intro=1..}] run advancement revoke @a through minecraft:_skulltulas/root
execute if entity @a[scores={Intro=1..}] run advancement revoke @a through minecraft:_upgrades/root
execute if entity @a[scores={Intro=1..}] run advancement revoke @a through minecraft:_secrets/root
...
#Start
execute if block 875 76 1995 minecraft:lectern{Page:2} run fill 875 77 1995 875 77 1995 minecraft:stone_button[facing=east] replace minecraft:air

execute if block 875 77 1995 minecraft:stone_button[powered=true] run scoreboard players set @e[type=marker,tag=Progress] Bottle 0
...
execute if block 875 77 1995 minecraft:stone_button[powered=true] at @a run summon minecraft:marker ~ ~ ~ {Tags:["OpeningCutscene"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
