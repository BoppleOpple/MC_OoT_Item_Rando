...
execute unless entity @s[tag=Reverse] if entity @e[type=marker,tag=AdultGoron,distance=..0.2] unless entity @s[tag=Cooldown] run scoreboard players remove @s timer 1
execute unless entity @s[tag=Reverse] if entity @e[type=marker,tag=AdultGoron,distance=..0.2] run tag @s add Cooldown
execute if entity @s[tag=Reverse] if entity @e[type=marker,tag=AdultGoron,distance=..0.2] unless entity @s[tag=Cooldown] run scoreboard players add @s timer 1
execute if entity @s[tag=Reverse] if entity @e[type=marker,tag=AdultGoron,distance=..0.2] run tag @s add Cooldown
...
execute unless entity @s[tag=Wait] if entity @s[scores={timer=1}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=AdultGoron1,limit=1]
execute unless entity @s[tag=Wait] if entity @s[scores={timer=2}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=AdultGoron2,limit=1]
execute unless entity @s[tag=Wait] if entity @s[scores={timer=3}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=AdultGoron3,limit=1]
execute unless entity @s[tag=Wait] if entity @s[scores={timer=4}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=AdultGoron4,limit=1]
execute unless entity @s[tag=Wait] if entity @s[scores={timer=5}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=AdultGoron5,limit=1]
execute unless entity @s[tag=Wait] if entity @s[scores={timer=6}] run tp @s ^ ^ ^.3 facing entity @e[type=marker,tag=AdultGoron6,limit=1]
