...
#Rolling Goron
execute unless entity @e[type=marker,tag=AdultGoron1] run summon minecraft:marker 2167 67.9 1843 {Tags:["AdultGoron1","AdultGoron"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute unless entity @e[type=marker,tag=AdultGoron2] run summon minecraft:marker 2166 67.9 1822 {Tags:["AdultGoron2","AdultGoron"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute unless entity @e[type=marker,tag=AdultGoron3] run summon minecraft:marker 2172 67.9 1813 {Tags:["AdultGoron3","AdultGoron"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute unless entity @e[type=marker,tag=AdultGoron4] run summon minecraft:marker 2182 67.9 1812 {Tags:["AdultGoron4","AdultGoron"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute unless entity @e[type=marker,tag=AdultGoron5] run summon minecraft:marker 2192 67.9 1820 {Tags:["AdultGoron5","AdultGoron"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute unless entity @e[type=marker,tag=AdultGoron6] run summon minecraft:marker 2191 67.9 1844 {Tags:["AdultGoron6","AdultGoron"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
...
#Medigoron
data merge entity @e[type=villager,tag=Medigoronshop,limit=1] {Offers:{Recipes:[{buy:{id:lapis_lazuli,Count:40,tag:{Item:1b,display:{Name:"{\"text\":\"Blue Rupee\"}"}}},sell:{id:golden_sword,Count:1,tag:{display:{Name:"\"Giant's Knife\""},HideFlags:63,Damage:24,CanDestroy:["minecraft:grass","minecraft:oak_sign","minecraft:fern","minecraft:flower_pot","minecraft:azalea_leaves"],Enchantments:[{id:sharpness,lvl:19}],GiantKnife:1b,MainHandItem:1b}},rewardExp:0b,maxUses:9999999}]}}
