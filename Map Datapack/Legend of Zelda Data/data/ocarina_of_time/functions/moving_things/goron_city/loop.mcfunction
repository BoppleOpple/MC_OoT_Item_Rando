...
#Bomb wall
#1
execute as @e[type=marker,tag=Bomb1] at @s run function ocarina_of_time:moving_things/goron_city/bomb_walls
...
#Pots
execute as @e[type=marker,tag=Pots] run function ocarina_of_time:moving_things/goron_city/pots
...
execute if entity @a[x=2204,y=71,z=1813,dx=5,dz=7] unless entity @a[x=2206,y=71,z=1815,dx=1,dz=1] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_wait",Count:1b}]}] run scoreboard players add @e[type=marker,tag=TimeBlock] timer 1
execute if entity @a[x=2204,y=71,z=1800,dx=5,dy=2,dz=7] unless entity @a[x=2206,y=71,z=1804,dx=1,dy=1,dz=1] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_wait",Count:1b}]}] run scoreboard players add @e[type=marker,tag=TimeBlock] lifetime 1
