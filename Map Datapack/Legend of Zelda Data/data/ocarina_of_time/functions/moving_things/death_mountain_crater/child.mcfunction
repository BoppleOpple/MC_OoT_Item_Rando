...
execute if entity @a[x=2687,y=37,z=1944,dx=0,dz=0] unless entity @e[type=marker,tag=BeanSpot,tag=PlantBean2] if entity @a[nbt={SelectedItem:{tag:{MagicBean:1b}}}] positioned 2687 37 1944 run function ocarina_of_time:items/magic_bean
execute if block 2687 37 1944 minecraft:pumpkin_stem[age=6] as @e[type=marker,tag=BeanSpot] unless entity @s[tag=PlantBean2] run tag @s add PlantBean2
