...
#Jabu Eyes
execute as @e[type=marker,tag=JabuJabu] unless entity @a[tag=Adult] run function ocarina_of_time:moving_things/zora_fountain/blink
...
#Pots
execute as @e[type=marker,tag=Pots] run function ocarina_of_time:moving_things/zora_fountain/pots
