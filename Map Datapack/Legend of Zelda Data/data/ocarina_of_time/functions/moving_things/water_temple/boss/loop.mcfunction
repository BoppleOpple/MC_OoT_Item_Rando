...
#Cutscene
execute as @e[type=marker,tag=MorphaCutscene] at @s run function ocarina_of_time:moving_things/water_temple/boss/cutscene
...
#End
execute unless block 1062 52 3092 minecraft:gold_block if block 1064 52 3092 minecraft:gold_block unless entity @e[type=zombie,tag=MorphaEye] unless entity @e[type=marker,tag=FinishMorpha] run summon minecraft:marker 1063 56 3092 {Tags:["FinishMorpha"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute unless block 1062 52 3092 minecraft:gold_block as @e[type=marker,tag=FinishMorpha] run function ocarina_of_time:moving_things/water_temple/boss/finish
