...
execute if entity @s[tag=Jump] if entity @a[nbt={SelectedItem:{id:"minecraft:diamond_sword",Count:1b}}] if entity @e[type=zombie,tag=DarkLink,nbt={HurtTime:10s}] at @a run summon minecraft:marker ~ 65 ~ {Tags:["DarkLinkSword"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
#Goron
...
execute at @a if entity @s[tag=OnSword,scores={lifetime=1}] rotated as @a run tp @e[type=marker,tag=DarkLinkSword] ~ 65 ~ ~ 0
...
execute if entity @s[tag=OnSword,scores={lifetime=2..40}] at @e[type=marker,tag=DarkLinkSword] run tp @a ~ ~ ~ ~ ~
...
execute if entity @s[tag=OnSword,scores={lifetime=41..}] run kill @e[type=marker,tag=DarkLinkSword]
...
execute if entity @s[scores={lifetime=1..60}] unless entity @s[tag=OnSword] unless entity @s[tag=Protect2] unless entity @s[tag=Back] run kill @e[type=marker,tag=DarkLinkSword]
