...
#Pots
execute as @e[type=marker,tag=Pots] run function ocarina_of_time:moving_things/water_temple/pots
...
#Eyes Switches
#1
execute if entity @e[type=arrow,x=1063,y=46,z=3018,dx=0,dz=0] run tag @e[type=marker,tag=HookGate] add Open
execute as @e[type=marker,tag=HookGate,tag=Open] at @s run function ocarina_of_time:moving_things/water_temple/eye_switch/eye_switch_1
execute as @e[type=marker,tag=Hookshot,x=1063,y=48,z=3012,dx=0,dz=0] run tag @s add RemoveGate
execute if entity @e[type=marker,tag=Hookshot,tag=RemoveGate] run fill 1064 50 3014 1062 48 3014 minecraft:air
execute unless entity @e[type=marker,tag=Hookshot,tag=RemoveGate] unless entity @e[type=marker,tag=HookGate,tag=Open] unless block 1062 49 3014 minecraft:iron_bars run fill 1064 50 3014 1062 48 3014 minecraft:iron_bars[east=true,west=true]
#2
execute at @a if block ~-.3 ~ ~ minecraft:iron_bars if entity @a[x=1100,y=44,z=3092,dx=1,dy=2,dz=3] run tp @a ~1 ~ ~
execute if entity @e[type=arrow,x=1104,y=46,z=3087,dx=0,dz=0.5] run tag @e[type=marker,tag=HookGate] add Open
...
#Moving Platform
execute as @e[type=marker,tag=WaterSlide] at @s run function ocarina_of_time:moving_things/water_temple/moving_platforms
...
execute if entity @a[x=1130,y=66,z=3125,dx=8,dz=6] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_wait",Count:1b}]}] unless entity @a[x=1133,y=65,z=3128,dx=2,dz=2] run scoreboard players add @e[type=marker,tag=TimeBlock] timer 1
...
#Extra length
execute positioned 1095 29 3073 if entity @e[type=marker,tag=Hookshot,distance=..1] run effect give @e[type=zombie,tag=Switch7] minecraft:wither 1 1 true
