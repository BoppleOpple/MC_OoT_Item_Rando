...
#Pots
execute unless entity @e[type=marker,tag=Pots,tag=Pot1] run fill 1032 36 3028 1032 36 3028 minecraft:flower_pot
execute unless entity @e[type=marker,tag=Pots,tag=Pot2] run fill 1032 36 3022 1032 36 3022 minecraft:flower_pot
execute unless entity @e[type=marker,tag=Pots,tag=Pot6] run fill 1049 48 3033 1049 48 3033 minecraft:flower_pot
execute unless entity @e[type=marker,tag=Pots,tag=Pot7] run fill 1049 48 3035 1049 48 3035 minecraft:flower_pot
execute unless entity @e[type=marker,tag=Pots,tag=Pot18] run fill 1041 48 3005 1041 48 3005 minecraft:flower_pot
execute unless entity @e[type=marker,tag=Pots,tag=Pot19] run fill 1043 48 3005 1043 48 3005 minecraft:flower_pot
