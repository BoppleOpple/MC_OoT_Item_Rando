#Small Platforms
#1
execute if block ~ ~-2 ~ minecraft:lime_glazed_terracotta unless entity @s[scores={lifetime=..10}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s lifetime 1
execute if block ~ ~-3 ~ minecraft:lime_glazed_terracotta unless entity @s[scores={lifetime=..10}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s lifetime 1
execute if block ~ ~-4 ~ minecraft:lime_glazed_terracotta unless entity @s[scores={lifetime=..10}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s lifetime 1
execute if block ~ ~-5 ~ minecraft:lime_glazed_terracotta unless entity @s[scores={lifetime=..10}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s lifetime 1
execute if block ~ ~-6 ~ minecraft:lime_glazed_terracotta unless entity @s[scores={lifetime=..10}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s lifetime 1
...
#2
execute if block ~ ~-2 ~ minecraft:light_blue_glazed_terracotta unless entity @s[scores={time=..10}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s time 1
execute if block ~ ~-3 ~ minecraft:light_blue_glazed_terracotta unless entity @s[scores={time=..10}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s time 1
execute if block ~ ~-4 ~ minecraft:light_blue_glazed_terracotta unless entity @s[scores={time=..10}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s time 1
execute if block ~ ~-5 ~ minecraft:light_blue_glazed_terracotta unless entity @s[scores={time=..10}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s time 1
execute if block ~ ~-6 ~ minecraft:light_blue_glazed_terracotta unless entity @s[scores={time=..10}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s time 1
...
#3
execute if block ~ ~-2 ~ minecraft:purple_glazed_terracotta unless entity @s[scores={ArrowCount=..10}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s ArrowCount 1
execute if block ~ ~-3 ~ minecraft:purple_glazed_terracotta unless entity @s[scores={ArrowCount=..10}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s ArrowCount 1
execute if block ~ ~-4 ~ minecraft:purple_glazed_terracotta unless entity @s[scores={ArrowCount=..10}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s ArrowCount 1
execute if block ~ ~-5 ~ minecraft:purple_glazed_terracotta unless entity @s[scores={ArrowCount=..10}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s ArrowCount 1
execute if block ~ ~-6 ~ minecraft:purple_glazed_terracotta unless entity @s[scores={ArrowCount=..10}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s ArrowCount 1
...
#Big Down Platform
execute if block ~ ~-2 ~ minecraft:yellow_glazed_terracotta unless entity @a[nbt={Inventory:[{Slot:100b,tag:{HoverBoots:1b}}]}] if entity @s[scores={GameTimer=150..}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s GameTimer 1
execute if block ~ ~-3 ~ minecraft:yellow_glazed_terracotta unless entity @a[nbt={Inventory:[{Slot:100b,tag:{HoverBoots:1b}}]}] if entity @s[scores={GameTimer=150..}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s GameTimer 1
execute if block ~ ~-4 ~ minecraft:yellow_glazed_terracotta unless entity @a[nbt={Inventory:[{Slot:100b,tag:{HoverBoots:1b}}]}] if entity @s[scores={GameTimer=150..}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s GameTimer 1
execute if block ~ ~-5 ~ minecraft:yellow_glazed_terracotta unless entity @a[nbt={Inventory:[{Slot:100b,tag:{HoverBoots:1b}}]}] if entity @s[scores={GameTimer=150..}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s GameTimer 1
execute if block ~ ~-6 ~ minecraft:yellow_glazed_terracotta unless entity @a[nbt={Inventory:[{Slot:100b,tag:{HoverBoots:1b}}]}] if entity @s[scores={GameTimer=150..}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s GameTimer 1

execute if block ~ ~-2 ~ minecraft:yellow_glazed_terracotta unless entity @s[scores={GameTimer=..10}] unless entity @s[scores={GameTimer=150..}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s GameTimer 1
execute if block ~ ~-3 ~ minecraft:yellow_glazed_terracotta unless entity @s[scores={GameTimer=..10}] unless entity @s[scores={GameTimer=150..}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s GameTimer 1
execute if block ~ ~-4 ~ minecraft:yellow_glazed_terracotta unless entity @s[scores={GameTimer=..10}] unless entity @s[scores={GameTimer=150..}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s GameTimer 1
execute if block ~ ~-5 ~ minecraft:yellow_glazed_terracotta unless entity @s[scores={GameTimer=..10}] unless entity @s[scores={GameTimer=150..}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s GameTimer 1
execute if block ~ ~-6 ~ minecraft:yellow_glazed_terracotta unless entity @s[scores={GameTimer=..10}] unless entity @s[scores={GameTimer=150..}] unless entity @e[type=marker,tag=Hookshot] run scoreboard players remove @s GameTimer 1
