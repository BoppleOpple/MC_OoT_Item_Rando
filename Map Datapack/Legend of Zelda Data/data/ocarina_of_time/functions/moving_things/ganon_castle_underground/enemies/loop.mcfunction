...
#Floor Icicles
#1
execute unless blocks -448 20 1975 -448 22 1975 -483 55 1960 all run fill -448 20 1975 -448 22 1975 minecraft:air
execute unless blocks -448 20 1975 -448 22 1975 -483 55 1960 all run kill @e[type=armor_stand,tag=FloorIcicle1]
#2
execute unless blocks -448 20 1974 -448 22 1974 -483 55 1960 all run fill -448 20 1974 -448 22 1974 minecraft:air
execute unless blocks -448 20 1974 -448 22 1974 -483 55 1960 all run kill @e[type=armor_stand,tag=FloorIcicle2]
#3
execute unless blocks -448 20 1973 -448 22 1973 -483 55 1960 all run fill -448 20 1973 -448 22 1973 minecraft:air
execute unless blocks -448 20 1973 -448 22 1973 -483 55 1960 all run kill @e[type=armor_stand,tag=FloorIcicle3]
#4
execute unless blocks -447 20 1973 -447 22 1973 -483 55 1960 all run fill -447 20 1973 -447 22 1973 minecraft:air
execute unless blocks -447 20 1973 -447 22 1973 -483 55 1960 all run kill @e[type=armor_stand,tag=FloorIcicle4]
#5
execute unless blocks -446 20 1973 -446 22 1973 -483 55 1960 all run fill -446 20 1973 -446 22 1973 minecraft:air
execute unless blocks -446 20 1973 -446 22 1973 -483 55 1960 all run kill @e[type=armor_stand,tag=FloorIcicle5]
#6
execute unless blocks -446 20 1974 -446 22 1974 -483 55 1960 all run fill -446 20 1974 -446 22 1974 minecraft:air
execute unless blocks -446 20 1974 -446 22 1974 -483 55 1960 all run kill @e[type=armor_stand,tag=FloorIcicle6]
#7
execute unless blocks -446 20 1975 -446 22 1975 -483 55 1960 all run fill -446 20 1975 -446 22 1975 minecraft:air
execute unless blocks -446 20 1975 -446 22 1975 -483 55 1960 all run kill @e[type=armor_stand,tag=FloorIcicle7]
#8
execute unless blocks -447 20 1975 -447 22 1975 -483 55 1960 all run fill -447 20 1975 -447 22 1975 minecraft:air
execute unless blocks -447 20 1975 -447 22 1975 -483 55 1960 all run kill @e[type=armor_stand,tag=FloorIcicle8]
#9
execute unless blocks -441 20 1982 -441 22 1982 -483 55 1960 all run fill -441 20 1982 -441 22 1982 minecraft:air
execute unless blocks -441 20 1982 -441 22 1982 -483 55 1960 all run kill @e[type=armor_stand,tag=FloorIcicle9]
#10
execute unless blocks -437 20 1979 -437 22 1979 -483 55 1960 all run fill -437 20 1979 -437 22 1979 minecraft:air
execute unless blocks -437 20 1979 -437 22 1979 -483 55 1960 all run kill @e[type=armor_stand,tag=FloorIcicle10]
#11
execute unless blocks -437 20 1969 -437 22 1969 -483 55 1960 all run fill -437 20 1969 -437 22 1969 minecraft:air
execute unless blocks -437 20 1969 -437 22 1969 -483 55 1960 all run kill @e[type=armor_stand,tag=FloorIcicle11]
#12
execute unless blocks -441 20 1966 -441 22 1966 -483 55 1960 all run fill -441 20 1966 -441 22 1966 minecraft:air
execute unless blocks -441 20 1966 -441 22 1966 -483 55 1960 all run kill @e[type=armor_stand,tag=FloorIcicle12]
