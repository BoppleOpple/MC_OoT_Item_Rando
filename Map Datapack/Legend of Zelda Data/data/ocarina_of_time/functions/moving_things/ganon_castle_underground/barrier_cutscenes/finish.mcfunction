...
execute if entity @s[scores={lifetime=1}] run summon minecraft:marker ~ ~ ~ {Tags:["ResetPos"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute if entity @s[scores={lifetime=1}] run tp @e[type=marker,tag=ResetPos] @p

execute if entity @s[scores={lifetime=2}] run gamemode spectator @a
execute if entity @s[scores={lifetime=2..49}] run tp @a -491 38 2006 180 10
...
execute if entity @s[scores={lifetime=50..}] run tp @a @e[type=marker,tag=ResetPos,limit=1]
