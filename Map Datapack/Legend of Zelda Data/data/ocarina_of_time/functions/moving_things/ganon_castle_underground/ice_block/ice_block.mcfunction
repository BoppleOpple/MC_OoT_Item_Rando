...
execute if entity @s[scores={timer=1}] at @a run summon minecraft:marker ~ ~ ~ {Tags:["IceBlock"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute if entity @s[scores={timer=1}] align xyz run tp @s ~.5 ~ ~.5

execute at @e[type=marker,tag=IceBlock] run tp @a ~ ~ ~
