...
execute if entity @a[x=-475,y=32,z=1939,dx=6,dz=5] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_wait",Count:1b}]}] run scoreboard players add @e[type=marker,tag=TimeBlock] timer 1
#2
...
execute if entity @a[x=-451,y=31,z=2023,dx=5,dz=3] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_wait",Count:1b}]}] run scoreboard players add @e[type=marker,tag=TimeBlock] lifetime 1

#Big Fairies
execute positioned -517 31 2013 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run summon minecraft:armor_stand -517 31 2013 {Tags:["GreenNavi"],Small:1b,Marker:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;-102214788,162220947,-1666754575,1836136248],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTljNTE1NDVkNTQ5NDczZWNjYWE2NzdiZTc3ZmM4OTNjZmEwNWVjMWYwM2I4NWMyZWJjMjM0MmM0YTlmOTdjMyJ9fX0="}]}}}}]}
execute positioned -517 31 2013 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run tag @a add GreenNaviSpot
execute positioned -517 31 2013 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_stal",Count:1b}]}] run function ocarina_of_time:items/big_fairy/summon
...
#Pots
execute as @e[type=marker,tag=Pots] run function ocarina_of_time:moving_things/ganon_castle_underground/pots
...
#Silver Rupees
#1
execute positioned -554 34 1889 if entity @e[type=armor_stand,tag=Medallions,distance=..1.5,sort=nearest,limit=1] unless block -554 31 1889 minecraft:stone_pressure_plate if entity @e[type=marker,tag=SilverRupeeCounter,scores={BlueRupee=0}] run fill -554 31 1889 -554 31 1889 minecraft:stone_pressure_plate
#2
execute if entity @e[type=armor_stand,tag=Rock1] unless block -580 20 1974 minecraft:stone_pressure_plate if entity @e[type=marker,tag=SilverRupeeCounter,scores={BlueRupee2=0}] run fill -580 20 1974 -580 20 1974 minecraft:stone_pressure_plate
#3
execute if entity @e[type=armor_stand,tag=BladeTrap25] unless block -530 31 2015 minecraft:stone_pressure_plate if entity @e[type=marker,tag=SilverRupeeCounter,scores={RedRupee=0}] run fill -530 31 2015 -530 31 2015 minecraft:stone_pressure_plate
#4
execute if entity @e[type=armor_stand,tag=Fan1] unless block -424 30 2051 minecraft:stone_pressure_plate if entity @e[type=marker,tag=SilverRupeeCounter,scores={RedRupee2=0}] run fill -424 30 2051 -424 30 2051 minecraft:stone_pressure_plate
