...
#Bombs
execute as @e[type=marker,tag=Bomb3] at @s run function ocarina_of_time:moving_things/dodongo_cavern/bomb
execute if entity @a[x=2145,y=34,z=1918,dx=2,dy=1,dz=14] run tp @a 2146 35 1934

#Platforms
execute as @e[type=marker,tag=Platforms] run function ocarina_of_time:moving_things/dodongo_cavern/platforms

#Navi
execute if block 2213 50 1941 minecraft:light_weighted_pressure_plate if entity @a[x=2213,y=50,z=1941,dx=0,dz=0] run tag @e[type=marker,tag=Platforms] add 2
...
#Fire Platforms
execute as @e[type=marker,tag=FirePlatform] run function ocarina_of_time:moving_things/dodongo_cavern/fire_platforms
...
execute if block 2189 46 1925 minecraft:red_concrete if block 2195 46 1925 minecraft:red_concrete run tag @e[type=marker,tag=Pots] add DodongoHead
execute unless block 2192 33 1931 minecraft:gold_block as @e[type=marker,tag=Pots,tag=DodongoHead] run function ocarina_of_time:moving_things/dodongo_cavern/dodongo_head
...
#Regen Bushes
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 2174 50 1950 2174 50 1950 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 2261 46 1951 2261 46 1951 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 2229 47 1933 2229 47 1933 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 2185 36 1904 2185 36 1904 minecraft:fern

#Pots
execute as @e[type=marker,tag=Pots] run function ocarina_of_time:moving_things/dodongo_cavern/pots
