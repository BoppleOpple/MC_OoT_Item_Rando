...
execute if entity @s[scores={GameTimer=1}] at @a run summon minecraft:marker ~ ~ ~ {Tags:["DodongoHeadCutscene"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
...
execute if entity @s[scores={GameTimer=81..}] run tp @a @e[type=marker,tag=DodongoHeadCutscene,limit=1]
execute if entity @s[scores={GameTimer=81..}] run kill @e[type=marker,tag=DodongoHeadCutscene]
