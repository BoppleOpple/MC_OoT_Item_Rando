...
#Sounds
execute if entity @s[scores={timer=1}] run playsound minecraft:block.sweet_berry_bush.pick_berries hostile @a ~ ~ ~ 1 .6
execute if entity @s[scores={timer=20}] run playsound minecraft:block.sweet_berry_bush.pick_berries hostile @a ~ ~ ~ 1 .6
execute if entity @s[scores={timer=40}] run playsound minecraft:block.sweet_berry_bush.pick_berries hostile @a ~ ~ ~ 1 .6
execute if entity @s[scores={timer=60}] run playsound minecraft:block.sweet_berry_bush.pick_berries hostile @a ~ ~ ~ 1 .6
execute if entity @s[scores={timer=80}] run playsound minecraft:block.sweet_berry_bush.pick_berries hostile @a ~ ~ ~ 1 .6
execute if entity @s[scores={timer=100}] run playsound minecraft:block.sweet_berry_bush.pick_berries hostile @a ~ ~ ~ 1 .6
execute if entity @s[scores={timer=120}] run playsound minecraft:block.sweet_berry_bush.pick_berries hostile @a ~ ~ ~ 1 .6
execute if entity @s[scores={timer=140}] run playsound minecraft:block.sweet_berry_bush.pick_berries hostile @a ~ ~ ~ 1 .6
