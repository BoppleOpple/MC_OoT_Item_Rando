...
execute if entity @s[tag=RightCut,scores={lifetime=2}] as @e[type=ravager,tag=HandHealth2] run data merge entity @s {Invulnerable:0b}
...
execute if entity @s[tag=LeftCut,scores={lifetime=2}] as @e[type=ravager,tag=HandHealth] run data merge entity @s {Invulnerable:0b}
...
execute if entity @s[tag=Clap,scores={lifetime=2}] as @e[type=ravager,tag=HandHealth1] run data merge entity @s {Invulnerable:0b}
execute if entity @s[tag=Clap,scores={lifetime=2}] as @e[type=ravager,tag=HandHealth2] run data merge entity @s {Invulnerable:0b}
...
execute if entity @s[tag=!RightShake,tag=!RightSquish,tag=RightSlap,scores={lifetime=2}] as @e[type=ravager,tag=HandHealth2] run data merge entity @s {Invulnerable:0b}
...
execute if entity @s[tag=!RightShake,tag=!RightSquish,tag=RightSlap,scores={lifetime=51}] as @e[type=ravager,tag=HandHealth2] run data merge entity @s {Invulnerable:1b}
...
execute if entity @s[tag=RightSquish,scores={lifetime=34}] as @e[type=ravager,tag=HandHealth2] run data merge entity @s {Invulnerable:1b}
...
execute if entity @s[tag=RightSquish,scores={lifetime=101}] as @e[type=ravager,tag=HandHealth2] run data merge entity @s {Invulnerable:0b}
...
execute if entity @s[tag=RightShake,scores={lifetime=34}] as @e[type=ravager,tag=HandHealth2] run data merge entity @s {Invulnerable:1b}
...
execute if entity @s[tag=RightShake,scores={lifetime=101}] as @e[type=ravager,tag=HandHealth2] run data merge entity @s {Invulnerable:0b}
...
execute if entity @s[tag=!LeftShake,tag=!LeftSquish,tag=LeftSlap,scores={lifetime=2}] as @e[type=ravager,tag=HandHealth] run data merge entity @s {Invulnerable:0b}
...
execute if entity @s[tag=!LeftShake,tag=!LeftSquish,tag=LeftSlap,scores={lifetime=51}] as @e[type=ravager,tag=HandHealth] run data merge entity @s {Invulnerable:1b}
...
execute if entity @s[scores={GameTimer=240..}] run data merge entity @s[tag=BongoHand1] {ArmorItems:[{},{},{},{id:cobblestone,Count:1b,tag:{CustomModelData:67}}]}
execute if entity @s[scores={GameTimer=240..}] run data merge entity @s[tag=BongoHand2] {ArmorItems:[{},{},{},{id:cobblestone,Count:1b,tag:{CustomModelData:66}}]}
execute if entity @s[scores={GameTimer=240..}] run tp @s ~ 22 ~
execute if entity @s[scores={GameTimer=240..}] run tag @s remove Stun
...
execute unless entity @s[tag=BigAttack] if entity @s[tag=BongoHand1,tag=Stun,scores={timer=15..,BombchuCount=1..2}] as @e[type=armor_stand,tag=BongoHand2,tag=!Action,tag=!RightSlap] run tag @s add RightCut
execute unless entity @s[tag=BigAttack] if entity @s[tag=BongoHand1,tag=Stun,scores={timer=15..,BombchuCount=3..4}] as @e[type=armor_stand,tag=BongoHand2,tag=!Action,tag=!RightPunch] run tag @s add RightSlap
execute unless entity @s[tag=BigAttack] if entity @s[tag=BongoHand1,tag=Stun,scores={timer=15..,BombchuCount=5..6}] as @e[type=armor_stand,tag=BongoHand2,tag=!Action,tag=!RightSlam] run tag @s add RightPunch
execute unless entity @s[tag=BigAttack] if entity @s[tag=BongoHand1,tag=Stun,scores={timer=15..,BombchuCount=7..9}] as @e[type=armor_stand,tag=BongoHand2,tag=!Action,tag=!RightCut] run tag @s add RightSlam
execute unless entity @s[tag=BigAttack] if entity @s[tag=BongoHand1,tag=Stun,scores={timer=15..}] run tag @e[type=armor_stand,tag=BongoHand2] add Action
...
execute unless entity @s[tag=BigAttack] if entity @s[tag=BongoHand2,tag=Stun,scores={timer=15..,BombchuCount=1..2}] as @e[type=armor_stand,tag=BongoHand1,tag=!Action,tag=!LeftSlap] run tag @s add LeftCut
execute unless entity @s[tag=BigAttack] if entity @s[tag=BongoHand2,tag=Stun,scores={timer=15..,BombchuCount=3..4}] as @e[type=armor_stand,tag=BongoHand1,tag=!Action,tag=!LeftPunch] run tag @s add LeftSlap
execute unless entity @s[tag=BigAttack] if entity @s[tag=BongoHand2,tag=Stun,scores={timer=15..,BombchuCount=5..6}] as @e[type=armor_stand,tag=BongoHand1,tag=!Action,tag=!LeftSlam] run tag @s add LeftPunch
execute unless entity @s[tag=BigAttack] if entity @s[tag=BongoHand2,tag=Stun,scores={timer=15..,BombchuCount=7..9}] as @e[type=armor_stand,tag=BongoHand1,tag=!Action,tag=!LeftCut] run tag @s add LeftSlam
execute unless entity @s[tag=BigAttack] if entity @s[tag=BongoHand2,tag=Stun,scores={timer=15..}] run tag @e[type=armor_stand,tag=BongoHand1] add Action
