...
#Pots
execute as @e[type=marker,tag=Pots] run function ocarina_of_time:moving_things/shadow_temple/pots
...
#Silver Rupees
#1
execute positioned 1750 77 917 if entity @e[type=armor_stand,tag=ScytheBladeTrap,distance=..1] if entity @e[type=marker,tag=SilverRupeeCounter,scores={BlueRupee=0}] run fill 1760 77 921 1760 79 923 minecraft:air
#2
execute if entity @e[type=armor_stand,tag=BladeTrap4] if block 1702 59 1015 minecraft:iron_bars if entity @e[type=marker,tag=SilverRupeeCounter,scores={BlueRupee2=0}] run fill 1702 58 1015 1702 59 1015 minecraft:air
#3
execute if entity @e[tag=RedeadReturn21] if entity @e[type=marker,tag=RedeadReturn20] if entity @e[type=marker,tag=SilverRupeeCounter,scores={RedRupee=0}] run fill 1716 58 964 1716 58 964 minecraft:stone_pressure_plate replace minecraft:air
...
execute if entity @a[x=1791,y=63,z=970,dx=5,dz=5] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_wait",Count:1b}]}] unless entity @a[x=1794,y=63,z=970,dx=2,dz=2] run scoreboard players add @e[type=marker,tag=TimeBlock] timer 1
execute if entity @a[x=1581,y=58,z=926,dx=8,dz=8] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_wait",Count:1b}]}] unless entity @a[x=1581,y=58,z=929,dx=2,dz=2] run scoreboard players add @e[type=marker,tag=TimeBlock] lifetime 1

#Big Fairies
execute positioned 1750 77 940 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run summon minecraft:armor_stand 1750 77 940 {Tags:["GreenNavi"],Small:1b,Marker:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;-102214788,162220947,-1666754575,1836136248],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTljNTE1NDVkNTQ5NDczZWNjYWE2NzdiZTc3ZmM4OTNjZmEwNWVjMWYwM2I4NWMyZWJjMjM0MmM0YTlmOTdjMyJ9fX0="}]}}}}]}
execute positioned 1750 77 940 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run tag @a add GreenNaviSpot
execute positioned 1750 77 940 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_stal",Count:1b}]}] run function ocarina_of_time:items/big_fairy/summon
execute positioned 1752 63 1014 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run summon minecraft:armor_stand 1752 63 1014 {Tags:["GreenNavi"],Small:1b,Marker:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;-102214788,162220947,-1666754575,1836136248],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTljNTE1NDVkNTQ5NDczZWNjYWE2NzdiZTc3ZmM4OTNjZmEwNWVjMWYwM2I4NWMyZWJjMjM0MmM0YTlmOTdjMyJ9fX0="}]}}}}]}
execute positioned 1752 63 1014 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run tag @a add GreenNaviSpot
execute positioned 1752 63 1014 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_stal",Count:1b}]}] run function ocarina_of_time:items/big_fairy/summon
execute positioned 1788 58 935 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run summon minecraft:armor_stand 1788 58 935 {Tags:["GreenNavi"],Small:1b,Marker:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;-102214788,162220947,-1666754575,1836136248],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTljNTE1NDVkNTQ5NDczZWNjYWE2NzdiZTc3ZmM4OTNjZmEwNWVjMWYwM2I4NWMyZWJjMjM0MmM0YTlmOTdjMyJ9fX0="}]}}}}]}
execute positioned 1788 58 935 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run tag @a add GreenNaviSpot
execute positioned 1788 58 935 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_stal",Count:1b}]}] run function ocarina_of_time:items/big_fairy/summon
...
execute as @e[type=marker,tag=MovingPlatforms] run function ocarina_of_time:moving_things/shadow_temple/moving_platforms

#Bombs
execute as @e[type=marker,tag=Bomb5] at @s run function ocarina_of_time:moving_things/shadow_temple/bomb
...
#Statue Bridge
execute if block 1605 58 923 minecraft:air if block 1602 61 931 minecraft:red_nether_bricks run function ocarina_of_time:moving_things/shadow_temple/break_statue
execute if block 1606 58 925 minecraft:air if block 1602 61 931 minecraft:red_nether_bricks run function ocarina_of_time:moving_things/shadow_temple/break_statue
execute if block 1604 58 925 minecraft:air if block 1602 61 931 minecraft:red_nether_bricks run function ocarina_of_time:moving_things/shadow_temple/break_statue
execute if block 1605 58 927 minecraft:air if block 1602 61 931 minecraft:red_nether_bricks run function ocarina_of_time:moving_things/shadow_temple/break_statue
execute if block 1604 58 928 minecraft:air if block 1602 61 931 minecraft:red_nether_bricks run function ocarina_of_time:moving_things/shadow_temple/break_statue
execute if block 1603 58 927 minecraft:air if block 1602 61 931 minecraft:red_nether_bricks run function ocarina_of_time:moving_things/shadow_temple/break_statue
...
execute at @a if entity @a[tag=Boss] if entity @a[y=4,dy=0] run tp @a 1651 21 963
