#Redead
#1
execute as @e[type=wither_skeleton,tag=Redead19] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=RedeadReturn19] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Redead19] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=RedeadReturn19,distance=...1] run tp @s 1650 91 912 0 60
#2
execute as @e[type=wither_skeleton,tag=Redead20] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=RedeadReturn20] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Redead20] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=RedeadReturn20,distance=...1] run tp @s 1719 58 967 -45 60
#3
execute as @e[type=wither_skeleton,tag=Redead21] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=RedeadReturn21] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Redead21] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=RedeadReturn21,distance=...1] run tp @s 1733 58 967 45 60
#4
execute as @e[type=wither_skeleton,tag=Redead22] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=RedeadReturn22] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Redead22] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=RedeadReturn22,distance=...1] run tp @s 1788 58 939 180 60
#5
execute as @e[type=wither_skeleton,tag=Redead23] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=RedeadReturn23] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Redead23] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=RedeadReturn23,distance=...1] run tp @s 1788 58 931 0 60
...
#Redead Room 3
execute unless block 1725 55 963 minecraft:gold_block if entity @a[x=1726,y=58,z=972,dx=0,dz=0] run function ocarina_of_time:moving_things/shadow_temple/enemies/redead_room_3/summon
execute unless block 1726 55 963 minecraft:gold_block if block 1725 55 963 minecraft:gold_block unless entity @e[type=wither_skeleton,tag=Redead20] unless entity @e[type=wither_skeleton,tag=Redead21] run function ocarina_of_time:moving_things/shadow_temple/enemies/redead_room_3/finish

#Gibdo
#1
execute as @e[type=wither_skeleton,tag=Gibdo3] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=GibdoReturn3] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Gibdo3] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=GibdoReturn3,distance=...1] run tp @s 1753 77 956 180 60
#2
execute as @e[type=wither_skeleton,tag=Gibdo4] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=GibdoReturn4] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Gibdo4] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=GibdoReturn4,distance=...1] run tp @s 1747 77 956 180 60

#3
execute as @e[type=wither_skeleton,tag=Gibdo5] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=GibdoReturn5] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Gibdo5] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=GibdoReturn5,distance=...1] run tp @s 1772 58 917 -30 60
#4
execute as @e[type=wither_skeleton,tag=Gibdo6] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=GibdoReturn6] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Gibdo6] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=GibdoReturn6,distance=...1] run tp @s 1778 58 917 30 60
