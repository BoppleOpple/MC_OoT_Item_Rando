#Pots
execute as @e[type=marker,tag=Pots] run function ocarina_of_time:moving_things/well/pots
...
#Bombs
execute as @e[type=marker,tag=Bomb4] at @s run function ocarina_of_time:moving_things/well/bomb
...
#Regen Bushes
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill -41 36 1314 -41 36 1314 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill -38 36 1315 -38 36 1315 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill -38 36 1317 -38 36 1317 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill -41 36 1317 -41 36 1317 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill -41 36 1319 -41 36 1319 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill -38 36 1319 -38 36 1319 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill -39 36 1321 -39 36 1321 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill -39 36 1325 -39 36 1325 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill -37 36 1328 -37 36 1328 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill -31 36 1334 -31 36 1334 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill -31 36 1336 -31 36 1336 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill -33 36 1336 -33 36 1336 minecraft:fern

#Silver Rupees
execute if entity @e[type=armor_stand,tag=Skeleton1] if entity @e[type=armor_stand,tag=Skeleton2] if entity @e[type=armor_stand,tag=WellTorch1] if entity @e[type=marker,tag=SilverRupeeCounter,scores={BlueRupee=0}] run fill -39 59 1350 -39 59 1350 minecraft:stone_pressure_plate replace minecraft:air
...
#Big Fairies
execute positioned 7 36 1311 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run summon minecraft:armor_stand 7 36 1311 {Tags:["GreenNavi"],Small:1b,Marker:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;-102214788,162220947,-1666754575,1836136248],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTljNTE1NDVkNTQ5NDczZWNjYWE2NzdiZTc3ZmM4OTNjZmEwNWVjMWYwM2I4NWMyZWJjMjM0MmM0YTlmOTdjMyJ9fX0="}]}}}}]}
execute positioned 7 36 1311 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run tag @a add GreenNaviSpot
execute positioned 7 36 1311 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_stal",Count:1b}]}] run function ocarina_of_time:items/big_fairy/summon
