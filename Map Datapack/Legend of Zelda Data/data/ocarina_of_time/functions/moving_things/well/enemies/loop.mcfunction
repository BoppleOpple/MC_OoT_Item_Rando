...
#Redead
#1
execute as @e[type=wither_skeleton,tag=Redead17] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=RedeadReturn17] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Redead17] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=RedeadReturn17,distance=...1] run tp @s -30 36 1339 140 60
#2
execute as @e[type=wither_skeleton,tag=Redead18] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=RedeadReturn18] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Redead18] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=RedeadReturn18,distance=...1] run tp @s 5 36 1366 180 60
...
#Gibdo
#1
execute as @e[type=wither_skeleton,tag=Gibdo1] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=GibdoReturn1] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Gibdo1] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=GibdoReturn1,distance=...1] run tp @s -74 59 1331 0 60
#2
execute as @e[type=wither_skeleton,tag=Gibdo2] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=GibdoReturn2] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Gibdo2] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=GibdoReturn2,distance=...1] run tp @s -76.0 59 1340 0 60
