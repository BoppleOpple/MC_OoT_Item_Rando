...
#Pots
execute as @e[type=marker,tag=Pots] run function ocarina_of_time:moving_things/haunted_wasteland/pots
...
execute if entity @a[tag=LeeverAttack] as @e[type=marker,tag=LeeverSpawn] at @s run function ocarina_of_time:moving_things/haunted_wasteland/leever_spawn
