loot replace entity @s hotbar.0 9 mine 913 4 -637 minecraft:air{drop_contents:1b}
loot replace entity @s inventory.0 27 mine 912 4 -637 minecraft:air{drop_contents:1b}
loot replace entity @s armor.feet 4 mine 911 4 -637 minecraft:air{drop_contents:1b}
loot replace entity @s weapon.offhand 1 mine 910 4 -637 minecraft:air{drop_contents:1b}
