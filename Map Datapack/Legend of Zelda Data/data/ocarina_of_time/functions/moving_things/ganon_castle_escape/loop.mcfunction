...
execute if entity @a[tag=TimerRoom1] unless entity @a[scores={MiniGameTime=1..}] run scoreboard players set @a MiniGameTime 3000
...
#Pots
execute as @e[type=marker,tag=Pots] run function ocarina_of_time:moving_things/ganon_castle_escape/pots
...
#Meteors
execute if entity @a[tag=Meteors] as @e[type=marker,tag=Meteor] at @a run function ocarina_of_time:moving_things/ganon_castle_escape/meteors
