...
execute if entity @a[scores={MiniGameTime=0}] if entity @s[tag=Prize] if entity @e[type=marker,tag=Progress,tag=SilverScale] run scoreboard players set @s text 3
execute if entity @a[scores={MiniGameTime=0}] if entity @s[tag=Prize] unless entity @e[type=marker,tag=Progress,tag=SilverScale] run scoreboard players set @s text 2
