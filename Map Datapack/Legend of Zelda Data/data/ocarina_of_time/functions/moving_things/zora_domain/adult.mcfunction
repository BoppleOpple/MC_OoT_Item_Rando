...
execute unless block 1767 58 2289 minecraft:gold_block unless block 1773 60 2288 minecraft:red_stained_glass unless block 1768 58 2288 minecraft:gold_block run scoreboard players set @e[type=armor_stand,tag=FakeKingZora] text 4
...
execute if block 1766 60 2289 minecraft:gold_block if block 1767 58 2289 minecraft:gold_block run fill 1768 58 2288 1768 58 2288 minecraft:gold_block
