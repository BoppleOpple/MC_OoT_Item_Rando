#Cutscene
execute as @e[type=zombie,tag=Octo] at @s unless block 1701 17 1259 minecraft:gold_block if entity @e[type=marker,tag=MiniBossPlatform,tag=Version1] run function ocarina_of_time:moving_things/jabu_jabu/enemies/big_octo/cutscene

#Summon
execute unless block 1701 17 1259 minecraft:gold_block if entity @e[type=marker,tag=MiniBossPlatform,tag=!Version1] run function ocarina_of_time:moving_things/jabu_jabu/enemies/big_octo/summon
