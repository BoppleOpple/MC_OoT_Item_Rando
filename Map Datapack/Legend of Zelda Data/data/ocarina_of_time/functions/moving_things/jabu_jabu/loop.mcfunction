...
execute if entity @a[x=1650,y=19,z=1302,dx=2,dz=2] unless block 1651 20 1304 minecraft:vine run function ocarina_of_time:moving_things/jabu_jabu/crate_reset
...
#Moving Platform
execute as @e[type=marker,tag=JabuPlatform] run function ocarina_of_time:moving_things/jabu_jabu/moving_platform
...
#Platform
execute as @a at @s if block ~ ~-2 ~ minecraft:green_terracotta unless block 1651 51 1301 minecraft:pink_terracotta run tag @e[type=marker,tag=JabuPlatform] add JabuPlatform2
execute as @e[type=marker,tag=JabuPlatform2] run function ocarina_of_time:moving_things/jabu_jabu/falling_platform

#Water
execute as @e[type=marker,tag=JabuPlatform] if block 1661 18 1323 minecraft:light_weighted_pressure_plate[power=1] run tag @s add JabuWater
execute as @e[type=marker,tag=JabuWater] run function ocarina_of_time:moving_things/jabu_jabu/water_level
...
#MiniBoss Platform
execute as @e[type=marker,tag=MiniBossPlatform,tag=Defeated] at @a run function ocarina_of_time:moving_things/jabu_jabu/final_platform
execute as @a at @s if entity @s[x=1693,y=26,z=1256,dx=10,dz=10] if block ~ ~-1 ~ minecraft:pink_terracotta run tag @e[type=marker,tag=MiniBossPlatform,tag=Defeated] add Up
...
#Pots
execute as @e[type=marker,tag=Pots] run function ocarina_of_time:moving_things/jabu_jabu/pots
