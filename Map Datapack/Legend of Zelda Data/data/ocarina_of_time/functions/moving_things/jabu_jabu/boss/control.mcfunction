...
execute if entity @s[scores={ArrowCount=30}] at @a run summon minecraft:marker ~ ~ ~ {Tags:["LazerPoint1","LazerPoint","Barinade"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
...
execute if entity @s[scores={ArrowCount=45..65}] anchored eyes positioned ^ ^2 ^-3.4 anchored feet facing entity @e[type=marker,tag=LazerPoint1] eyes rotated ~ ~-5 run function ocarina_of_time:moving_things/jabu_jabu/boss/lazer
...
execute unless entity @s[tag=Lazer1] run kill @e[type=marker,tag=LazerPoint1]
#2
...
execute if entity @s[scores={PushBlock=30}] at @a run summon minecraft:marker ~ ~ ~ {Tags:["LazerPoint2","LazerPoint","Barinade"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
...
execute if entity @s[scores={PushBlock=45..65}] anchored eyes positioned ^3 ^2 ^1.4 anchored feet facing entity @e[type=marker,tag=LazerPoint2] eyes rotated ~ ~-5 run function ocarina_of_time:moving_things/jabu_jabu/boss/lazer
...
execute unless entity @s[tag=Lazer2] run kill @e[type=marker,tag=LazerPoint2]
#3
...
execute if entity @s[scores={nearbyBomb=30}] at @a run summon minecraft:marker ~ ~ ~ {Tags:["LazerPoint3","LazerPoint","Barinade"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
...
execute if entity @s[scores={nearbyBomb=45..65}] anchored eyes positioned ^-3 ^2 ^1.4 anchored feet facing entity @e[type=marker,tag=LazerPoint3] eyes rotated ~ ~-5 run function ocarina_of_time:moving_things/jabu_jabu/boss/lazer
...
execute unless entity @s[tag=Lazer3] run kill @e[type=marker,tag=LazerPoint3]
