...
execute if block 1336 43 -659 minecraft:light_weighted_pressure_plate[power=1] run tag @e[type=marker,tag=WaterPlatform] add 2
execute if block 1336 43 -659 minecraft:light_weighted_pressure_plate[power=1] run tag @e[type=marker,tag=WaterPlatform] add Start
...
#Water Platform
execute as @e[type=marker,tag=WaterPlatform] at @a run function ocarina_of_time:moving_things/deku_tree/water_platform
...
#Hint 1
execute if block 1447 11 -643 minecraft:gold_block if block 1358 73 -663 minecraft:gold_block unless entity @e[type=zombie,tag=DekuScrub1] unless block 1358 73 -673 minecraft:gold_block run tellraw @a ["",{"text":"Deku Scrub:","color":"gold"},{"text":" Ow-ow-ow! Forgive me, master! If I give you a tip, will you let me go? When you jump off a high cliff, you won't get hurt from the fall!"}]
execute if block 1447 11 -643 minecraft:gold_block if block 1358 73 -663 minecraft:gold_block unless entity @e[type=zombie,tag=DekuScrub1] unless block 1358 73 -673 minecraft:gold_block run fill 1358 75 -654 1358 75 -654 minecraft:stone_pressure_plate replace minecraft:air
execute if block 1447 11 -643 minecraft:gold_block if block 1358 73 -663 minecraft:gold_block unless entity @e[type=zombie,tag=DekuScrub1] unless block 1358 73 -673 minecraft:gold_block run fill 1358 75 -672 1358 75 -672 minecraft:stone_pressure_plate replace minecraft:air
execute if block 1447 11 -643 minecraft:gold_block if block 1358 73 -663 minecraft:gold_block unless entity @e[type=zombie,tag=DekuScrub1] unless block 1358 73 -673 minecraft:gold_block at @a run playsound minecraft:block.iron_door.open block @a ~ ~ ~ 1
execute if block 1447 11 -643 minecraft:gold_block if block 1358 73 -663 minecraft:gold_block unless entity @e[type=zombie,tag=DekuScrub1] run fill 1358 73 -673 1358 73 -673 minecraft:gold_block
#Hint 2
execute if block 1447 11 -643 minecraft:gold_block if block 1344 45 -637 minecraft:gold_block unless entity @e[type=zombie,tag=DekuScrub2] unless block 1337 45 -637 minecraft:gold_block run tellraw @a ["",{"text":"Deku Scrub: ","color":"gold"},{"text":"Please forgive me, master! I'll never do it again! If you spare me, I'll teach you something cool. You will never beat my brothers up ahead unless you punish them in the proper order. The order is... "},{"text":"2 3 1 Twenty-three is number one!","color":"red"},{"text":" Do you think I'm a traitor?"}]
execute if block 1447 11 -643 minecraft:gold_block if block 1344 45 -637 minecraft:gold_block unless entity @e[type=zombie,tag=DekuScrub2] run fill 1337 45 -637 1337 45 -637 minecraft:gold_block
#Hint 3
execute if block 1447 11 -643 minecraft:gold_block if block 1387 10 -661 minecraft:dirt unless entity @e[type=zombie,tag=DekuScrub9] unless block 1391 10 -663 minecraft:gold_block run tellraw @a ["",{"text":"Deku Scrub:","color":"gold"},{"text":" How did you know our secret? How irritating! It's so annoying that I'm going to reveal the secret of Queen Gohma to you! In order to administer the coup de grâce to Queen Gohma, strike with your sword "},{"text":"while she's stunned","color":"red"},{"text":". Oh, Queenie... Sorry about that!"}]
execute if block 1447 11 -643 minecraft:gold_block if block 1387 10 -661 minecraft:dirt unless entity @e[type=zombie,tag=DekuScrub9] unless block 1391 10 -663 minecraft:gold_block at @a run playsound minecraft:block.iron_door.open block @a ~ ~ ~ 1
execute if block 1447 11 -643 minecraft:gold_block if block 1387 10 -661 minecraft:dirt unless entity @e[type=zombie,tag=DekuScrub9] unless block 1391 10 -663 minecraft:gold_block run fill 1393 12 -661 1393 12 -661 minecraft:stone_pressure_plate
execute if block 1447 11 -643 minecraft:gold_block if block 1387 10 -661 minecraft:dirt unless entity @e[type=zombie,tag=DekuScrub9] run fill 1391 10 -663 1391 10 -663 minecraft:gold_block

#Loot Tables
#Regen Bushes
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1373 64 -625 1373 64 -625 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1375 64 -626 1375 64 -626 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1378 64 -629 1378 64 -629 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1381 71 -636 1381 71 -636 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1381 71 -634 1381 71 -634 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1364 70 -679 1364 70 -679 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1364 70 -681 1364 70 -681 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1352 70 -679 1352 70 -679 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1352 70 -681 1352 70 -681 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1363 89 -677 1363 89 -677 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1363 89 -679 1363 89 -679 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1363 47 -634 1363 47 -634 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1361 47 -634 1361 47 -634 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1349 47 -641 1349 47 -641 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1350 47 -640 1350 47 -640 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1350 47 -634 1350 47 -634 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1349 47 -633 1349 47 -633 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1346 47 -671 1346 47 -671 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1346 47 -669 1346 47 -669 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1347 50 -685 1347 50 -685 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1347 50 -683 1347 50 -683 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1377 50 -685 1377 50 -685 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1377 50 -683 1377 50 -683 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1384 12 -639 1384 12 -639 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1382 12 -639 1382 12 -639 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1380 12 -639 1380 12 -639 minecraft:fern

execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1415 12 -679 1415 12 -679 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1427 12 -679 1427 12 -679 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1438 12 -679 1438 12 -679 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1443 12 -671 1443 12 -671 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1443 12 -651 1443 12 -651 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1438 12 -643 1438 12 -643 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1427 12 -643 1427 12 -643 minecraft:fern
execute as @e[type=marker,tag=LootTable,scores={timer=100}] run fill 1415 12 -643 1415 12 -643 minecraft:fern
