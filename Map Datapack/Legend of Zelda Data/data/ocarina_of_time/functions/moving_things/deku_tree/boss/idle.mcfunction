...
execute unless entity @s[tag=Looking] if entity @s[scores={timer=1..2}] facing entity @e[type=marker,tag=GohmaSpot,limit=1,sort=random] eyes run tp @s ~ ~ ~ ~180 -90
...
execute unless entity @s[tag=Looking] if entity @s[scores={timer=20..}] if entity @e[type=marker,tag=GohmaSpot,distance=..0.2] run scoreboard players set @s timer 0
execute if entity @s[scores={timer=40..}] run scoreboard players set @s timer 0

execute if entity @s[scores={timer=..-30}] run kill @e[type=marker,tag=GohmaSpot]
execute if entity @s[scores={timer=..-30}] run summon minecraft:marker 1427 12 -661 {Tags:["GohmaSpot","GohmaSpot1"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute if entity @s[scores={timer=..-30}] run summon minecraft:marker 1427 27 -661 {Tags:["GohmaSpot","GohmaSpot2"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
