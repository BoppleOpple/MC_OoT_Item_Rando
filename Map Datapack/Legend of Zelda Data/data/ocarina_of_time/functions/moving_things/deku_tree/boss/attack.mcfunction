...
#Shield
execute unless entity @s[tag=Cooldown] if entity @a[distance=..1] if entity @a[nbt={SelectedItem:{id:"minecraft:shield",Count:1b}}] run playsound minecraft:item.shield.block ambient @a ~ ~ ~ 1 1
execute unless entity @s[tag=Cooldown] if entity @a[distance=..1] if entity @a[nbt={SelectedItem:{id:"minecraft:shield",Count:1b}}] run tag @s add Cooldown
execute unless entity @s[tag=Cooldown] if entity @a[distance=..1] if entity @a[nbt={Inventory:[{Slot:-106b,id:"minecraft:shield",Count:1b}]}] run playsound minecraft:item.shield.block ambient @a ~ ~ ~ 1 1
execute unless entity @s[tag=Cooldown] if entity @a[distance=..1] if entity @a[nbt={Inventory:[{Slot:-106b,id:"minecraft:shield",Count:1b}]}] run tag @s add Cooldown
...
execute unless entity @s[tag=Cooldown] unless entity @s[tag=Fall] unless entity @s[tag=Climb2] unless entity @s[tag=Climb] unless entity @s[tag=Stun] unless entity @s[scores={timer=1..80}] if entity @s[scores={lifetime=35}] if entity @a[distance=..3] if entity @a[nbt={SelectedItem:{id:"minecraft:shield",Count:1b}}] run playsound minecraft:item.shield.block ambient @a ~ ~ ~ 1 1
execute unless entity @s[tag=Cooldown] unless entity @s[tag=Fall] unless entity @s[tag=Climb2] unless entity @s[tag=Climb] unless entity @s[tag=Stun] unless entity @s[scores={timer=1..80}] if entity @s[scores={lifetime=35}] if entity @a[distance=..3] if entity @a[nbt={SelectedItem:{id:"minecraft:shield",Count:1b}}] run tag @s add Cooldown
execute unless entity @s[tag=Cooldown] unless entity @s[tag=Fall] unless entity @s[tag=Climb2] unless entity @s[tag=Climb] unless entity @s[tag=Stun] unless entity @s[scores={timer=1..80}] if entity @s[scores={lifetime=35}] if entity @a[distance=..3] if entity @a[nbt={Inventory:[{Slot:-106b,id:"minecraft:shield",Count:1b}]}] run playsound minecraft:item.shield.block ambient @a ~ ~ ~ 1 1
execute unless entity @s[tag=Cooldown] unless entity @s[tag=Fall] unless entity @s[tag=Climb2] unless entity @s[tag=Climb] unless entity @s[tag=Stun] unless entity @s[scores={timer=1..80}] if entity @s[scores={lifetime=35}] if entity @a[distance=..3] if entity @a[nbt={Inventory:[{Slot:-106b,id:"minecraft:shield",Count:1b}]}] run tag @s add Cooldown
...
execute if entity @s[tag=Cooldown] run scoreboard players add @s ArrowCount2 1
execute if entity @s[scores={ArrowCount2=10..}] run tag @s remove Cooldown
execute if entity @s[scores={ArrowCount2=10..}] run scoreboard players set @s ArrowCount2 0
...
execute if entity @s[scores={GameTimer=76}] facing entity @e[type=marker,tag=GohmaSpot,limit=1,sort=nearest] eyes run tp @s ~ ~ ~ ~180 -90
execute if entity @s[scores={GameTimer=77..299}] run tp @s ^ ^.15 ^ ~ -90
execute if entity @s[scores={GameTimer=77..299}] if entity @e[type=marker,tag=GohmaSpot,distance=..1] run scoreboard players set @s GameTimer 300
