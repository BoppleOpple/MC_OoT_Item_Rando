...
execute unless block 1427 5 -665 minecraft:gold_block unless block 1427 5 -664 minecraft:gold_block run summon minecraft:marker 1424 27 -662 {Tags:["GohmaSpot"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute unless block 1427 5 -665 minecraft:gold_block unless block 1427 5 -664 minecraft:gold_block run summon minecraft:marker 1426 27 -665 {Tags:["GohmaSpot"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute unless block 1427 5 -665 minecraft:gold_block unless block 1427 5 -664 minecraft:gold_block run summon minecraft:marker 1429 27 -659 {Tags:["GohmaSpot"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute unless block 1427 5 -665 minecraft:gold_block unless block 1427 5 -664 minecraft:gold_block run summon minecraft:marker 1425 27 -658 {Tags:["GohmaSpot"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
