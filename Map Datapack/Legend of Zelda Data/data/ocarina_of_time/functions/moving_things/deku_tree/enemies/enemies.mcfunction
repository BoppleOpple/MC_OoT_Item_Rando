#Deku Babas
#1
execute unless entity @e[type=wither_skeleton,tag=DekuBabaBody4] if entity @e[type=marker,tag=DekuBabaHealth4,scores={lifetime=300..}] run function ocarina_of_time:moving_things/deku_tree/enemies/deku_baba1
...
execute unless entity @e[type=wither_skeleton,tag=DekuBabaBody4] run scoreboard players add @e[type=marker,tag=DekuBabaHealth4] lifetime 1
#2
execute unless entity @e[type=wither_skeleton,tag=DekuBabaBody5] if entity @e[type=marker,tag=DekuBabaHealth5,scores={lifetime=300..}] run function ocarina_of_time:moving_things/deku_tree/enemies/deku_baba2
...
execute unless entity @e[type=wither_skeleton,tag=DekuBabaBody5] run scoreboard players add @e[type=marker,tag=DekuBabaHealth5] lifetime 1
#3
execute unless entity @e[type=wither_skeleton,tag=DekuBabaBody6] if entity @e[type=marker,tag=DekuBabaHealth6,scores={lifetime=300..}] run function ocarina_of_time:moving_things/deku_tree/enemies/deku_baba3
...
execute unless entity @e[type=wither_skeleton,tag=DekuBabaBody6] run scoreboard players add @e[type=marker,tag=DekuBabaHealth6] lifetime 1
#4
execute unless entity @e[type=wither_skeleton,tag=DekuBabaBody7] if entity @e[type=marker,tag=DekuBabaHealth7,scores={lifetime=300..}] run function ocarina_of_time:moving_things/deku_tree/enemies/deku_baba4
...
execute unless entity @e[type=wither_skeleton,tag=DekuBabaBody7] run scoreboard players add @e[type=marker,tag=DekuBabaHealth7] lifetime 1
#5
execute unless entity @e[type=wither_skeleton,tag=DekuBabaBody8] if entity @e[type=marker,tag=DekuBabaHealth8,scores={lifetime=300..}] run function ocarina_of_time:moving_things/deku_tree/enemies/deku_baba5
...
execute unless entity @e[type=wither_skeleton,tag=DekuBabaBody8] run scoreboard players add @e[type=marker,tag=DekuBabaHealth8] lifetime 1
...
execute at @a if entity @a[y=10,dy=3] if block 1447 11 -643 minecraft:gold_block unless entity @e[type=zombie,tag=DekuScrub9] run kill @e[type=zombie,tag=DekuScrub10]
execute at @a if entity @a[y=10,dy=3] if block 1447 11 -643 minecraft:gold_block unless entity @e[type=zombie,tag=DekuScrub9] run kill @e[type=zombie,tag=DekuScrub11]
#10 Special
