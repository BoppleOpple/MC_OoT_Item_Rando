...
execute if entity @a[scores={MiniGameTime=1200}] run tag @a add NoTeleport
...
execute as @e[type=horse,tag=Epona] if entity @a[scores={MiniGameTime=1..6}] run tag @a remove NoTeleport
