...
#Treasure Shop
execute if block 862 50 1417 minecraft:barrier as @e[type=marker,tag=RandomTreasure] run function ocarina_of_time:moving_things/castle_town/minigames/treasure_randomizer
...
#Pots
execute as @e[type=marker,tag=Pots] run function ocarina_of_time:moving_things/castle_town/pots
execute as @e[type=marker,tag=Pots2] run function ocarina_of_time:moving_things/castle_town/pots_2

#Master Sword Switch
execute at @a if entity @e[type=armor_stand,tag=MasterSword,distance=..5] unless entity @e[type=item,distance=..30] unless entity @a[tag=Adult] as @e[type=armor_stand,tag=MasterSword] unless block 995 5 1394 minecraft:gold_block unless data entity @s ArmorItems[].id unless data entity @s HandItems[].id run function ocarina_of_time:moving_things/castle_town/master_sword/first_time
execute at @a if entity @e[type=armor_stand,tag=MasterSword,distance=..5] unless entity @e[type=item,distance=..30] unless entity @a[tag=Adult] as @e[type=armor_stand,tag=MasterSword] if block 995 5 1394 minecraft:gold_block unless data entity @s ArmorItems[].id unless data entity @s HandItems[].id run function ocarina_of_time:moving_things/castle_town/master_sword/adult
...
#Item in Sword Slot
execute as @e[type=armor_stand,tag=MasterSword] if data entity @s ArmorItems[].id run function ocarina_of_time:moving_things/castle_town/pedestal/teleport
...
execute if entity @a[tag=NoOcarina] as @e[type=armor_stand,tag=MasterSword] unless entity @s[nbt={HandItems:[{id:"minecraft:diamond_sword"},{}]}] unless data entity @s ArmorItems[].id unless data entity @s HandItems[].id run function ocarina_of_time:moving_things/castle_town/pedestal/finish
