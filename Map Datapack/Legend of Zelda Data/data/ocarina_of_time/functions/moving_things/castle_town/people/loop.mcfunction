#Day/Night
execute unless entity @a[x=886,y=60,z=1426,dx=0,dz=0] unless entity @a[x=884,y=60,z=1426,dx=0,dz=0] unless entity @a[x=882,y=60,z=1426,dx=0,dz=0] unless entity @a[x=880,y=60,z=1426,dx=0,dz=0] unless entity @a[scores={time=13001..23000}] run function ocarina_of_time:moving_things/castle_town/people/morning_people
execute unless entity @a[x=886,y=60,z=1426,dx=0,dz=0] unless entity @a[x=884,y=60,z=1426,dx=0,dz=0] unless entity @a[x=882,y=60,z=1426,dx=0,dz=0] unless entity @a[x=880,y=60,z=1426,dx=0,dz=0] if entity @a[scores={time=13001..23000}] run function ocarina_of_time:moving_things/castle_town/people/night_people
