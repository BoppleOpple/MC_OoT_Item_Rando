...
execute if entity @a[scores={MiniGameTime=1}] run scoreboard players add @a DekuSeeds2 50
...
execute if entity @a[scores={MiniGameTime=640}] if entity @s[scores={lifetime=10}] unless entity @s[tag=Prize] as @e[type=marker,tag=Progress] if entity @s[tag=SlingshotUpgrade1] run tag @s add SlingshotUpgrade2
execute if entity @a[scores={MiniGameTime=640}] if entity @s[scores={lifetime=10}] unless entity @s[tag=Prize] if entity @e[type=marker,tag=Progress,tag=SlingshotUpgrade2] run advancement grant @a only minecraft:_upgrades/slingshot_upgrade_2
execute if entity @a[scores={MiniGameTime=640}] if entity @s[scores={lifetime=10}] unless entity @s[tag=Prize] if entity @e[type=marker,tag=Progress,tag=SlingshotUpgrade2] run tellraw @a ["",{"text":"You got the "},{"text":"Biggest Deku Seed Bullet Bag","color":"red"},{"text":"! This bag can hold up to "},{"text":"50 ","color":"yellow"},{"text":"slingshot bullets."}]
execute if entity @a[scores={MiniGameTime=640}] if entity @s[scores={lifetime=10}] unless entity @s[tag=Prize] if entity @e[type=marker,tag=Progress,tag=SlingshotUpgrade2] run scoreboard players set @a DekuSeeds2 50
execute if entity @a[scores={MiniGameTime=640}] if entity @s[scores={lifetime=10}] unless entity @s[tag=Prize] as @e[type=marker,tag=Progress] unless entity @s[tag=SlingshotUpgrade1] run tag @s add SlingshotUpgrade1
execute if entity @a[scores={MiniGameTime=640}] if entity @s[scores={lifetime=10}] unless entity @s[tag=Prize] as @e[type=marker,tag=Progress,tag=SlingshotUpgrade1] unless entity @s[tag=SlingshotUpgrade2] run advancement grant @a only minecraft:_upgrades/slingshot_upgrade_1
execute if entity @a[scores={MiniGameTime=640}] if entity @s[scores={lifetime=10}] unless entity @s[tag=Prize] as @e[type=marker,tag=Progress,tag=SlingshotUpgrade1] unless entity @s[tag=SlingshotUpgrade2] run tellraw @a ["",{"text":"You got a "},{"text":"Big Deku Seed Bullet Bag","color":"aqua"},{"text":"! This bag can hold up to "},{"text":"40 ","color":"yellow"},{"text":"slingshot bullets."}]
execute if entity @a[scores={MiniGameTime=640}] if entity @s[scores={lifetime=10}] unless entity @s[tag=Prize] as @e[type=marker,tag=Progress,tag=SlingshotUpgrade1] unless entity @s[tag=SlingshotUpgrade2] run scoreboard players set @a DekuSeeds2 40
