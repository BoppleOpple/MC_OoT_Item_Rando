...
#Bomb Bag
execute unless block 868 36 1421 minecraft:gold_block if entity @s[tag=Prize,scores={lifetime=3..4}] if entity @e[type=item,nbt={Item:{tag:{BombBag:1b}}},x=873,y=41.5,z=1421,dx=0,dz=0] as @e[type=marker,tag=Progress] if entity @s[tag=BombUpgrade1] run tag @s add BombUpgrade2
execute unless block 868 36 1421 minecraft:gold_block if entity @s[tag=Prize,scores={lifetime=3..4}] if entity @e[type=item,nbt={Item:{tag:{BombBag:1b}}},x=873,y=41.5,z=1421,dx=0,dz=0] if entity @e[type=marker,tag=Progress,tag=BombUpgrade2] run advancement grant @a only minecraft:_upgrades/bomb_upgrade_2
execute unless block 868 36 1421 minecraft:gold_block if entity @s[tag=Prize,scores={lifetime=3..4}] if entity @e[type=item,nbt={Item:{tag:{BombBag:1b}}},x=873,y=41.5,z=1421,dx=0,dz=0] if entity @e[type=marker,tag=Progress,tag=BombUpgrade2] run tellraw @a ["",{"text":"You got the ","color":"white"},{"text":"Biggest Bomb Bag","color":"red"},{"text":"! Now you can carry up to "},{"text":"40 ","color":"yellow"},{"text":"Bombs!"}]
execute unless block 868 36 1421 minecraft:gold_block if entity @s[tag=Prize,scores={lifetime=3..4}] if entity @e[type=item,nbt={Item:{tag:{BombBag:1b}}},x=873,y=41.5,z=1421,dx=0,dz=0] if entity @e[type=marker,tag=Progress,tag=BombUpgrade2] run give @p tnt{display:{Name:"\"Bomb\""}} 50
execute unless block 868 36 1421 minecraft:gold_block if entity @s[tag=Prize,scores={lifetime=3..4}] if entity @e[type=item,nbt={Item:{tag:{BombBag:1b}}},x=873,y=41.5,z=1421,dx=0,dz=0] as @e[type=marker,tag=Progress] unless entity @s[tag=BombUpgrade1] run tag @s add BombUpgrade1
execute unless block 868 36 1421 minecraft:gold_block if entity @s[tag=Prize,scores={lifetime=3..4}] if entity @e[type=item,nbt={Item:{tag:{BombBag:1b}}},x=873,y=41.5,z=1421,dx=0,dz=0] as @e[type=marker,tag=Progress,tag=BombUpgrade1] unless entity @s[tag=BombUpgrade2] run advancement grant @a only minecraft:_upgrades/bomb_upgrade_1
...
execute unless block 868 36 1421 minecraft:gold_block if entity @s[tag=Prize,scores={lifetime=3..4}] if entity @e[type=item,nbt={Item:{tag:{BombBag:1b}}},x=873,y=41.5,z=1421,dx=0,dz=0] as @e[type=marker,tag=Progress,tag=BombUpgrade1] unless entity @s[tag=BombUpgrade2] run give @p tnt{display:{Name:"\"Bomb\""}} 50
