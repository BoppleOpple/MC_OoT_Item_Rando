...
execute if entity @s[scores={timer=222}] run kill @e[nbt={Item:{id:"minecraft:diamond_sword"}}]
...
execute if entity @s[scores={timer=340..}] run fill 902 5 -635 902 5 -635 minecraft:gold_block
