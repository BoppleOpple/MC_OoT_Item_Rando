...
execute if entity @s[tag=FinalGanonDeath,scores={GameTimer=561..850}] run tp @a 80 5 518 90 0
...
execute if entity @s[tag=FinalGanonDeath,scores={GameTimer=690}] run tp @e[type=armor_stand,tag=Ganondorf8] 78 5.3 518
