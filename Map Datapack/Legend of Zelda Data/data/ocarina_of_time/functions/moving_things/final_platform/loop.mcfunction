...
#Pickup Master Sword
execute as @e[type=armor_stand,tag=MasterSword] at @s if entity @a[distance=..1] run give @a minecraft:diamond_sword{display:{Name:"\"Master Sword\""},HideFlags:63,Unbreakable:1,CanDestroy:["minecraft:grass","minecraft:oak_sign","minecraft:fern","minecraft:flower_pot","minecraft:azalea_leaves"]}
