...
tag @s remove self
#Fly Down
execute if entity @e[type=zombie,tag=Volvagia,tag=Fly] if entity @s[scores={lifetime=201..}] positioned ~ ~1 ~ if entity @e[type=marker,tag=DragonFloor,tag=Return,distance=..1] run tag @s add FlyDown
...
tag @s remove self
#Fly Down
execute if entity @e[type=zombie,tag=Volvagia,tag=Boulder] if entity @s[scores={lifetime=601..}] positioned ~ ~-18 ~ if entity @e[type=marker,tag=DragonFloor3,distance=..1] run tag @s add FlyDown
