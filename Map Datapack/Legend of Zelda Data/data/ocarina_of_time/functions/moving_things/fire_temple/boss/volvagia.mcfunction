...
#Bubbles
execute as @e[type=marker,tag=AppearSpot] at @s run function ocarina_of_time:moving_things/fire_temple/boss/fake_out
scoreboard players add @s GameTimer 1
execute unless entity @s[tag=Phase1] if entity @s[tag=Phase2,scores={GameTimer=1}] run tag @e[type=marker,tag=DragonFloor3] add AppearSpot
execute unless entity @s[tag=Phase1] unless entity @s[tag=Phase2] if entity @s[scores={GameTimer=1}] run tag @e[type=marker,tag=DragonFloor,sort=random,limit=1] add AppearSpot
execute if entity @s[tag=Phase1] if entity @s[scores={GameTimer=1}] run tag @e[type=marker,tag=DragonFloor,sort=random,limit=1] add AppearSpot
execute unless entity @s[tag=Fly] if entity @s[tag=Fake1] if entity @s[scores={GameTimer=30}] run tag @e[type=marker,tag=DragonFloor,tag=!AppearSpot,sort=random,limit=1] add AppearSpot
execute unless entity @s[tag=Fly] if entity @s[tag=Fake2] if entity @s[scores={GameTimer=30}] run tag @e[type=marker,tag=DragonFloor,tag=!AppearSpot,sort=random,limit=1] add AppearSpot
execute unless entity @s[tag=Fly] if entity @s[tag=Fake2] if entity @s[scores={GameTimer=60}] run tag @e[type=marker,tag=DragonFloor,tag=!AppearSpot,sort=random,limit=1] add AppearSpot
execute unless entity @s[tag=Fly] if entity @s[tag=Fake3] if entity @s[scores={GameTimer=30}] run tag @e[type=marker,tag=DragonFloor,tag=!AppearSpot,sort=random,limit=1] add AppearSpot
execute unless entity @s[tag=Fly] if entity @s[tag=Fake3] if entity @s[scores={GameTimer=60}] run tag @e[type=marker,tag=DragonFloor,tag=!AppearSpot,sort=random,limit=1] add AppearSpot
execute unless entity @s[tag=Fly] if entity @s[tag=Fake3] if entity @s[scores={GameTimer=90}] run tag @e[type=marker,tag=DragonFloor,tag=!AppearSpot,sort=random,limit=1] add AppearSpot
...
execute if entity @s[tag=Ground,scores={timer=1}] at @e[type=marker,tag=AppearSpot,scores={timer=1..20}] run tp @s ~ ~-5 ~
execute if entity @s[tag=Ground,scores={timer=1}] at @e[type=marker,tag=AppearSpot,scores={timer=1..20}] run summon minecraft:armor_stand ~ ~-5 ~ {Tags:["Volvagia","VolvagiaGround"],Rotation:[-90f],ArmorItems:[{},{},{},{id:dead_tube_coral_fan,Count:1b,tag:{CustomModelData:2}}],NoGravity:1b,Invisible:1b,Pose:{Head:[-110f,0f,180f]}}
...
execute if entity @s[tag=Fly,scores={timer=1}] positioned as @e[type=marker,tag=AppearSpot,scores={timer=1..20}] run tp @s ~ ~-5 ~ ~ -90
...
#Return
execute if entity @s[tag=Fly,scores={timer=351}] run tag @e[type=marker,tag=DragonFloor,sort=furthest,limit=1] add Return
#Right
execute unless entity @s[tag=FlyDown] if entity @s[tag=Fly,scores={timer=351..}] at @s positioned ^ ^ ^1 facing entity @e[type=marker,tag=DragonFloor,tag=Return] eyes positioned ^1 ^ ^ if entity @s[distance=..1.4142] at @s run tp @s ^ ^ ^.08 ~-3 ~
#Left
execute unless entity @s[tag=FlyDown] if entity @s[tag=Fly,scores={timer=351..}] at @s positioned ^ ^ ^1 facing entity @e[type=marker,tag=DragonFloor,tag=Return] eyes positioned ^1 ^ ^ unless entity @s[distance=..1.4142] at @s run tp @s ^ ^ ^.08 ~3 ~
#FlyDown
execute if entity @s[tag=Fly,scores={timer=351..}] positioned ~ ~1 ~ if entity @e[type=marker,tag=DragonFloor,tag=Return,distance=..1] run tag @s add FlyDown
...
execute if entity @s[tag=Boulder,scores={timer=1}] positioned as @e[type=marker,tag=DragonFloor3] run tp @s ~ ~-5 ~ 60 -90
...
execute if entity @s[scores={timer=2000}] run tag @e[type=marker,tag=DragonFloor] remove Return
