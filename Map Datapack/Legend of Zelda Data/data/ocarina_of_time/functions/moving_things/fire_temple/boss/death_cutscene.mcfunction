...
execute if entity @s[tag=Die,scores={ArrowCount=14}] positioned as @e[type=marker,tag=DragonFloor5] run tp @s ~ ~-5 ~ -10 -90
...
execute if entity @s[tag=Die,scores={ArrowCount=360}] run kill @e[type=marker,tag=DragonFloor]
