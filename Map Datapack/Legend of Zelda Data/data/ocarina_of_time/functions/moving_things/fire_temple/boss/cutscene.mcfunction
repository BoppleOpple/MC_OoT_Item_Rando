...
execute if entity @s[tag=Fly,scores={ArrowCount=63}] positioned as @e[type=marker,tag=DragonFloor5] run tp @s ~ ~-5 ~ 160 -90
...
#Right
execute unless entity @e[type=marker,tag=DragonFloor8,tag=Return] if entity @s[tag=Fly,scores={ArrowCount=207..600}] at @s positioned ^ ^ ^1 facing entity @e[type=armor_stand,tag=DragonFollow] eyes positioned ^1 ^ ^ if entity @s[distance=..1.4142] at @s run tp @s ^ ^ ^.08 ~-3 ~
#Left
execute unless entity @e[type=marker,tag=DragonFloor8,tag=Return] if entity @s[tag=Fly,scores={ArrowCount=207..600}] at @s positioned ^ ^ ^1 facing entity @e[type=armor_stand,tag=DragonFollow] eyes positioned ^1 ^ ^ unless entity @s[distance=..1.4142] at @s run tp @s ^ ^ ^.08 ~3 ~
#Return
execute if entity @s[tag=Fly,scores={ArrowCount=455}] run tag @e[type=marker,tag=DragonFloor8] add Return
#Right
execute unless entity @s[tag=FlyDown] if entity @e[type=marker,tag=DragonFloor8,tag=Return] at @s positioned ^ ^ ^1 facing entity @e[type=marker,tag=DragonFloor,tag=Return] eyes positioned ^1 ^ ^ if entity @s[distance=..1.4142] at @s run tp @s ^ ^ ^.08 ~-3 ~
#Left
execute unless entity @s[tag=FlyDown] if entity @e[type=marker,tag=DragonFloor8,tag=Return] at @s positioned ^ ^ ^1 facing entity @e[type=marker,tag=DragonFloor,tag=Return] eyes positioned ^1 ^ ^ unless entity @s[distance=..1.4142] at @s run tp @s ^ ^ ^.08 ~3 ~
#FlyDown
execute if entity @s[tag=Fly] positioned ~ ~1 ~ if entity @e[type=marker,tag=DragonFloor,tag=Return,distance=..1] run tag @s add FlyDown
...
execute if entity @s[scores={ArrowCount=860..}] run tag @e[type=marker,tag=DragonFloor] remove Return
