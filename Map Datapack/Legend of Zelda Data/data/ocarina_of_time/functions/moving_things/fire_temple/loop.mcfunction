...
#Pots
execute as @e[type=marker,tag=Pots] run function ocarina_of_time:moving_things/fire_temple/pots

#Pressure Plates
execute as @e[type=marker,tag=TimerFireWall] run function ocarina_of_time:moving_things/fire_temple/pressure_plates/fire_wall
...
execute as @e[type=marker,tag=FirePlatforms] run function ocarina_of_time:moving_things/fire_temple/fire_platforms
...
execute if entity @a[x=3109,y=47,z=1924,dx=6,dy=5,dz=8] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_wait",Count:1b}]}] unless entity @a[x=3111,y=47,z=1928,dx=2,dz=2] unless entity @a[x=875,y=56,z=-1176,dx=0,dz=2] run scoreboard players add @e[type=marker,tag=TimeBlock] timer 1
execute if entity @a[x=3026,y=110,z=1953,dx=6,dy=5,dz=10] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_wait",Count:1b}]}] unless entity @a[x=3030,y=109,z=1959,dx=2,dz=2] run scoreboard players add @e[type=marker,tag=TimeBlock] lifetime 1
...
execute if entity @a[x=3080,y=42,z=1926,dx=0,dz=0] run tag @a remove HotArea
execute if entity @a[x=3080,y=42,z=1928,dx=0,dz=0] run tag @a add HotArea

execute if entity @a[x=3075,y=42,z=1917,dx=0,dz=0] run tag @a remove HotArea
execute if entity @a[x=3073,y=42,z=1917,dx=0,dz=0] run tag @a add HotArea
...
execute as @e[type=marker,tag=Pipes] at @a run function ocarina_of_time:moving_things/fire_temple/pipes
...
#Mimic
execute as @e[type=marker,tag=TimerFireWall] unless entity @e[type=zombie,tag=DoorMimic3] run fill 3010 110 1952 3012 112 1950 minecraft:air replace minecraft:chiseled_red_sandstone
execute as @e[type=marker,tag=TimerFireWall] unless entity @e[type=zombie,tag=DoorMimic3] run fill 3011 110 1951 3011 110 1951 minecraft:stone_pressure_plate replace minecraft:air
...
#Hammer Safety
execute as @e[type=item,x=3019,y=158,z=1963,dx=4,dy=1,dz=4] run tp @s 3018 158 1962
