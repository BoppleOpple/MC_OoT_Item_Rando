...
#Owl
execute unless entity @a[tag=Adult] as @e[type=armor_stand,tag=OwlStand10] at @s run tp @s ~ ~ ~ facing entity @p
execute as @e[type=armor_stand,tag=OwlFly] at @s run function ocarina_of_time:moving_things/lake_hylia_child/owl
execute if entity @a[tag=Fly] unless entity @e[type=marker,tag=Fly] run summon minecraft:marker 730.523 73.00000 2760.502 {Tags:["Fly"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute as @e[type=marker,tag=Fly] at @s run function ocarina_of_time:moving_things/lake_hylia_child/fly
...
#Bug Grass
execute as @e[type=marker,tag=Pots] run function ocarina_of_time:moving_things/lake_hylia_child/grass
...
#Scarecrow
execute if entity @e[type=marker,tag=Songs,tag=Scarecrow] run scoreboard players set @e[type=armor_stand,tag=Bonooru2] text 3
...
#Big Fairies
execute positioned 817 66 2782 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @e[type=armor_stand,tag=GreenNavi1] run summon minecraft:armor_stand 817 66 2782 {Tags:["GreenNavi","GreenNavi1"],Small:1b,Marker:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;-102214788,162220947,-1666754575,1836136248],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTljNTE1NDVkNTQ5NDczZWNjYWE2NzdiZTc3ZmM4OTNjZmEwNWVjMWYwM2I4NWMyZWJjMjM0MmM0YTlmOTdjMyJ9fX0="}]}}}}]}
execute positioned 817 66 2782 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run tag @a add GreenNaviSpot
execute positioned 817 66 2782 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_stal",Count:1b}]}] run function ocarina_of_time:items/big_fairy/summon
...
#Water Temple
execute unless block 776 41 2761 minecraft:water if entity @e[type=marker,tag=Progress,tag=GotWaterMedallion] run fill 778 39 2762 774 36 2762 minecraft:water
execute unless block 776 41 2761 minecraft:water if entity @e[type=marker,tag=Progress,tag=GotWaterMedallion] run fill 776 41 2761 776 41 2761 minecraft:water
