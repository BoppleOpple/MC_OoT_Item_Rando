...
execute as @e[type=marker,tag=RedPoeWatch] if block 881 64 -1204 minecraft:gold_block unless entity @e[type=armor_stand,tag=RedPainting] run fill 881 65 -1204 881 65 -1204 minecraft:gold_block
#Sound
...
execute if block 927 74 -1201 minecraft:gold_block if block 928 74 -1200 minecraft:gold_block if block 830 3 -1068 minecraft:grass_block unless entity @e[type=armor_stand,tag=BluePainting] run fill 911 65 -1204 911 65 -1204 minecraft:gold_block
#Sound
...
execute if block 948 56 -1154 minecraft:gold_block if block 942 57 -1154 minecraft:air run scoreboard players set @a MiniGameTime -10
