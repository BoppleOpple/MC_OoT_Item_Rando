...
#Push away
execute as @e[type=zombie,tag=GreenPoeBlock1,y_rotation=90] at @s as @e[type=zombie,tag=GreenPoeBlock2,distance=..1] run tp @s ~1 ~ ~
execute as @e[type=zombie,tag=GreenPoeBlock1,y_rotation=90] at @s as @e[type=zombie,tag=GreenPoeBlock3,distance=..1] run tp @s ~1 ~ ~1
execute as @e[type=zombie,tag=GreenPoeBlock1,y_rotation=90] at @s as @e[type=zombie,tag=GreenPoeBlock4,distance=..1] run tp @s ~ ~ ~1
execute as @e[type=zombie,tag=GreenPoeBlock1,y_rotation=180] at @s as @e[type=zombie,tag=GreenPoeBlock2,distance=..1] run tp @s ~ ~ ~1
execute as @e[type=zombie,tag=GreenPoeBlock1,y_rotation=180] at @s as @e[type=zombie,tag=GreenPoeBlock3,distance=..1] run tp @s ~-1 ~ ~1
execute as @e[type=zombie,tag=GreenPoeBlock1,y_rotation=180] at @s as @e[type=zombie,tag=GreenPoeBlock4,distance=..1] run tp @s ~-1 ~ ~
execute as @e[type=zombie,tag=GreenPoeBlock1,y_rotation=270] at @s as @e[type=zombie,tag=GreenPoeBlock2,distance=..1] run tp @s ~-1 ~ ~
execute as @e[type=zombie,tag=GreenPoeBlock1,y_rotation=270] at @s as @e[type=zombie,tag=GreenPoeBlock3,distance=..1] run tp @s ~-1 ~ ~-1
execute as @e[type=zombie,tag=GreenPoeBlock1,y_rotation=270] at @s as @e[type=zombie,tag=GreenPoeBlock4,distance=..1] run tp @s ~ ~ ~-1
execute as @e[type=zombie,tag=GreenPoeBlock1,y_rotation=0] at @s as @e[type=zombie,tag=GreenPoeBlock2,distance=..1] run tp @s ~ ~ ~-1
execute as @e[type=zombie,tag=GreenPoeBlock1,y_rotation=0] at @s as @e[type=zombie,tag=GreenPoeBlock3,distance=..1] run tp @s ~1 ~ ~-1
execute as @e[type=zombie,tag=GreenPoeBlock1,y_rotation=0] at @s as @e[type=zombie,tag=GreenPoeBlock4,distance=..1] run tp @s ~1 ~ ~
