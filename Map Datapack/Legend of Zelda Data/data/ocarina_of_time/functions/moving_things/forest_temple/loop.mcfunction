...
#Pots
execute as @e[type=marker,tag=Pots] run function ocarina_of_time:moving_things/forest_temple/pots
...
#Down
execute if block 919 68 -1194 minecraft:stone_pressure_plate[powered=true] unless block 919 68 -1194 minecraft:air at @a run summon minecraft:marker ~ ~ ~ {Tags:["WaterLevel"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
...
execute if entity @a[x=873,y=56,z=-1179,dx=8,dy=1,dz=8] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_wait",Count:1b}]}] unless entity @a[x=876,y=56,z=-1177,dx=3,dz=4] unless entity @a[x=875,y=56,z=-1176,dx=0,dz=2] run scoreboard players add @e[type=marker,tag=TimeBlock] timer 1
...
#1
execute if entity @e[type=arrow,x=849,y=88,z=-1164,dx=0,dz=-0] unless entity @a[gamemode=spectator] if block 849 88 -1165 minecraft:light_gray_shulker_box unless entity @e[type=marker,tag=TwistedRoom1] run summon minecraft:marker 849 84 -1190 {Tags:["TwistedRoom","TwistedRoom1"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute if entity @e[type=arrow,x=849,y=88,z=-1164,dx=0,dz=-0] if entity @a[gamemode=spectator] run kill @e[type=arrow]
#2
execute if entity @e[type=arrow,x=849,y=88,z=-1164,dx=0,dz=-0] unless entity @a[gamemode=spectator] if block 849 88 -1165 minecraft:white_shulker_box unless entity @e[type=marker,tag=TwistedRoom2] run summon minecraft:marker 849 84 -1190 {Tags:["TwistedRoom","TwistedRoom2"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute if entity @e[type=arrow,x=849,y=88,z=-1164,dx=0,dz=-0] if entity @a[gamemode=spectator] run kill @e[type=arrow]
#3
execute if entity @a[x=849,y=85,z=-1167,dx=0,dz=0] if block 849 88 -1165 minecraft:light_gray_shulker_box unless entity @e[type=marker,tag=TwistedRoom1] unless entity @e[type=marker,tag=TwistedRoom2] unless entity @e[type=marker,tag=TwistedRoom3] run summon minecraft:marker 815 51 -1162 {Tags:["TwistedRoom","TwistedRoom3"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
#4
execute if entity @a[x=848,y=85,z=-1190,dx=2,dz=0] if block 849 88 -1165 minecraft:light_gray_shulker_box unless entity @e[type=marker,tag=TwistedRoom1] unless entity @e[type=marker,tag=TwistedRoom2] unless entity @e[type=marker,tag=TwistedRoom4] run summon minecraft:marker 815 51 -1162 {Tags:["TwistedRoom","TwistedRoom4"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
...
#1
execute if entity @e[type=arrow,x=936,y=87,z=-1154,dx=0,dz=-0] unless entity @a[gamemode=spectator] unless block 936 87 -1154 minecraft:ice if block 935 87 -1154 minecraft:light_gray_shulker_box unless entity @e[type=marker,tag=TwistedRoom5] run summon minecraft:marker 946 84 -1190 {Tags:["TwistedRoom","TwistedRoom5"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute if entity @e[type=arrow,x=936,y=87,z=-1154,dx=0,dz=-0] if entity @a[gamemode=spectator] run kill @e[type=arrow]
#2
execute if entity @e[type=arrow,x=936,y=87,z=-1154,dx=0,dz=-0] unless entity @a[gamemode=spectator] unless block 936 87 -1154 minecraft:ice if block 935 87 -1154 minecraft:white_shulker_box unless entity @e[type=marker,tag=TwistedRoom6] run summon minecraft:marker 946 84 -1190 {Tags:["TwistedRoom","TwistedRoom6"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute if entity @e[type=arrow,x=936,y=87,z=-1154,dx=0,dz=-0] if entity @a[gamemode=spectator] run kill @e[type=arrow]
#3
execute if entity @a[x=946,y=85,z=-1167,dx=0,dz=0] unless block 936 87 -1154 minecraft:ice if block 935 87 -1154 minecraft:white_shulker_box unless entity @e[type=marker,tag=TwistedRoom5] unless entity @e[type=marker,tag=TwistedRoom6] unless entity @e[type=marker,tag=TwistedRoom7] run summon minecraft:marker 973 56 -1182 {Tags:["TwistedRoom","TwistedRoom7"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
#4
execute if entity @a[x=945,y=85,z=-1190,dx=2,dz=0] unless block 936 87 -1154 minecraft:ice if block 935 87 -1154 minecraft:white_shulker_box unless entity @e[type=marker,tag=TwistedRoom5] unless entity @e[type=marker,tag=TwistedRoom6] unless entity @e[type=marker,tag=TwistedRoom8] run summon minecraft:marker 973 56 -1182 {Tags:["TwistedRoom","TwistedRoom8"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}

#Spinning Platform
execute positioned 946 79 -1154 if entity @a[distance=..15] as @e[type=marker,tag=ForestSpin] run function ocarina_of_time:moving_things/forest_temple/spinning_platforms
...
execute if entity @a[x=944,y=60,z=-1197,dx=9,dy=1,dz=31] as @e[type=marker,tag=FallCeiling] run tag @s add Fall
execute as @e[type=marker,tag=FallCeiling,tag=Fall] run function ocarina_of_time:moving_things/forest_temple/falling_ceiling
