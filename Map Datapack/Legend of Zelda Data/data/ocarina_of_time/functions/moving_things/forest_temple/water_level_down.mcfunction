...
execute as @e[type=marker,tag=WaterLevel] run scoreboard players add @s timer 1
execute as @e[type=marker,tag=WaterLevel,scores={timer=1}] run gamemode spectator @a
execute as @e[type=marker,tag=WaterLevel,scores={timer=1..19}] run tp @p 929 63 -1172 0 60
execute as @e[type=marker,tag=WaterLevel,scores={timer=20}] run tp @p @s
execute as @e[type=marker,tag=WaterLevel,scores={timer=20}] run gamemode adventure @a
execute as @e[type=marker,tag=WaterLevel,scores={timer=21..}] run kill @s
