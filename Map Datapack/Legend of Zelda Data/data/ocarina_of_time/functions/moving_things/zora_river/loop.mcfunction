...
#WaterFall
execute if entity @a[x=1605,y=89,z=2285,dx=2,dz=2,nbt={Inventory:[{id:"minecraft:music_disc_mall",Count:1b}]}] run tag @e[type=marker,tag=Waterfall] add Open
execute as @e[type=marker,tag=Waterfall,tag=Open] run function ocarina_of_time:moving_things/zora_river/waterfall
...
execute if entity @a[x=1610,y=81,z=2283,dx=0,dy=10,dz=6] unless entity @e[type=marker,tag=Waterfall,tag=Open] run tp @a 1607 81 2286 90 ~
...
#Pots
execute as @e[type=marker,tag=Pots] run function ocarina_of_time:moving_things/zora_river/grass
