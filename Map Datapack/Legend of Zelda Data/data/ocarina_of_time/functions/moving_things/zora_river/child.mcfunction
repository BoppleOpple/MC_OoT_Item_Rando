...
execute if entity @a[x=1507,y=69,z=2315,dx=0,dz=0] unless entity @e[type=marker,tag=BeanSpot,tag=PlantBean10] if entity @a[nbt={SelectedItem:{tag:{MagicBean:1b}}}] positioned 1507 69 2315 run function ocarina_of_time:items/magic_bean
execute if block 1507 69 2315 minecraft:pumpkin_stem[age=6] as @e[type=marker,tag=BeanSpot] unless entity @s[tag=PlantBean10] run tag @s add PlantBean10
