...
#Pots
execute as @e[type=marker,tag=Pots] run function ocarina_of_time:moving_things/ice_cavern/pots

#Silver Rupees
#1
execute if block 2047 27 2305 minecraft:air if entity @e[type=armor_stand,tag=IceBladeTrap] if entity @e[type=marker,tag=SilverRupeeCounter,scores={BlueRupee=0}] run fill 2058 30 2288 2057 32 2287 minecraft:air replace minecraft:ice
execute if block 2047 27 2305 minecraft:air if entity @e[type=armor_stand,tag=IceBladeTrap] if entity @e[type=marker,tag=SilverRupeeCounter,scores={BlueRupee=0}] run fill 2047 27 2305 2047 27 2305 minecraft:gold_block
#2
execute if block 2035 27 2293 minecraft:air if entity @e[type=armor_stand,tag=IceBladeTrap] if entity @e[type=marker,tag=SilverRupeeCounter,scores={BlueRupee2=0}] run fill 2021 28 2300 2019 31 2300 minecraft:air replace minecraft:ice
execute if block 2035 27 2293 minecraft:air if entity @e[type=armor_stand,tag=IceBladeTrap] if entity @e[type=marker,tag=SilverRupeeCounter,scores={BlueRupee2=0}] run fill 2035 27 2293 2035 27 2293 minecraft:gold_block
...
execute if entity @a[x=2011,y=27,z=2287,dx=5,dy=1,dz=5] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_wait",Count:1b}]}] run scoreboard players add @e[type=marker,tag=TimeBlock] timer 1

#Big Fairies
execute positioned 2050 26 2331 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run summon minecraft:armor_stand 2050 26 2331 {Tags:["GreenNavi"],Small:1b,Marker:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;-102214788,162220947,-1666754575,1836136248],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTljNTE1NDVkNTQ5NDczZWNjYWE2NzdiZTc3ZmM4OTNjZmEwNWVjMWYwM2I4NWMyZWJjMjM0MmM0YTlmOTdjMyJ9fX0="}]}}}}]}
execute positioned 2050 26 2331 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run tag @a add GreenNaviSpot
execute positioned 2050 26 2331 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_stal",Count:1b}]}] run function ocarina_of_time:items/big_fairy/summon
