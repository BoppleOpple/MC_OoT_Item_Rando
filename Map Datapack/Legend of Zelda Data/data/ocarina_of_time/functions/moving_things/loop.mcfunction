...
#Loot Tables
scoreboard players add @e[type=marker,tag=LootTable] timer 1
execute as @e[type=marker,tag=LootTable,scores={timer=101..}] run scoreboard players set @s timer 0
