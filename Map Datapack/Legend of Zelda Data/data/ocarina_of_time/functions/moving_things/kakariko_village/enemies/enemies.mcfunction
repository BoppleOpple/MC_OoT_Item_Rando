...
#Redead
#1
execute as @e[type=wither_skeleton,tag=Redead1] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=RedeadReturn1] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Redead1] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=RedeadReturn1,distance=...1] run tp @s 1589 50 1955 180 60
#2
execute as @e[type=wither_skeleton,tag=Redead2] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=RedeadReturn2] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Redead2] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=RedeadReturn2,distance=...1] run tp @s 1589 50 1945 -90 60
#3
execute as @e[type=wither_skeleton,tag=Redead3] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=RedeadReturn3] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Redead3] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=RedeadReturn3,distance=...1] run tp @s 1584 50 1948 0 60
#4
execute as @e[type=wither_skeleton,tag=Redead4] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=RedeadReturn4] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Redead4] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=RedeadReturn4,distance=...1] run tp @s 1598 34 1956 0 60
#5
execute as @e[type=wither_skeleton,tag=Redead5] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=RedeadReturn5] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Redead5] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=RedeadReturn5,distance=...1] run tp @s 1742 32 1977 0 60
#6
execute as @e[type=wither_skeleton,tag=Redead6] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=RedeadReturn6] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Redead6] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=RedeadReturn6,distance=...1] run tp @s 1711 32 2009 -90 60
#7
execute as @e[type=wither_skeleton,tag=Redead7] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=RedeadReturn7] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Redead7] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=RedeadReturn7,distance=...1] run tp @s 1684 32 2013 -90 60
#8
execute as @e[type=wither_skeleton,tag=Redead8] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=RedeadReturn8] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Redead8] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=RedeadReturn8,distance=...1] run tp @s 1680 33 1976 0 60
...
#9
execute as @e[type=wither_skeleton,tag=Redead26] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=RedeadReturn26] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Redead26] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=RedeadReturn26,distance=...1] run tp @s 1497 38 1916 -45 60
#10
execute as @e[type=wither_skeleton,tag=Redead27] at @s unless entity @s[tag=Stun] unless entity @s[tag=Attack] facing entity @e[type=marker,tag=RedeadReturn27] feet rotated ~ 0 run tp @s ^ ^ ^.02 ~ ~
execute as @e[type=wither_skeleton,tag=Redead27] at @s unless entity @s[tag=Attack] if entity @e[type=marker,tag=RedeadReturn27,distance=...1] run tp @s 1503 38 1916 45 60
