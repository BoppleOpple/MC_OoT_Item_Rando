...
#FailSafe
execute if blocks 1627 65 1969 1627 65 1976 1627 66 1969 all unless entity @e[type=item,nbt={Item:{tag:{display:{Name:"{\"text\":\"Heart Piece\"}"},Prize:1,InventoryItem:1b,HeartPiece:1b}}}] run summon minecraft:item ^ ^ ^1 {Item:{id:golden_carrot,Count:1,tag:{display:{Name:"{\"text\":\"Heart Piece\"}"},Prize:1,InventoryItem:1b,HeartPiece:1b}},PickupDelay:10}
