...
execute if entity @a[x=1613,y=75,z=1942,dx=0,dz=0] unless entity @e[type=marker,tag=BeanSpot,tag=PlantBean5] if entity @a[nbt={SelectedItem:{tag:{MagicBean:1b}}}] positioned 1613 75 1942 run function ocarina_of_time:items/magic_bean
execute if block 1613 75 1942 minecraft:pumpkin_stem[age=6] as @e[type=marker,tag=BeanSpot] unless entity @s[tag=PlantBean5] run tag @s add PlantBean5
