...
execute if entity @a[scores={MiniGameTime=1}] run scoreboard players set @a ArrowCount2 50
...
execute if entity @a[scores={MiniGameTime=640}] if entity @s[scores={lifetime=10}] unless entity @s[tag=Prize] as @e[type=marker,tag=Progress] if entity @s[tag=FairyBowUpgrade1] run tag @s add FairyBowUpgrade2
execute if entity @a[scores={MiniGameTime=640}] if entity @s[scores={lifetime=10}] unless entity @s[tag=Prize] if entity @e[type=marker,tag=Progress,tag=FairyBowUpgrade2] run advancement grant @a only minecraft:_upgrades/biggest_quiver
...
execute if entity @a[scores={MiniGameTime=640}] if entity @s[scores={lifetime=10}] unless entity @s[tag=Prize] if entity @e[type=marker,tag=Progress,tag=FairyBowUpgrade2] run scoreboard players set @a ArrowCount2 50
execute if entity @a[scores={MiniGameTime=640}] if entity @s[scores={lifetime=10}] unless entity @s[tag=Prize] as @e[type=marker,tag=Progress] unless entity @s[tag=FairyBowUpgrade1] run tag @s add FairyBowUpgrade1
execute if entity @a[scores={MiniGameTime=640}] if entity @s[scores={lifetime=10}] unless entity @s[tag=Prize] as @e[type=marker,tag=Progress,tag=FairyBowUpgrade1] unless entity @s[tag=FairyBowUpgrade2] run advancement grant @a only minecraft:_upgrades/big_quiver
...
execute if entity @a[scores={MiniGameTime=640}] if entity @s[scores={lifetime=10}] unless entity @s[tag=Prize] as @e[type=marker,tag=Progress,tag=FairyBowUpgrade1] unless entity @s[tag=FairyBowUpgrade2] run scoreboard players set @a ArrowCount2 40
