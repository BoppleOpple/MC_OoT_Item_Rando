...
#Pots
execute as @e[type=marker,tag=Pots] run function ocarina_of_time:moving_things/destroyed_castle_town/pots
...
execute unless block 1418 66 956 minecraft:gold_block if entity @e[type=armor_stand,tag=GhostCatcher,scores={timer=1000..}] run scoreboard players add @e[type=marker,tag=Progress] Bottle 1
