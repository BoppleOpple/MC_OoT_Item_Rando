...
#Silver Rupees
#1
execute if block 467 45 846 minecraft:end_stone_bricks if entity @e[type=marker,tag=SilverRupeeCounter,scores={BlueRupee=0}] if entity @e[type=armor_stand,tag=Rock] run fill 547 33 883 547 33 883 minecraft:stone_pressure_plate replace minecraft:air
#2
execute if block 461 34 893 minecraft:gold_block unless block 462 34 893 minecraft:gold_block if entity @e[type=marker,tag=SilverRupeeCounter,scores={BlueRupee2=0}] if entity @e[type=armor_stand,tag=Rock] run function ocarina_of_time:moving_things/training_ground/enemies/trial_3/finish
#3
execute if block 467 45 846 minecraft:end_stone_bricks if entity @e[type=marker,tag=SilverRupeeCounter,scores={RedRupee=0}] if entity @e[type=armor_stand,tag=Rock] if block 557 33 879 minecraft:air run clone 557 42 878 557 42 878 557 33 879 replace move
...
execute if entity @a[x=525,y=34,z=878,dx=11,dy=4,dz=11] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_wait",Count:1b}]}] unless entity @a[x=529,y=35,z=883,dx=5,dy=3,dz=2] run scoreboard players add @e[type=marker,tag=TimeBlock] timer 1
execute if entity @a[x=556,y=34,z=878,dx=10,dz=10] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_wait",Count:1b}]}] unless entity @a[x=556,y=32,z=878,dx=10,dz=10] run scoreboard players add @e[type=marker,tag=TimeBlock] lifetime 1

#Big Fairies
execute positioned 500 40 915 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run summon minecraft:armor_stand 500 40 915 {Tags:["GreenNavi"],Small:1b,Marker:1b,NoGravity:1b,ArmorItems:[{},{},{},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;-102214788,162220947,-1666754575,1836136248],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTljNTE1NDVkNTQ5NDczZWNjYWE2NzdiZTc3ZmM4OTNjZmEwNWVjMWYwM2I4NWMyZWJjMjM0MmM0YTlmOTdjMyJ9fX0="}]}}}}]}
execute positioned 500 40 915 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] unless entity @a[tag=GreenNaviSpot] run tag @a add GreenNaviSpot
execute positioned 500 40 915 if entity @a[distance=..5] unless entity @e[type=marker,tag=BigFairy,distance=..1] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_stal",Count:1b}]}] run function ocarina_of_time:items/big_fairy/summon
