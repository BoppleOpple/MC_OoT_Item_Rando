...
#Hookshot
execute unless block 1397 33 2766 minecraft:gold_block if entity @e[type=marker,tag=Hookshot,x=1397,y=39,z=2759,dx=0,dy=1,dz=0] run fill 1399 36 2762 1395 38 2762 minecraft:water
execute unless block 1397 33 2766 minecraft:gold_block if entity @e[type=marker,tag=Hookshot,x=1397,y=39,z=2759,dx=0,dy=1,dz=0] run fill 1397 41 2761 1397 41 2761 minecraft:water
execute unless block 1397 33 2766 minecraft:gold_block if entity @e[type=marker,tag=Hookshot,x=1397,y=39,z=2759,dx=0,dy=1,dz=0] run fill 1397 33 2766 1397 33 2766 minecraft:gold_block
...
#Bean Spot
execute as @e[type=marker,tag=BeanSpot] at @a run function ocarina_of_time:moving_things/lake_hylia_adult/bean_spot
