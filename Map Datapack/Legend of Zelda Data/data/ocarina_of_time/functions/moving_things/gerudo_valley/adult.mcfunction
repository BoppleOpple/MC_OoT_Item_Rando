...
execute if block 367 70 2038 minecraft:gold_block run tag @a remove FixedBridge
...
#Bean Spot
execute as @e[type=marker,tag=BeanSpot] at @a run function ocarina_of_time:moving_things/gerudo_valley/bean_spot
