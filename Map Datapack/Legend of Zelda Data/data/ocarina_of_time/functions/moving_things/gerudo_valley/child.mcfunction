...
execute if entity @a[x=365,y=36,z=2039,dx=0,dz=0] unless entity @e[type=marker,tag=BeanSpot,tag=PlantBean4] if entity @a[nbt={SelectedItem:{tag:{MagicBean:1b}}}] positioned 365 36 2039 run function ocarina_of_time:items/magic_bean
execute if block 365 36 2039 minecraft:pumpkin_stem[age=6] as @e[type=marker,tag=BeanSpot] unless entity @s[tag=PlantBean4] run tag @s add PlantBean4
