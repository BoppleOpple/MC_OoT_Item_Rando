...
execute if entity @a[scores={click=13..}] run fill 697 67 2764 697 67 2764 minecraft:gold_block
...
execute if entity @a[scores={click=13..}] run kill @e[type=armor_stand,tag=OwlStand10]
