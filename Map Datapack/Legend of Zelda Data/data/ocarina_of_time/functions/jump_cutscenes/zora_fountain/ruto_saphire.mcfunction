...
execute unless entity @s[tag=Turned] if entity @s[scores={lifetime=15..}] run tp @s 1388 57 1335
...
execute if entity @a[scores={click=493}] if entity @s[scores={timer=180..}] if entity @e[type=marker,tag=Progress,tag=GoronRuby] run tellraw @a {"text":"Her most precious possession? You don't know what she's talking about, but you've finally collected all three Spiritual Stones!"}
execute if entity @a[scores={click=493}] if entity @s[scores={timer=180..}] unless entity @e[type=marker,tag=Progress,tag=GoronRuby] run tellraw @a {"text":"Her most precious possession? You don't know what she's talking about, but you've collected two Spiritual Stones! Only one to go!"}
execute if entity @a[scores={click=493}] if entity @s[scores={timer=180..}] run scoreboard players set @a click 494
execute if entity @a[scores={click=495}] if entity @s[scores={timer=180..}] if entity @e[type=marker,tag=Progress,tag=GoronRuby] run tellraw @a {"text":"Go back to see Princess Zelda!"}
...
execute if entity @a[scores={click=498..}] unless entity @e[type=marker,tag=Progress,tag=GoronRuby] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={lifetime=12..}] run scoreboard players set @s lifetime 12
execute if entity @a[scores={click=498..}] if entity @e[type=marker,tag=Progress,tag=GoronRuby] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={lifetime=13..}] run scoreboard players set @s lifetime 13
execute if entity @a[scores={click=498..}] unless entity @e[type=marker,tag=Progress,tag=GoronRuby] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={text=3..}] run scoreboard players set @s text 3
execute if entity @a[scores={click=498..}] if entity @e[type=marker,tag=Progress,tag=GoronRuby] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={text=4..}] run scoreboard players set @s text 4
execute if entity @a[scores={click=498..}] run tag @e[type=marker,tag=Progress] add ZoraSapphire
execute if entity @a[scores={click=498..}] if entity @e[type=marker,tag=Progress,tag=GoronRuby] run tag @a add RunningMan
execute if entity @a[scores={click=498..}] if entity @e[type=marker,tag=Progress,tag=GoronRuby] run tag @a add ZeldaCastle
execute if entity @a[scores={click=498..}] unless entity @e[type=marker,tag=Progress,tag=GoronRuby] run tag @a add ZeldaText
