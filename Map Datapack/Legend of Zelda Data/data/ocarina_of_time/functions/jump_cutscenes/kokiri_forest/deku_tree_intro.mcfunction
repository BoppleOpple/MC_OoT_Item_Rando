...
execute unless entity @s[tag=Part2] unless entity @a[scores={click=0..}] run data merge entity @e[type=marker,tag=Progress,limit=1] {Tags:["Progress"]}
execute unless entity @s[tag=Part2] unless entity @a[scores={click=0..}] run data merge entity @e[type=marker,tag=Songs,limit=1] {Tags:["Songs"]}
...
execute if entity @s[tag=Part2] if entity @a[scores={click=22..}] run kill @e[type=marker,tag=OpeningCutscene]
