...
execute if entity @s[tag=Part2] if entity @a[scores={click=6..}] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={lifetime=7..}] run scoreboard players set @s lifetime 7
execute if entity @s[tag=Part2] if entity @a[scores={click=6..}] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={text=1..}] run scoreboard players set @s text 1
...
execute if entity @s[scores={timer=31..}] run tag @e[type=marker,tag=Songs] add SariaSong
