...
execute if entity @a[scores={click=60..}] if entity @a[tag=!DeadDekuTree3] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={lifetime=3..}] run scoreboard players set @s lifetime 3
