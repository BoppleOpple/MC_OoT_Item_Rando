...
execute if entity @a[scores={click=8..}] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={lifetime=26..}] run scoreboard players set @s lifetime 26
execute if entity @a[scores={click=8..}] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={text=9..}] run scoreboard players set @s text 9
execute if entity @a[scores={click=8..}] run tag @a add ZeldaReunite
execute if entity @a[scores={click=8..}] run tag @e[type=marker,tag=Progress] add AllMedallions
