...
execute if entity @s[tag=Part2] if entity @a[scores={click=48..}] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={lifetime=6..}] run scoreboard players set @s lifetime 6
