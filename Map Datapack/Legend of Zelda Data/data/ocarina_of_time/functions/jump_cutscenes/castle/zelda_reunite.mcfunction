...
execute if entity @a[scores={click=87}] run tag @e[type=marker,tag=Progress] add LightArrowHelp
...
execute if entity @a[scores={click=108..}] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={lifetime=27..}] run scoreboard players set @s lifetime 27
