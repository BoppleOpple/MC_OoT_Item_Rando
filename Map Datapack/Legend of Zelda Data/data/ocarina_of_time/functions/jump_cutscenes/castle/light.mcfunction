...
execute unless entity @s[tag=Part2] if entity @a[scores={click=1}] run tag @a remove FinalSheikText
...
execute if entity @s[scores={lifetime=45..}] run tag @e[type=marker,tag=Songs] add Light
