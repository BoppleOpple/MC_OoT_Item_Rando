...
execute if entity @a[scores={click=17}] run tag @e[type=marker,tag=Progress] add GotFireMedallion
execute if entity @a[scores={click=17}] unless entity @e[type=marker,tag=Progress,tag=GotForestMedallion,tag=GotFireMedallion,tag=GotWaterMedallion] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={lifetime=19..}] run scoreboard players set @s lifetime 19
execute if entity @a[scores={click=17}] if entity @e[type=marker,tag=Progress,tag=GotForestMedallion,tag=GotFireMedallion,tag=GotWaterMedallion] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={lifetime=21..}] run scoreboard players set @s lifetime 21
execute if entity @a[scores={click=17}] if entity @e[type=marker,tag=Progress,tag=GotForestMedallion,tag=GotFireMedallion,tag=GotWaterMedallion] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={text=8..}] run scoreboard players set @s text 8
