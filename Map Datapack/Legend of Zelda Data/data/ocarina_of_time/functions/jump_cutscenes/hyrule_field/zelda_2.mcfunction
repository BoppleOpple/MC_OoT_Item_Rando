...
execute unless entity @s[tag=PlaySong] unless entity @a[scores={click=0..}] run tag @e[type=marker,tag=Progress] add ZeldaOcarina
...
execute if entity @s[scores={timer=60..}] run tag @e[type=marker,tag=Songs] add Time
...
execute if entity @s[tag=Part2] if entity @a[scores={click=2..}] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={lifetime=15..}] run scoreboard players set @s lifetime 15
execute if entity @s[tag=Part2] if entity @a[scores={click=2..}] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={text=5..}] run scoreboard players set @s text 5
