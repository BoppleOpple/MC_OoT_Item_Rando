...
execute unless entity @a[scores={click=0..}] run scoreboard players add @e[type=marker,tag=Progress] Bottle 1
...
execute if entity @s[scores={timer=600..}] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={lifetime=11..}] run scoreboard players set @s lifetime 11
