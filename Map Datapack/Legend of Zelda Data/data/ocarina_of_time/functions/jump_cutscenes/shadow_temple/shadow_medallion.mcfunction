...
execute if entity @a[scores={click=31..}] run tag @e[type=marker,tag=Progress] add GotShadowMedallion
execute if entity @a[scores={click=31..}] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={lifetime=24..}] run scoreboard players set @s lifetime 24
