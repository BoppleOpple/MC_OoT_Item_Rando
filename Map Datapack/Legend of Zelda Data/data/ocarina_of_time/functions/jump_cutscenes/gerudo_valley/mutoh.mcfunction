...
execute unless entity @a[scores={click=0..}] if entity @s[scores={text=1}] run tag @s add text1
execute unless entity @a[scores={click=0..}] if entity @s[scores={text=2}] run tag @s add text2
execute unless entity @a[scores={click=0..}] if entity @s[scores={text=3}] run tag @s add text3
...
execute if entity @a[scores={click=12}] if entity @s[tag=text1] run scoreboard players set @s text 1
execute if entity @a[scores={click=12}] if entity @s[tag=text2] run scoreboard players set @s text 2
execute if entity @a[scores={click=12}] if entity @s[tag=text3] run scoreboard players set @s text 3
execute if entity @a[scores={click=12}] run tag @s remove text1
execute if entity @a[scores={click=12}] run tag @s remove text2
execute if entity @a[scores={click=12}] run tag @s remove text3
