...
execute unless entity @s[tag=Revisit] if entity @a[scores={click=27}] run tag @e[type=marker,tag=Progress] remove HalfMagic
execute unless entity @s[tag=Revisit] if entity @a[scores={click=27}] run tag @e[type=marker,tag=Progress] add FullMagic
