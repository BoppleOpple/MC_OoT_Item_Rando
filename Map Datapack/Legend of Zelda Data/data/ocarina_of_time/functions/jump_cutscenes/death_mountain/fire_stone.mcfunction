...
execute if entity @a[scores={click=25}] unless entity @e[type=marker,tag=Progress,tag=ZoraSapphire] run tellraw @a {"text":"You don't know what he means by \"Sworn Brothers,\" but you've collected two Spiritual Stones! You have one more to find!"}
execute if entity @a[scores={click=25}] if entity @e[type=marker,tag=Progress,tag=ZoraSapphire] run tellraw @a {"text":"You don't know what he means by \"Sworn Brothers,\" but you've finally collected all three Spiritual Stones! Go back to see Princess Zelda!"}
...
execute if entity @a[tag=FinishChase] unless entity @e[type=marker,tag=Progress,tag=ZoraSapphire] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={lifetime=9..}] run scoreboard players set @s lifetime 9
execute if entity @a[tag=FinishChase] if entity @e[type=marker,tag=Progress,tag=ZoraSapphire] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={lifetime=13..}] run scoreboard players set @s lifetime 13
execute if entity @a[tag=FinishChase] unless entity @e[type=marker,tag=Progress,tag=ZoraSapphire] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={text=3..}] run scoreboard players set @s text 3
execute if entity @a[tag=FinishChase] if entity @e[type=marker,tag=Progress,tag=ZoraSapphire] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={text=4..}] run scoreboard players set @s text 4
execute if entity @a[tag=FinishChase] run tag @e[type=marker,tag=Progress] add GoronRuby
...
execute if entity @a[tag=FinishChase] if entity @e[type=marker,tag=Progress,tag=ZoraSapphire] run tag @a add RunningMan
execute if entity @a[tag=FinishChase] if entity @e[type=marker,tag=Progress,tag=ZoraSapphire] run tag @a add ZeldaCastle
execute if entity @a[tag=FinishChase] unless entity @e[type=marker,tag=Progress,tag=ZoraSapphire] run tag @a add ZeldaText
