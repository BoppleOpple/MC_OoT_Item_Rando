...
execute if entity @a[scores={click=62}] run tag @e[type=marker,tag=Progress] add GotForestMedallion
execute if entity @a[scores={click=62}] unless entity @e[type=marker,tag=Progress,tag=GotForestMedallion,tag=GotFireMedallion,tag=GotWaterMedallion] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={lifetime=18..}] run scoreboard players set @s lifetime 18
execute if entity @a[scores={click=62}] if entity @e[type=marker,tag=Progress,tag=GotForestMedallion,tag=GotFireMedallion,tag=GotWaterMedallion] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={lifetime=21..}] run scoreboard players set @s lifetime 21
execute if entity @a[scores={click=62}] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={text=7..}] run scoreboard players set @s text 7
execute if entity @a[scores={click=62}] if entity @e[type=marker,tag=Progress,tag=GotForestMedallion,tag=GotFireMedallion,tag=GotWaterMedallion] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={text=8..}] run scoreboard players set @s text 8
