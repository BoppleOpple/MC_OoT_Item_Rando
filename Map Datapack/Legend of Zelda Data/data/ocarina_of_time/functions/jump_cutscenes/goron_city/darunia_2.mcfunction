...
execute if entity @a[scores={click=26..}] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={lifetime=8..}] run scoreboard players set @s lifetime 8
execute if entity @a[scores={click=26..}] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={text=2..}] run scoreboard players set @s text 2
execute if entity @a[scores={click=26..}] run tag @e[type=marker,tag=Progress] add GoronBracelet
