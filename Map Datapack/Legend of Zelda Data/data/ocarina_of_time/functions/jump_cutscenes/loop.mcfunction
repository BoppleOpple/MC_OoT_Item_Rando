...
execute if entity @a[tag=NotStarted] as @e[type=marker,tag=OpeningCutscene] at @s run function ocarina_of_time:jump_cutscenes/kokiri_forest/deku_tree_intro
...
#Owl1
execute if entity @a[tag=Owl1,x=1064,y=67,z=2104,dx=7,dy=2,dz=0] as @e[type=marker,tag=FakeOwl] run function ocarina_of_time:jump_cutscenes/hyrule_field/owl1

#Owl2
execute if entity @a[tag=Owl2,x=1037,y=67,z=1920,dx=13,dy=2,dz=14] as @e[type=marker,tag=FakeOwl] run function ocarina_of_time:jump_cutscenes/hyrule_field/owl2

#Owl3
execute if entity @a[tag=Owl3,x=804,y=62,z=2069,dx=18,dy=3,dz=24] as @e[type=marker,tag=FakeOwl] run function ocarina_of_time:jump_cutscenes/hyrule_field/owl3

#Owl4
execute if entity @a[tag=Owl4,x=826,y=56,z=2194,dx=12,dy=5,dz=12] as @e[type=marker,tag=FakeOwl] run function ocarina_of_time:jump_cutscenes/hyrule_field/owl4
...
#Owl5
execute if entity @a[tag=Owl5,x=893,y=76,z=947,dx=8,dy=2,dz=1] as @e[type=marker,tag=FakeOwl] run function ocarina_of_time:jump_cutscenes/castle/owl
...
execute if entity @a[tag=ExtraOwl,x=1480,y=69,z=2329,dx=6,dy=1,dz=4] as @e[type=marker,tag=FakeOwl] run function ocarina_of_time:jump_cutscenes/zora_river/owl6_extra
execute if entity @a[tag=OwlSaria,x=1480,y=69,z=2329,dx=6,dy=1,dz=4] as @e[type=marker,tag=FakeOwl] run function ocarina_of_time:jump_cutscenes/zora_river/owl6
...
execute if entity @a[tag=MountainOwl] as @e[type=marker,tag=FakeOwl] run function ocarina_of_time:jump_cutscenes/death_mountain/owl
...
execute if entity @a[tag=LakeOwl] as @e[type=marker,tag=FakeOwl] run function ocarina_of_time:jump_cutscenes/lake_hylia/owl
...
#Lost Woods Owl 1
execute if entity @a[tag=LostWoodsOwl,x=-578,y=75,z=-686,dx=6,dy=2,dz=4] as @e[type=marker,tag=FakeOwl] run function ocarina_of_time:jump_cutscenes/kokiri_forest/owl_1
...
#Lost Woods Owl 2
execute if entity @a[tag=LostWoodsOwl2,x=-579,y=75,z=-718,dx=8,dy=2,dz=3] as @e[type=marker,tag=FakeOwl] run function ocarina_of_time:jump_cutscenes/kokiri_forest/owl_2
...
execute if entity @a[tag=MeetJabuJabu2] as @e[type=marker,tag=JabuJabu] run function ocarina_of_time:jump_cutscenes/zora_fountain/jabu_jabu
...
#2
execute if entity @a[tag=InCastleField,x=946,y=72,z=969,dx=2,dz=2] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_mall",Count:1b}]}] if entity @e[type=marker,tag=Progress,tag=HalfMagic] run tag @a add GreatFairy2
execute if entity @a[tag=InCastleField,x=946,y=72,z=969,dx=2,dz=2] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_mall",Count:1b}]}] if entity @e[type=marker,tag=Progress,tag=FullMagic] run tag @a add GreatFairy2
...
#3
execute if entity @a[tag=InZoraFountain,x=1450,y=54,z=1391,dx=2,dz=2] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_mall",Count:1b}]}] if entity @e[type=marker,tag=Progress,tag=HalfMagic] run tag @a add GreatFairy3
execute if entity @a[tag=InZoraFountain,x=1450,y=54,z=1391,dx=2,dz=2] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_mall",Count:1b}]}] if entity @e[type=marker,tag=Progress,tag=FullMagic] run tag @a add GreatFairy3
...
#4
execute if entity @a[tag=InDeathCrater,x=2722,y=43,z=2016,dx=2,dz=2] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_mall",Count:1b}]}] if entity @e[type=marker,tag=Progress,tag=HalfMagic] run tag @a add GreatFairy4
execute if entity @a[tag=InDeathCrater,x=2722,y=43,z=2016,dx=2,dz=2] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_mall",Count:1b}]}] if entity @e[type=marker,tag=Progress,tag=FullMagic] run tag @a add GreatFairy4
...
#5
execute if entity @a[tag=InDesertColossus,x=459,y=37,z=479,dx=2,dz=2] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_mall",Count:1b}]}] if entity @e[type=marker,tag=Progress,tag=HalfMagic] run tag @a add GreatFairy5
execute if entity @a[tag=InDesertColossus,x=459,y=37,z=479,dx=2,dz=2] if entity @a[nbt={Inventory:[{id:"minecraft:music_disc_mall",Count:1b}]}] if entity @e[type=marker,tag=Progress,tag=FullMagic] run tag @a add GreatFairy5
...
execute if entity @a[tag=PoeFlames] as @e[type=marker,tag=PoeFire] at @s run function ocarina_of_time:jump_cutscenes/forest_temple/poe_flames
...
#Scarecrow 1
execute if entity @a[x=800,y=66,z=2683,dx=4,dz=3] unless entity @a[tag=LearnScarecrowSong2] unless entity @e[type=marker,tag=Songs,tag=Scarecrow] if entity @a[nbt={SelectedItem:{tag:{OcarinaSaria:1b}}}] unless entity @a[tag=Adult] run tag @a add LearnScarecrowSong1
execute if entity @a[x=800,y=66,z=2683,dx=4,dz=3] unless entity @a[tag=LearnScarecrowSong2] unless entity @e[type=marker,tag=Songs,tag=Scarecrow] if entity @a[nbt={SelectedItem:{tag:{OcarinaZelda:1b}}}] unless entity @a[tag=Adult] run tag @a add LearnScarecrowSong1
...
#Scarecrow 2
execute if entity @a[x=800,y=66,z=2683,dx=4,dz=3] if entity @a[tag=LearnScarecrowSong2,tag=Adult] unless entity @e[type=marker,tag=Songs,tag=Scarecrow] if entity @a[nbt={SelectedItem:{tag:{OcarinaSaria:1b}}}] run tag @a add LearnScarecrowSong3
execute if entity @a[x=800,y=66,z=2683,dx=4,dz=3] if entity @a[tag=LearnScarecrowSong2,tag=Adult] unless entity @e[type=marker,tag=Songs,tag=Scarecrow] if entity @a[nbt={SelectedItem:{tag:{OcarinaZelda:1b}}}] run tag @a add LearnScarecrowSong3
...
#Scarecrow 3
execute if entity @a[x=1421,y=66,z=2683,dx=4,dz=3] if entity @a[tag=LearnScarecrowSong2,tag=Adult] unless entity @e[type=marker,tag=Songs,tag=Scarecrow] if entity @a[nbt={SelectedItem:{tag:{OcarinaSaria:1b}}}] run tag @a add LearnScarecrowSong3
execute if entity @a[x=1421,y=66,z=2683,dx=4,dz=3] if entity @a[tag=LearnScarecrowSong2,tag=Adult] unless entity @e[type=marker,tag=Songs,tag=Scarecrow] if entity @a[nbt={SelectedItem:{tag:{OcarinaZelda:1b}}}] run tag @a add LearnScarecrowSong3
...
#Owl Spirit Temple
execute if entity @a[tag=OwlSpiritTemple] as @e[type=marker,tag=FakeOwl] run function ocarina_of_time:jump_cutscenes/spirit_temple/owl
...
#Staff Role
execute if entity @a[tag=StaffRole] as @e[type=marker,tag=StaffRole] at @s run function ocarina_of_time:jump_cutscenes/staff_role/staff_role
