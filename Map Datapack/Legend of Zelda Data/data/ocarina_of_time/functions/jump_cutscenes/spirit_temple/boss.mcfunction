...
execute if entity @s[scores={timer=371}] run summon minecraft:marker -39 127 775 {Tags:["Twinrova","TwinrovaSpot"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute if entity @s[scores={timer=371}] run summon minecraft:marker -15 127 775 {Tags:["Twinrova","TwinrovaSpot"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute if entity @s[scores={timer=371}] run summon minecraft:marker -15 127 751 {Tags:["Twinrova","TwinrovaSpot"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute if entity @s[scores={timer=371}] run summon minecraft:marker -39 127 751 {Tags:["Twinrova","TwinrovaSpot"],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
