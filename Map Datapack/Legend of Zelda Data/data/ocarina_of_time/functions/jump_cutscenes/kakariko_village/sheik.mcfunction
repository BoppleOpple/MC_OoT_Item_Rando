...
#Shadow 1
execute if entity @s[scores={timer=400}] run summon minecraft:marker 1547 84 1928 {Tags:["Shadow","Shadow1"],Rotation:[180f],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute if entity @s[scores={timer=401..429}] as @e[type=marker,tag=Shadow1] at @s run tp @s ~-.7 ~ ~-1
execute if entity @s[scores={timer=430}] run kill @e[type=marker,tag=Shadow1]
...
#Shadow 2
execute if entity @s[scores={timer=450}] run summon minecraft:marker 1508 94 1906 {Tags:["Shadow","Shadow2"],Rotation:[180f],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute if entity @s[scores={timer=451..495}] as @e[type=marker,tag=Shadow2] at @s run tp @s ~-.35 ~ ~.5
execute if entity @s[scores={timer=496..516}] as @e[type=marker,tag=Shadow2] at @s run tp @s ~ ~ ~.7
execute if entity @s[scores={timer=517..528}] as @e[type=marker,tag=Shadow2] at @s run tp @s ~.7 ~ ~
execute if entity @s[scores={timer=529..549}] as @e[type=marker,tag=Shadow2] at @s run tp @s ~.1 ~ ~-.6
execute if entity @s[scores={timer=550..586}] as @e[type=marker,tag=Shadow2] at @s run tp @s ~.8 ~ ~
execute if entity @s[scores={timer=587}] run kill @e[type=marker,tag=Shadow2]

execute if entity @s[scores={timer=455}] run summon minecraft:marker 1510.049 94 1903.0 {Tags:["CleanShadow","Shadow3"],Rotation:[180f],Age:-2147483648,Duration:-1,WaitTime:-2147483648}
execute if entity @s[scores={timer=456..507}] as @e[type=marker,tag=Shadow3] at @s run tp @s ~-.35 ~ ~.5
execute if entity @s[scores={timer=508..528}] as @e[type=marker,tag=Shadow3] at @s run tp @s ~ ~ ~.7
execute if entity @s[scores={timer=529..540}] as @e[type=marker,tag=Shadow3] at @s run tp @s ~.7 ~ ~
execute if entity @s[scores={timer=541..561}] as @e[type=marker,tag=Shadow3] at @s run tp @s ~.1 ~ ~-.6
execute if entity @s[scores={timer=562..598}] as @e[type=marker,tag=Shadow3] at @s run tp @s ~.8 ~ ~
execute if entity @s[scores={timer=602}] run kill @e[type=marker,tag=Shadow3]
...
execute if entity @s[tag=Part2] if entity @a[scores={click=5..}] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={lifetime=22..}] run scoreboard players set @s lifetime 22
execute if entity @s[tag=Part2] if entity @a[scores={click=5..}] run tag @e[type=marker,tag=Progress] add FinishKakariko
...
execute if entity @s[scores={lifetime=58..}] run tag @e[type=marker,tag=Songs] add Shadows
...
#Shadow
execute as @e[type=marker,tag=Shadow] at @s positioned ~-2 67 ~-2 run fill ~ ~ ~ ~4 94 ~4 minecraft:black_wool replace #ocarina_of_time:bongo_shadow_1
execute as @e[type=marker,tag=Shadow] at @s positioned ~-2 67 ~-2 run fill ~ ~ ~ ~4 94 ~4 minecraft:black_concrete replace minecraft:dirt
execute as @e[type=marker,tag=Shadow] at @s positioned ~-2 67 ~-2 run fill ~ ~ ~ ~4 94 ~4 minecraft:black_carpet replace #ocarina_of_time:bongo_shadow_2

execute as @e[type=marker,tag=CleanShadow] at @s positioned ~-3 67 ~-3 run fill ~ ~ ~ ~6 94 ~6 minecraft:grass_block replace minecraft:black_wool
execute as @e[type=marker,tag=CleanShadow] at @s positioned ~-3 67 ~-3 run fill ~ ~ ~ ~6 94 ~6 minecraft:dirt replace minecraft:black_concrete
