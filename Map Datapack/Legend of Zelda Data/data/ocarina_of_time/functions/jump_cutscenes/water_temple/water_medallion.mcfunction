...
execute as @e[type=armor_stand,tag=Sheik4,scores={timer=200..}] run tag @e[type=marker,tag=Progress] add GotWaterMedallion
execute as @e[type=armor_stand,tag=Sheik4,scores={timer=200..}] if entity @e[type=marker,tag=Progress,tag=GotForestMedallion,tag=GotFireMedallion,tag=GotWaterMedallion] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={lifetime=21..}] run scoreboard players set @s lifetime 21
execute as @e[type=armor_stand,tag=Sheik4,scores={timer=200..}] if entity @e[type=marker,tag=Progress,tag=GotForestMedallion,tag=GotFireMedallion,tag=GotWaterMedallion] as @e[type=marker,tag=FakeSaria] unless entity @s[scores={text=8..}] run scoreboard players set @s text 8
