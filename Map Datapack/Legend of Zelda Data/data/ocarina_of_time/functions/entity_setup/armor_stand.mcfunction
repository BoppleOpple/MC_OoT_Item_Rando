...
execute if entity @s[tag=Peahat] if entity @e[type=marker,tag=PeahatReturn] run function ocarina_of_time:enemies/peahat/peahat_timer
execute if entity @s[tag=Peahat] if entity @e[type=marker,tag=PeahatReturn] run function ocarina_of_time:enemies/peahat/peahat_timer
execute if entity @s[tag=Peahat] if entity @e[type=marker,tag=PeahatReturn] run function ocarina_of_time:enemies/peahat/peahat_timer
execute if entity @s[tag=Peahat] if entity @e[type=marker,tag=PeahatReturn] run function ocarina_of_time:enemies/peahat/peahat_timer
...
#Navi Help
execute if entity @s[tag=HintNavi] if entity @a[nbt={Inventory:[{id:"minecraft:player_head",Count:1b,tag:{display:{Name:"{\"text\":\"Navi\"}"}}}]}] as @e[type=marker,tag=FakeSaria] run function ocarina_of_time:items/navi/navi_help
