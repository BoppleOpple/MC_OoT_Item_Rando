...
#Iron Boots
execute if entity @s[tag=Sink] at @s unless entity @e[type=marker,tag=Hookshot] run function ocarina_of_time:items/boots/sink
execute if entity @s[tag=Sink] at @s unless entity @e[type=marker,tag=Hookshot] run function ocarina_of_time:items/boots/sink
execute if entity @s[tag=Sink] at @s unless entity @e[type=marker,tag=Hookshot] run function ocarina_of_time:items/boots/sink
...
#Forest Temple
execute if entity @a[tag=InForestTemple] if entity @s[type=marker,tag=TwistedRoom] at @s run function ocarina_of_time:moving_things/forest_temple/twisted_room_1/entity
execute if entity @a[tag=InForestTemple] if entity @s[type=marker,tag=SlideRoom] at @s run function ocarina_of_time:moving_things/forest_temple/slide_room/slide
execute if entity @a[tag=InForestTemple] if entity @s[type=marker,tag=PoeFire] at @s run function ocarina_of_time:moving_things/forest_temple/poe_fire
