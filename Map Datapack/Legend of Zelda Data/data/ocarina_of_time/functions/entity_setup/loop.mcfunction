...
execute unless entity @e[type=zombie,tag=Wolfos,tag=Attack] run kill @e[type=marker,tag=Circle]
execute unless entity @e[type=zombie,tag=Stalfos] run tag @e[type=marker,tag=StalfosMove] remove Select1
execute unless entity @e[type=zombie,tag=Stalfos] run tag @e[type=marker,tag=StalfosMove] remove Select2
execute unless entity @e[type=zombie,tag=Tinymaster] run kill @e[type=marker,tag=TinymasterTeleport]
...
#Area Effect Cloud
execute as @e[type=marker] at @s run function ocarina_of_time:entity_setup/marker
